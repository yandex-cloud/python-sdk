...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_HISTORYENTRY_FAILEDATTEMPT'].fields_by_name['started_at']._loaded_options = None
  _globals['_HISTORYENTRY_FAILEDATTEMPT'].fields_by_name['started_at']._serialized_options = b'\350\3071\001'
