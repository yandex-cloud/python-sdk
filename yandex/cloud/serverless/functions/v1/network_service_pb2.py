...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GETUSEDNETWORKREQUEST'].fields_by_name['network_id']._loaded_options = None
  _globals['_GETUSEDNETWORKREQUEST'].fields_by_name['network_id']._serialized_options = b'\350\3071\001'
  _globals['_LISTUSEDNETWORKSREQUEST'].oneofs_by_name['scope']._loaded_options = None
  _globals['_LISTUSEDNETWORKSREQUEST'].oneofs_by_name['scope']._serialized_options = b'\300\3011\001'
  _globals['_LISTUSEDNETWORKSREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTUSEDNETWORKSREQUEST'].fields_by_name['page_size']._serialized_options = b'\372\3071\006<=1000'
  _globals['_LISTUSEDNETWORKSREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTUSEDNETWORKSREQUEST'].fields_by_name['page_token']._serialized_options = b'\212\3101\005<=100'
  _globals['_LISTCONNECTEDRESOURCESREQUEST'].oneofs_by_name['network_scope']._loaded_options = None
  _globals['_LISTCONNECTEDRESOURCESREQUEST'].oneofs_by_name['network_scope']._serialized_options = b'\300\3011\001'
  _globals['_LISTCONNECTEDRESOURCESREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTCONNECTEDRESOURCESREQUEST'].fields_by_name['page_size']._serialized_options = b'\372\3071\006<=1000'
  _globals['_LISTCONNECTEDRESOURCESREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTCONNECTEDRESOURCESREQUEST'].fields_by_name['page_token']._serialized_options = b'\212\3101\005<=100'
  _globals['_TRIGGERUSEDNETWORKCLEANUPREQUEST'].fields_by_name['network_id']._loaded_options = None
  _globals['_TRIGGERUSEDNETWORKCLEANUPREQUEST'].fields_by_name['network_id']._serialized_options = b'\350\3071\001'
  _globals['_NETWORKSERVICE'].methods_by_name['GetUsed']._loaded_options = None
  _globals['_NETWORKSERVICE'].methods_by_name['GetUsed']._serialized_options = b'\202\323\344\223\002*\022(/functions/v1/networks/used/{network_id}'
  _globals['_NETWORKSERVICE'].methods_by_name['ListUsed']._loaded_options = None
  _globals['_NETWORKSERVICE'].methods_by_name['ListUsed']._serialized_options = b'\202\323\344\223\002\035\022\033/functions/v1/networks/used'
  _globals['_NETWORKSERVICE'].methods_by_name['ListConnectedResources']._loaded_options = None
  _globals['_NETWORKSERVICE'].methods_by_name['ListConnectedResources']._serialized_options = b'\202\323\344\223\002$\022\"/functions/v1/networks/connections'
  _globals['_NETWORKSERVICE'].methods_by_name['TriggerUsedCleanup']._loaded_options = None
  _globals['_NETWORKSERVICE'].methods_by_name['TriggerUsedCleanup']._serialized_options = b'\202\323\344\223\002<\"7/functions/v1/networks/used/{network_id}:triggerCleanup:\001*'
