...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/serverless/eventrouter/v1/connector_service_pb2_grpc.py depends on'
...
def add_ConnectorServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.serverless.eventrouter.v1.ConnectorService', rpc_method_handlers)
