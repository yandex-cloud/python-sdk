...
_TRIGGER_LOGGING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\362\3071\034[a-zA-Z][-a-zA-Z0-9_.]{1,62}\202\3101\005<=100', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='stream_name', full_name='yandex.cloud.serverless.triggers.v1.Trigger.Logging.stream_name', index=3,
      number=7, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\362\3071\035|[a-z][-a-z0-9]{1,61}[a-z0-9]\202\3101\005<=100', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='levels', full_name='yandex.cloud.serverless.triggers.v1.Trigger.Logging.levels', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='batch_settings', full_name='yandex.cloud.serverless.triggers.v1.Trigger.Logging.batch_settings', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\350\3071\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='invoke_function', full_name='yandex.cloud.serverless.triggers.v1.Trigger.Logging.invoke_function', index=6,
      number=101, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='invoke_container', full_name='yandex.cloud.serverless.triggers.v1.Trigger.Logging.invoke_container', index=7,
      number=103, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_OBJECTSTORAGEBUCKETSETTINGS = _descriptor.Descriptor(
  name='ObjectStorageBucketSettings',
  full_name='yandex.cloud.serverless.triggers.v1.ObjectStorageBucketSettings',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='bucket_id', full_name='yandex.cloud.serverless.triggers.v1.ObjectStorageBucketSettings.bucket_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\212\3101\0043-63\362\3071\016[-.0-9a-zA-Z]*', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='service_account_id', full_name='yandex.cloud.serverless.triggers.v1.ObjectStorageBucketSettings.service_account_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MAIL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='attachments_bucket', full_name='yandex.cloud.serverless.triggers.v1.Mail.attachments_bucket', index=2,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='invoke_function', full_name='yandex.cloud.serverless.triggers.v1.Mail.invoke_function', index=3,
      number=101, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='invoke_container', full_name='yandex.cloud.serverless.triggers.v1.Mail.invoke_container', index=4,
      number=103, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MAIL.fields_by_name['attachments_bucket'].message_type = _OBJECTSTORAGEBUCKETSETTINGS
...
DESCRIPTOR.message_types_by_name['ObjectStorageBucketSettings'] = _OBJECTSTORAGEBUCKETSETTINGS
...
ObjectStorageBucketSettings = _reflection.GeneratedProtocolMessageType('ObjectStorageBucketSettings', (_message.Message,), {
  'DESCRIPTOR' : _OBJECTSTORAGEBUCKETSETTINGS,
  '__module__' : 'yandex.cloud.serverless.triggers.v1.trigger_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.serverless.triggers.v1.ObjectStorageBucketSettings)
  })
_sym_db.RegisterMessage(ObjectStorageBucketSettings)
