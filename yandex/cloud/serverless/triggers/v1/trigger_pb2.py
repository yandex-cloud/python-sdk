...
_TRIGGER = _descriptor.Descriptor(
  ...
  nested_types=[_TRIGGER_LABELSENTRY, _TRIGGER_RULE, _TRIGGER_TIMER, _TRIGGER_MESSAGEQUEUE, _TRIGGER_IOTMESSAGE, _TRIGGER_OBJECTSTORAGE, ],
  enum_types=[
