...
AndPredicate = _reflection.GeneratedProtocolMessageType('AndPredicate', (_message.Message,), dict(
...
FieldValuePredicate = _reflection.GeneratedProtocolMessageType('FieldValuePredicate', (_message.Message,), dict(
