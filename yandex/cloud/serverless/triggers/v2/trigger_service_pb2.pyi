...
class ListTriggersResponse(google.protobuf.message.Message):
    ...
    """
    @property
    def triggers(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[yandex.cloud.serverless.triggers.v2.trigger_pb2.Trigger]:
        """List of triggers in the specified folder."""

    def __init__(
        self,
        *,
        triggers: collections.abc.Iterable[yandex.cloud.serverless.triggers.v2.trigger_pb2.Trigger] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
...
class CreateTriggerRequest(google.protobuf.message.Message):
    ...
    @property
    def source(self) -> yandex.cloud.serverless.triggers.v2.trigger_pb2.Source:
        """Event source for the trigger."""

    @property
    def action(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[yandex.cloud.serverless.triggers.v2.trigger_pb2.Action]:
    ...
    def __init__(
        ...
        *,
        ...
        source: yandex.cloud.serverless.triggers.v2.trigger_pb2.Source | None = ...,
        action: collections.abc.Iterable[yandex.cloud.serverless.triggers.v2.trigger_pb2.Action] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["source", b"source"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["action", b"action", "description", b"description", "folder_id", b"folder_id", "labels", b"labels", "name", b"name", "source", b"source"]) -> None: ...
...
class UpdateTriggerRequest(google.protobuf.message.Message):
    ...
    @property
    def source(self) -> yandex.cloud.serverless.triggers.v2.trigger_pb2.Source:
        """New event source for the trigger."""

    @property
    def action(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[yandex.cloud.serverless.triggers.v2.trigger_pb2.Action]:
        """New list of actions for the trigger."""
    ...
    def HasField(self, field_name: typing.Literal["source", b"source", "update_mask", b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["action", b"action", "description", b"description", "labels", b"labels", "name", b"name", "source", b"source", "trigger_id", b"trigger_id", "update_mask", b"update_mask"]) -> None: ...
