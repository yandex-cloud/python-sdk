...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ASYMMETRICSIGNREQUEST.fields_by_name['key_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _ASYMMETRICSIGNREQUEST.fields_by_name['message']._options = None
  _ASYMMETRICSIGNREQUEST.fields_by_name['message']._serialized_options = b'\350\3071\001\212\3101\007<=32768'
  _ASYMMETRICSIGNHASHREQUEST.fields_by_name['key_id']._options = None
  _ASYMMETRICSIGNHASHREQUEST.fields_by_name['key_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _ASYMMETRICSIGNHASHREQUEST.fields_by_name['hash']._options = None
  _ASYMMETRICSIGNHASHREQUEST.fields_by_name['hash']._serialized_options = b'\350\3071\001\212\3101\006<=4096'
  ...
  _ASYMMETRICSIGNATURECRYPTOSERVICE.methods_by_name['Sign']._options = None
  _ASYMMETRICSIGNATURECRYPTOSERVICE.methods_by_name['Sign']._serialized_options = b'\202\323\344\223\0022\"-/kms/v1/asymmetricSignatureKeys/{key_id}:sign:\001*'
  _ASYMMETRICSIGNATURECRYPTOSERVICE.methods_by_name['SignHash']._options = None
  _ASYMMETRICSIGNATURECRYPTOSERVICE.methods_by_name['SignHash']._serialized_options = b'\202\323\344\223\0026\"1/kms/v1/asymmetricSignatureKeys/{key_id}:signHash:\001*'
  _ASYMMETRICSIGNATURECRYPTOSERVICE.methods_by_name['GetPublicKey']._options = None
  _ASYMMETRICSIGNATURECRYPTOSERVICE.methods_by_name['GetPublicKey']._serialized_options = b'\202\323\344\223\0024\0222/kms/v1/asymmetricSignatureKeys/{key_id}/publicKey'
