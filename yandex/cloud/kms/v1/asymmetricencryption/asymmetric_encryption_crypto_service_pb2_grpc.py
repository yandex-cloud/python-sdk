...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in yandex/cloud/kms/v1/asymmetricencryption/asymmetric_encryption_crypto_service_pb2_grpc.py depends on'
...
def add_AsymmetricEncryptionCryptoServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.kms.v1.asymmetricencryption.AsymmetricEncryptionCryptoService', rpc_method_handlers)
