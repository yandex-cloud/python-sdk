...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('ZBgithub.com/yandex-cloud/go-genproto/yandex/cloud/endpoint;endpoint'))
...
_APIENDPOINTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\036\022\034/endpoints/{api_endpoint_id}')),
  ),
  _descriptor.MethodDescriptor(
    name='List',
