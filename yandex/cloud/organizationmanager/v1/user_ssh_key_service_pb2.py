...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GETUSERSSHKEYREQUEST.fields_by_name['user_ssh_key_id']._options = None
  _GETUSERSSHKEYREQUEST.fields_by_name['user_ssh_key_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _LISTUSERSSHKEYSREQUEST.fields_by_name['organization_id']._options = None
  _LISTUSERSSHKEYSREQUEST.fields_by_name['organization_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _LISTUSERSSHKEYSREQUEST.fields_by_name['subject_id']._options = None
  _LISTUSERSSHKEYSREQUEST.fields_by_name['subject_id']._serialized_options = b'\212\3101\004<=50'
  _LISTUSERSSHKEYSREQUEST.fields_by_name['page_size']._options = None
  _LISTUSERSSHKEYSREQUEST.fields_by_name['page_size']._serialized_options = b'\372\3071\0060-1000'
  _LISTUSERSSHKEYSREQUEST.fields_by_name['page_token']._options = None
  _LISTUSERSSHKEYSREQUEST.fields_by_name['page_token']._serialized_options = b'\212\3101\006<=2000'
  _CREATEUSERSSHKEYREQUEST.fields_by_name['organization_id']._options = None
  _CREATEUSERSSHKEYREQUEST.fields_by_name['organization_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _CREATEUSERSSHKEYREQUEST.fields_by_name['subject_id']._options = None
  _CREATEUSERSSHKEYREQUEST.fields_by_name['subject_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _CREATEUSERSSHKEYREQUEST.fields_by_name['name']._options = None
  _CREATEUSERSSHKEYREQUEST.fields_by_name['name']._serialized_options = b'\212\3101\005<=255'
  _CREATEUSERSSHKEYREQUEST.fields_by_name['data']._options = None
  _CREATEUSERSSHKEYREQUEST.fields_by_name['data']._serialized_options = b'\350\3071\001\212\3101\007<=20000'
  _UPDATEUSERSSHKEYREQUEST.fields_by_name['user_ssh_key_id']._options = None
  _UPDATEUSERSSHKEYREQUEST.fields_by_name['user_ssh_key_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _UPDATEUSERSSHKEYREQUEST.fields_by_name['name']._options = None
  _UPDATEUSERSSHKEYREQUEST.fields_by_name['name']._serialized_options = b'\212\3101\005<=255'
  _DELETEUSERSSHKEYREQUEST.fields_by_name['user_ssh_key_id']._options = None
  _DELETEUSERSSHKEYREQUEST.fields_by_name['user_ssh_key_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _USERSSHKEYSERVICE.methods_by_name['Get']._options = None
  _USERSSHKEYSERVICE.methods_by_name['Get']._serialized_options = b'\202\323\344\223\0028\0226/organization-manager/v1/userSshKeys/{user_ssh_key_id}'
  _USERSSHKEYSERVICE.methods_by_name['List']._options = None
  _USERSSHKEYSERVICE.methods_by_name['List']._serialized_options = b'\202\323\344\223\002&\022$/organization-manager/v1/userSshKeys'
  _USERSSHKEYSERVICE.methods_by_name['Create']._options = None
  _USERSSHKEYSERVICE.methods_by_name['Create']._serialized_options = b'\262\322*&\n\030CreateUserSshKeyMetadata\022\nUserSshKey\202\323\344\223\002)\"$/organization-manager/v1/userSshKeys:\001*'
  _USERSSHKEYSERVICE.methods_by_name['Update']._options = None
  _USERSSHKEYSERVICE.methods_by_name['Update']._serialized_options = b'\262\322*&\n\030UpdateUserSshKeyMetadata\022\nUserSshKey\202\323\344\223\002;26/organization-manager/v1/userSshKeys/{user_ssh_key_id}:\001*'
  _USERSSHKEYSERVICE.methods_by_name['Delete']._options = None
  _USERSSHKEYSERVICE.methods_by_name['Delete']._serialized_options = b'\262\322*1\n\030DeleteUserSshKeyMetadata\022\025google.protobuf.Empty\202\323\344\223\0028*6/organization-manager/v1/userSshKeys/{user_ssh_key_id}'
