...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ORGANIZATIONSERVICE'].methods_by_name['ListAccessPolicyBindings']._loaded_options = None
  _globals['_ORGANIZATIONSERVICE'].methods_by_name['ListAccessPolicyBindings']._serialized_options = b'\202\323\344\223\002O\022M/organization-manager/v1/organizations/{resource_id}:listAccessPolicyBindings'
  _globals['_ORGANIZATIONSERVICE'].methods_by_name['BindAccessPolicy']._loaded_options = None
  _globals['_ORGANIZATIONSERVICE'].methods_by_name['BindAccessPolicy']._serialized_options = b'\262\322*B\n\037access.BindAccessPolicyMetadata\022\037access.BindAccessPolicyResponse\202\323\344\223\002J\"E/organization-manager/v1/organizations/{resource_id}:bindAccessPolicy:\001*'
  _globals['_ORGANIZATIONSERVICE'].methods_by_name['UnbindAccessPolicy']._loaded_options = None
  _globals['_ORGANIZATIONSERVICE'].methods_by_name['UnbindAccessPolicy']._serialized_options = b'\262\322*F\n!access.UnbindAccessPolicyMetadata\022!access.UnbindAccessPolicyResponse\202\323\344\223\002L\"G/organization-manager/v1/organizations/{resource_id}:unbindAccessPolicy:\001*'
  _globals['_ORGANIZATIONSERVICE'].methods_by_name['UpdateAccessPolicyBindingParameters']._loaded_options = None
  _globals['_ORGANIZATIONSERVICE'].methods_by_name['UpdateAccessPolicyBindingParameters']._serialized_options = b'\262\322*h\n2access.UpdateAccessPolicyBindingParametersMetadata\0222access.UpdateAccessPolicyBindingParametersResponse\202\323\344\223\002]2X/organization-manager/v1/organizations/{resource_id}:updateAccessPolicyBindingParameters:\001*'
