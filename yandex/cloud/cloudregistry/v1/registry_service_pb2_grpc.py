...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/cloudregistry/v1/registry_service_pb2_grpc.py depends on'
...
class RegistryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ForceDelete = channel.unary_unary(
                '/yandex.cloud.cloudregistry.v1.RegistryService/ForceDelete',
                request_serializer=yandex_dot_cloud_dot_cloudregistry_dot_v1_dot_registry__service__pb2.DeleteRegistryRequest.SerializeToString,
                response_deserializer=yandex_dot_cloud_dot_operation_dot_operation__pb2.Operation.FromString,
                _registered_method=True)
...
def add_RegistryServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.cloudregistry.v1.RegistryService', rpc_method_handlers)
