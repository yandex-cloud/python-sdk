...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DELETEARTIFACTREQUEST'].fields_by_name['with_history']._loaded_options = None
  _globals['_DELETEARTIFACTREQUEST'].fields_by_name['with_history']._serialized_options = b'\350\3071\000'
