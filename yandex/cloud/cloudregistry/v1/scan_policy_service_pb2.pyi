...
class CreateScanPolicyRequest(google.protobuf.message.Message):
    ...
    @property
    def rules(self) -> yandex.cloud.cloudregistry.v1.scan_policy_pb2.ScanRules:
    ...
    def __init__(
        ...
        *,
        ...
        description: builtins.str = ...,
        scan_lang_packages: builtins.bool = ...,
        rules: yandex.cloud.cloudregistry.v1.scan_policy_pb2.ScanRules | None = ...,
        disabled: builtins.bool = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["rules", b"rules"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "disabled", b"disabled", "name", b"name", "registry_id", b"registry_id", "rules", b"rules", "scan_lang_packages", b"scan_lang_packages"]) -> None: ...
...
class UpdateScanPolicyRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "disabled", b"disabled", "name", b"name", "rules", b"rules", "scan_lang_packages", b"scan_lang_packages", "scan_policy_id", b"scan_policy_id", "update_mask", b"update_mask"]) -> None: ...
