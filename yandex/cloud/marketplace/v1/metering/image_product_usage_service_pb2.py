...
_WRITEIMAGEPRODUCTUSAGEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\202\3101\0041-25'), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_IMAGEPRODUCTUSAGESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0025\"0/marketplace/v1/metering/imageProductUsage/write:\001*'),
  ),
])
