...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/marketplace/v1/metering/image_product_usage_service_pb2_grpc.py depends on'
...
def add_ImageProductUsageServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.marketplace.v1.metering.ImageProductUsageService', rpc_method_handlers)
