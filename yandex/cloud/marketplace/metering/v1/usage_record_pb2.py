...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'yandex.cloud.marketplace.metering.v1.usage_record_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_USAGERECORD'].fields_by_name['uuid']._loaded_options = None
  _globals['_USAGERECORD'].fields_by_name['uuid']._serialized_options = b'\350\3071\001\212\3101\004<=36'
  _globals['_USAGERECORD'].fields_by_name['sku_id']._loaded_options = None
  _globals['_USAGERECORD'].fields_by_name['sku_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _globals['_USAGERECORD'].fields_by_name['quantity']._loaded_options = None
  _globals['_USAGERECORD'].fields_by_name['quantity']._serialized_options = b'\372\3071\002>0'
  _globals['_USAGERECORD'].fields_by_name['timestamp']._loaded_options = None
  _globals['_USAGERECORD'].fields_by_name['timestamp']._serialized_options = b'\350\3071\001'
