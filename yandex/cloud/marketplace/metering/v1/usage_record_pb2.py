...
# source: yandex/cloud/marketplace/metering/v1/usage_record.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='yandex/cloud/marketplace/metering/v1/usage_record.proto',
...
_REJECTEDUSAGERECORD_REASON = _descriptor.EnumDescriptor(
  name='Reason',
  full_name='yandex.cloud.marketplace.metering.v1.RejectedUsageRecord.Reason',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_USAGERECORD = _descriptor.Descriptor(
  name='UsageRecord',
  full_name='yandex.cloud.marketplace.metering.v1.UsageRecord',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='uuid', full_name='yandex.cloud.marketplace.metering.v1.UsageRecord.uuid', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='sku_id', full_name='yandex.cloud.marketplace.metering.v1.UsageRecord.sku_id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='quantity', full_name='yandex.cloud.marketplace.metering.v1.UsageRecord.quantity', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='yandex.cloud.marketplace.metering.v1.UsageRecord.timestamp', index=3,
...
_ACCEPTEDUSAGERECORD = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.marketplace.metering.v1.AcceptedUsageRecord',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='uuid', full_name='yandex.cloud.marketplace.metering.v1.AcceptedUsageRecord.uuid', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REJECTEDUSAGERECORD = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.marketplace.metering.v1.RejectedUsageRecord',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='uuid', full_name='yandex.cloud.marketplace.metering.v1.RejectedUsageRecord.uuid', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='reason', full_name='yandex.cloud.marketplace.metering.v1.RejectedUsageRecord.reason', index=1,
...
UsageRecord = _reflection.GeneratedProtocolMessageType('UsageRecord', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.marketplace.metering.v1.usage_record_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.marketplace.metering.v1.UsageRecord)
  })
...
AcceptedUsageRecord = _reflection.GeneratedProtocolMessageType('AcceptedUsageRecord', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.marketplace.metering.v1.usage_record_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.marketplace.metering.v1.AcceptedUsageRecord)
  })
...
RejectedUsageRecord = _reflection.GeneratedProtocolMessageType('RejectedUsageRecord', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.marketplace.metering.v1.usage_record_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.marketplace.metering.v1.RejectedUsageRecord)
  })
