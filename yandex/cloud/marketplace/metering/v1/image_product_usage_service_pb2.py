...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='yandex/cloud/marketplace/metering/v1/image_product_usage_service.proto',
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,yandex_dot_cloud_dot_validation__pb2.DESCRIPTOR,yandex_dot_cloud_dot_marketplace_dot_metering_dot_v1_dot_usage__record__pb2.DESCRIPTOR,])
...
_WRITEIMAGEPRODUCTUSAGEREQUEST = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.marketplace.metering.v1.WriteImageProductUsageRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='yandex.cloud.marketplace.metering.v1.WriteImageProductUsageRequest.validate_only', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='product_id', full_name='yandex.cloud.marketplace.metering.v1.WriteImageProductUsageRequest.product_id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='usage_records', full_name='yandex.cloud.marketplace.metering.v1.WriteImageProductUsageRequest.usage_records', index=2,
...
_WRITEIMAGEPRODUCTUSAGERESPONSE = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.marketplace.metering.v1.WriteImageProductUsageResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='accepted', full_name='yandex.cloud.marketplace.metering.v1.WriteImageProductUsageResponse.accepted', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rejected', full_name='yandex.cloud.marketplace.metering.v1.WriteImageProductUsageResponse.rejected', index=1,
...
_WRITEIMAGEPRODUCTUSAGEREQUEST.fields_by_name['usage_records'].message_type = yandex_dot_cloud_dot_marketplace_dot_metering_dot_v1_dot_usage__record__pb2._USAGERECORD
_WRITEIMAGEPRODUCTUSAGERESPONSE.fields_by_name['accepted'].message_type = yandex_dot_cloud_dot_marketplace_dot_metering_dot_v1_dot_usage__record__pb2._ACCEPTEDUSAGERECORD
_WRITEIMAGEPRODUCTUSAGERESPONSE.fields_by_name['rejected'].message_type = yandex_dot_cloud_dot_marketplace_dot_metering_dot_v1_dot_usage__record__pb2._REJECTEDUSAGERECORD
...
WriteImageProductUsageRequest = _reflection.GeneratedProtocolMessageType('WriteImageProductUsageRequest', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.marketplace.metering.v1.image_product_usage_service_pb2'
...
_IMAGEPRODUCTUSAGESERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='yandex.cloud.marketplace.metering.v1.ImageProductUsageService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Write',
    full_name='yandex.cloud.marketplace.metering.v1.ImageProductUsageService.Write',
    index=0,
    containing_service=None,
    input_type=_WRITEIMAGEPRODUCTUSAGEREQUEST,
    output_type=_WRITEIMAGEPRODUCTUSAGERESPONSE,
    serialized_options=b'\202\323\344\223\0025\"0/marketplace/metering/v1/imageProductUsage/write:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
