...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/marketplace/pim/v1/saas/product_instance_service_pb2_grpc.py depends on'
...
def add_ProductInstanceServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.marketplace.pim.v1.saas.ProductInstanceService', rpc_method_handlers)
