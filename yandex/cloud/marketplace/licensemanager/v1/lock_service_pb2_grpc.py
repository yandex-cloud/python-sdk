...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/marketplace/licensemanager/v1/lock_service_pb2_grpc.py depends on'
...
def add_LockServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.marketplace.licensemanager.v1.LockService', rpc_method_handlers)
