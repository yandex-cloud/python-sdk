...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GETLOCKBYINSTANCEANDRESOURCEREQUEST.fields_by_name['instance_id']._serialized_options = b'\350\3071\001'
  _GETLOCKBYINSTANCEANDRESOURCEREQUEST.fields_by_name['resource_id']._options = None
  _GETLOCKBYINSTANCEANDRESOURCEREQUEST.fields_by_name['resource_id']._serialized_options = b'\350\3071\001'
  _LISTLOCKSREQUEST.fields_by_name['resource_id']._options = None
  _LISTLOCKSREQUEST.fields_by_name['resource_id']._serialized_options = b'\350\3071\001'
  _LISTLOCKSREQUEST.fields_by_name['folder_id']._options = None
  _LISTLOCKSREQUEST.fields_by_name['folder_id']._serialized_options = b'\350\3071\001'
  _LISTLOCKSREQUEST.fields_by_name['page_size']._options = None
  _LISTLOCKSREQUEST.fields_by_name['page_size']._serialized_options = b'\372\3071\0060-1000'
  _LISTLOCKSREQUEST.fields_by_name['page_token']._options = None
  _LISTLOCKSREQUEST.fields_by_name['page_token']._serialized_options = b'\212\3101\005<=100'
  _LISTLOCKSREQUEST.fields_by_name['filter']._options = None
  _LISTLOCKSREQUEST.fields_by_name['filter']._serialized_options = b'\212\3101\006<=1000'
  _LISTLOCKSREQUEST.fields_by_name['order_by']._options = None
  _LISTLOCKSREQUEST.fields_by_name['order_by']._serialized_options = b'\212\3101\005<=100'
  _LOCKSERVICE.methods_by_name['Get']._options = None
  _LOCKSERVICE.methods_by_name['Get']._serialized_options = b'\202\323\344\223\0021\022//marketplace/license-manager/v1/locks/{lock_id}'
  _LOCKSERVICE.methods_by_name['GetByInstanceAndResource']._options = None
  _LOCKSERVICE.methods_by_name['GetByInstanceAndResource']._serialized_options = b'\202\323\344\223\002@\022>/marketplace/license-manager/v1/locks:getByInstanceAndResource'
  _LOCKSERVICE.methods_by_name['List']._options = None
  _LOCKSERVICE.methods_by_name['List']._serialized_options = b'\202\323\344\223\002\'\022%/marketplace/license-manager/v1/locks'
