...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in yandex/cloud/marketplace/licensemanager/v1/instance_service_pb2_grpc.py depends on'
...
def add_InstanceServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.marketplace.licensemanager.v1.InstanceService', rpc_method_handlers)
