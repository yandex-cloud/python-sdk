...
import yandex.cloud.baremetal.v2.zone_service_pb2
...
class ZoneServiceStub:
    ...
    ListZones: grpc.UnaryUnaryMultiCallable[
...
class ZoneServiceAsyncStub:
    ...
    GetZone: grpc.aio.UnaryUnaryMultiCallable[
        yandex.cloud.baremetal.v2.zone_service_pb2.GetZoneRequest,
        yandex.cloud.baremetal.v2.zone_pb2.Zone,
    ]
    """(-- api-linter: yc::1702::method-no-resource=disabled
    ...
    ListZones: grpc.aio.UnaryUnaryMultiCallable[
        yandex.cloud.baremetal.v2.zone_service_pb2.ListZonesRequest,
        yandex.cloud.baremetal.v2.zone_service_pb2.ListZonesResponse,
    ]
    """(-- api-linter: yc::1702::method-no-resource=disabled
