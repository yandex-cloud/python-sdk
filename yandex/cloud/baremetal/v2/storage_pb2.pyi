...
class StoragePartition(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["mount_point", b"mount_point", "size_bytes", b"size_bytes", "type", b"type"]) -> None: ...
...
class Storage(google.protobuf.message.Message):
    ...
    @property
    def disk(self) -> yandex.cloud.baremetal.v2.disk_pb2.Disk:
        """Disk storage."""
    ...
    def __init__(
        ...
        *,
        ...
        disk: yandex.cloud.baremetal.v2.disk_pb2.Disk | None = ...,
