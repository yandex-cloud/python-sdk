...
import typing
import yandex.cloud.baremetal.v2.zone_pb2
...
class ListZonesResponse(google.protobuf.message.Message):
    ...
    """
    @property
    def zones(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[yandex.cloud.baremetal.v2.zone_pb2.Zone]:
        """List of Zone resources."""

    def __init__(
        self,
        *,
        zones: collections.abc.Iterable[yandex.cloud.baremetal.v2.zone_pb2.Zone] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
