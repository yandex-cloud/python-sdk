...
class GetHardwarePoolRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["hardware_pool_id", b"hardware_pool_id", "zone_id", b"zone_id"]) -> None: ...
...
class ListHardwarePoolsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["page_size", b"page_size", "page_token", b"page_token", "zone_id", b"zone_id"]) -> None: ...
...
class ListHardwarePoolsResponse(google.protobuf.message.Message):
    ...
    """
    @property
    def hardware_pools(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[yandex.cloud.baremetal.v2.hardware_pool_pb2.HardwarePool]:
        """List of HardwarePool resources."""

    def __init__(
        self,
        *,
        hardware_pools: collections.abc.Iterable[yandex.cloud.baremetal.v2.hardware_pool_pb2.HardwarePool] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
