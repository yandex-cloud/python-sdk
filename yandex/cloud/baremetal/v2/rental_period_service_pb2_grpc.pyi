...
import grpc.aio
import typing
import yandex.cloud.baremetal.v2.rental_period_service_pb2
...
class RentalPeriodServiceStub:
    ...
    ListRentalPeriods: grpc.UnaryUnaryMultiCallable[
        yandex.cloud.baremetal.v2.rental_period_service_pb2.ListRentalPeriodsRequest,
...
class RentalPeriodServiceAsyncStub:
    ...
    ListRentalPeriods: grpc.aio.UnaryUnaryMultiCallable[
        yandex.cloud.baremetal.v2.rental_period_service_pb2.ListRentalPeriodsRequest,
        yandex.cloud.baremetal.v2.rental_period_service_pb2.ListRentalPeriodsResponse,
    ]
    """Retrieves the list of RentalPeriod resources.
...
class RentalPeriodServiceServicer(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def ListRentalPeriods(
        self,
        request: yandex.cloud.baremetal.v2.rental_period_service_pb2.ListRentalPeriodsRequest,
