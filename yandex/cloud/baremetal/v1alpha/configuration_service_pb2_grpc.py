...
from yandex.cloud.baremetal.v1alpha import configuration_service_pb2 as yandex_dot_cloud_dot_baremetal_dot_v1alpha_dot_configuration__service__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/baremetal/v1alpha/configuration_service_pb2_grpc.py depends on'
...
class ConfigurationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                '/yandex.cloud.baremetal.v1alpha.ConfigurationService/Get',
                request_serializer=yandex_dot_cloud_dot_baremetal_dot_v1alpha_dot_configuration__service__pb2.GetConfigurationRequest.SerializeToString,
                response_deserializer=yandex_dot_cloud_dot_baremetal_dot_v1alpha_dot_configuration__pb2.Configuration.FromString,
...
def add_ConfigurationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=yandex_dot_cloud_dot_baremetal_dot_v1alpha_dot_configuration__service__pb2.GetConfigurationRequest.FromString,
                    response_serializer=yandex_dot_cloud_dot_baremetal_dot_v1alpha_dot_configuration__pb2.Configuration.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'yandex.cloud.baremetal.v1alpha.ConfigurationService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('yandex.cloud.baremetal.v1alpha.ConfigurationService', rpc_method_handlers)
...
class ConfigurationService(object):
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/yandex.cloud.baremetal.v1alpha.ConfigurationService/Get',
            yandex_dot_cloud_dot_baremetal_dot_v1alpha_dot_configuration__service__pb2.GetConfigurationRequest.SerializeToString,
            yandex_dot_cloud_dot_baremetal_dot_v1alpha_dot_configuration__pb2.Configuration.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
