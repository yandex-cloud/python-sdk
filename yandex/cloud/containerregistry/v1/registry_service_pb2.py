...
_IPPERMISSIONDELTA.fields_by_name['ip_permission'].message_type = yandex_dot_cloud_dot_containerregistry_dot_v1_dot_ip__permission__pb2._IPPERMISSION
...
_UPDATEIPPERMISSIONREQUEST.fields_by_name['ip_permission_deltas'].message_type = _IPPERMISSIONDELTA
