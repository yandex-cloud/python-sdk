...
class ProviderServiceServicer(metaclass=abc.ABCMeta):
    ...
    def ListActivated(
        ...
        context: _ServicerContext,
    ) -> typing.Union[yandex.cloud.cdn.v1.provider_service_pb2.ListActivatedProvidersResponse, collections.abc.Awaitable[yandex.cloud.cdn.v1.provider_service_pb2.ListActivatedProvidersResponse]]:
        """List activated providers for specified client."""
