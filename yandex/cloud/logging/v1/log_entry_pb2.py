...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_LOGENTRY'].fields_by_name['stream_name']._serialized_options = b'\212\3101\004<=71'
  ...
  _globals['_INCOMINGLOGENTRY'].fields_by_name['message']._serialized_options = b'\272\3101\t<=1048576'
  _globals['_INCOMINGLOGENTRY'].fields_by_name['json_payload']._loaded_options = None
  _globals['_INCOMINGLOGENTRY'].fields_by_name['json_payload']._serialized_options = b'\272\3101\t<=1048576'
  _globals['_INCOMINGLOGENTRY'].fields_by_name['stream_name']._loaded_options = None
  _globals['_INCOMINGLOGENTRY'].fields_by_name['stream_name']._serialized_options = b'\212\3101\004<=71'
  _globals['_LOGENTRYDEFAULTS'].fields_by_name['json_payload']._loaded_options = None
  _globals['_LOGENTRYDEFAULTS'].fields_by_name['json_payload']._serialized_options = b'\272\3101\t<=1048576'
  _globals['_LOGENTRYDEFAULTS'].fields_by_name['stream_name']._loaded_options = None
  _globals['_LOGENTRYDEFAULTS'].fields_by_name['stream_name']._serialized_options = b'\212\3101\004<=71'
  ...
  _globals['_INCOMINGLOGENTRY']._serialized_end=839
  _globals['_LOGENTRYDEFAULTS']._serialized_start=842
  _globals['_LOGENTRYDEFAULTS']._serialized_end=1021
  _globals['_DESTINATION']._serialized_start=1024
  _globals['_DESTINATION']._serialized_end=1185
  _globals['_LOGLEVEL']._serialized_start=1188
  _globals['_LOGLEVEL']._serialized_end=1350
  _globals['_LOGLEVEL_LEVEL']._serialized_start=1256
  _globals['_LOGLEVEL_LEVEL']._serialized_end=1350
