...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_LOGENTRYRESOURCE'].fields_by_name['type']._loaded_options = None
  _globals['_LOGENTRYRESOURCE'].fields_by_name['type']._serialized_options = b'\212\3101\004<=63'
  _globals['_LOGENTRYRESOURCE'].fields_by_name['id']._loaded_options = None
  _globals['_LOGENTRYRESOURCE'].fields_by_name['id']._serialized_options = b'\212\3101\004<=63'
