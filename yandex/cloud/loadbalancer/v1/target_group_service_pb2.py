...
GetTargetGroupRequest = _reflection.GeneratedProtocolMessageType('GetTargetGroupRequest', (_message.Message,), dict(
...
ListTargetGroupsRequest = _reflection.GeneratedProtocolMessageType('ListTargetGroupsRequest', (_message.Message,), dict(
...
ListTargetGroupsResponse = _reflection.GeneratedProtocolMessageType('ListTargetGroupsResponse', (_message.Message,), dict(
...
CreateTargetGroupRequest = _reflection.GeneratedProtocolMessageType('CreateTargetGroupRequest', (_message.Message,), dict(
...
CreateTargetGroupMetadata = _reflection.GeneratedProtocolMessageType('CreateTargetGroupMetadata', (_message.Message,), dict(
...
UpdateTargetGroupRequest = _reflection.GeneratedProtocolMessageType('UpdateTargetGroupRequest', (_message.Message,), dict(
...
UpdateTargetGroupMetadata = _reflection.GeneratedProtocolMessageType('UpdateTargetGroupMetadata', (_message.Message,), dict(
...
DeleteTargetGroupRequest = _reflection.GeneratedProtocolMessageType('DeleteTargetGroupRequest', (_message.Message,), dict(
...
DeleteTargetGroupMetadata = _reflection.GeneratedProtocolMessageType('DeleteTargetGroupMetadata', (_message.Message,), dict(
...
AddTargetsMetadata = _reflection.GeneratedProtocolMessageType('AddTargetsMetadata', (_message.Message,), dict(
...
RemoveTargetsMetadata = _reflection.GeneratedProtocolMessageType('RemoveTargetsMetadata', (_message.Message,), dict(
...
ListTargetGroupOperationsRequest = _reflection.GeneratedProtocolMessageType('ListTargetGroupOperationsRequest', (_message.Message,), dict(
...
ListTargetGroupOperationsResponse = _reflection.GeneratedProtocolMessageType('ListTargetGroupOperationsResponse', (_message.Message,), dict(
...
_TARGETGROUPSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0022\0220/load-balancer/v1/targetGroups/{target_group_id}'),
  ),
  _descriptor.MethodDescriptor(
    name='List',
    ...
    serialized_options=_b('\202\323\344\223\002 \022\036/load-balancer/v1/targetGroups'),
  ),
  _descriptor.MethodDescriptor(
    name='Create',
    ...
    serialized_options=_b('\202\323\344\223\002#\"\036/load-balancer/v1/targetGroups:\001*\262\322*(\n\031CreateTargetGroupMetadata\022\013TargetGroup'),
  ),
  _descriptor.MethodDescriptor(
    name='Update',
    ...
    output_type=yandex_dot_cloud_dot_operation_dot_operation__pb2._OPERATION,
    serialized_options=_b('\202\323\344\223\002520/load-balancer/v1/targetGroups/{target_group_id}:\001*\262\322*(\n\031UpdateTargetGroupMetadata\022\013TargetGroup'),
  ),
  _descriptor.MethodDescriptor(
    name='Delete',
    ...
    output_type=yandex_dot_cloud_dot_operation_dot_operation__pb2._OPERATION,
    serialized_options=_b('\202\323\344\223\0022*0/load-balancer/v1/targetGroups/{target_group_id}\262\322*2\n\031DeleteTargetGroupMetadata\022\025google.protobuf.Empty'),
  ),
  _descriptor.MethodDescriptor(
    name='AddTargets',
    ...
    output_type=yandex_dot_cloud_dot_operation_dot_operation__pb2._OPERATION,
    serialized_options=_b('\202\323\344\223\002@\";/load-balancer/v1/targetGroups/{target_group_id}:addTargets:\001*\262\322*!\n\022AddTargetsMetadata\022\013TargetGroup'),
  ),
  _descriptor.MethodDescriptor(
    name='RemoveTargets',
    ...
    output_type=yandex_dot_cloud_dot_operation_dot_operation__pb2._OPERATION,
    serialized_options=_b('\202\323\344\223\002C\">/load-balancer/v1/targetGroups/{target_group_id}:removeTargets:\001*\262\322*$\n\025RemoveTargetsMetadata\022\013TargetGroup'),
  ),
  _descriptor.MethodDescriptor(
    name='ListOperations',
    ...
    serialized_options=_b('\202\323\344\223\002=\022;/load-balancer/v1/targetGroups/{target_group_id}/operations'),
  ),
])
