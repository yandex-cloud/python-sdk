...
class ListTargetGroupsResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        target_groups: collections.abc.Iterable[yandex.cloud.loadbalancer.v1.target_group_pb2.TargetGroup] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
...
class CreateTargetGroupRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        region_id: builtins.str = ...,
        targets: collections.abc.Iterable[yandex.cloud.loadbalancer.v1.target_group_pb2.Target] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "folder_id", b"folder_id", "labels", b"labels", "name", b"name", "region_id", b"region_id", "targets", b"targets"]) -> None: ...
