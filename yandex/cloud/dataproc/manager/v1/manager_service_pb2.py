...
_INITACTSSTATE = _descriptor.EnumDescriptor(
  name='InitActsState',
  full_name='yandex.cloud.dataproc.manager.v1.InitActsState',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='INIT_ACTS_STATE_UNSPECIFIED', index=0, number=0,
...
_sym_db.RegisterEnumDescriptor(_INITACTSSTATE)

InitActsState = enum_type_wrapper.EnumTypeWrapper(_INITACTSSTATE)
...
_LIVYINFO = _descriptor.Descriptor(
  name='LivyInfo',
  full_name='yandex.cloud.dataproc.manager.v1.LivyInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='alive', full_name='yandex.cloud.dataproc.manager.v1.LivyInfo.alive', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INITACTS = _descriptor.Descriptor(
  name='InitActs',
  full_name='yandex.cloud.dataproc.manager.v1.InitActs',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='state', full_name='yandex.cloud.dataproc.manager.v1.InitActs.state', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fqdns', full_name='yandex.cloud.dataproc.manager.v1.InitActs.fqdns', index=1,
...
_INFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='livy', full_name='yandex.cloud.dataproc.manager.v1.Info.livy', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='init_acts', full_name='yandex.cloud.dataproc.manager.v1.Info.init_acts', index=8,
...
_REPORTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='collected_at', full_name='yandex.cloud.dataproc.manager.v1.ReportRequest.collected_at', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INITACTS.fields_by_name['state'].enum_type = _INITACTSSTATE
...
_INFO.fields_by_name['livy'].message_type = _LIVYINFO
_INFO.fields_by_name['init_acts'].message_type = _INITACTS
_REPORTREQUEST.fields_by_name['info'].message_type = _INFO
_REPORTREQUEST.fields_by_name['collected_at'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
...
DESCRIPTOR.message_types_by_name['LivyInfo'] = _LIVYINFO
DESCRIPTOR.message_types_by_name['InitActs'] = _INITACTS
...
DESCRIPTOR.enum_types_by_name['InitActsState'] = _INITACTSSTATE
...
InitActs = _reflection.GeneratedProtocolMessageType('InitActs', (_message.Message,), {
  'DESCRIPTOR' : _INITACTS,
  '__module__' : 'yandex.cloud.dataproc.manager.v1.manager_service_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.dataproc.manager.v1.InitActs)
  })
_sym_db.RegisterMessage(InitActs)
