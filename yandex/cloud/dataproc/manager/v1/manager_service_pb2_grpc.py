...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/dataproc/manager/v1/manager_service_pb2_grpc.py depends on'
...
def add_DataprocManagerServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.dataproc.manager.v1.DataprocManagerService', rpc_method_handlers)
