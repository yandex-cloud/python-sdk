...
_UPDATEJOBSTATUSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='application_info', full_name='yandex.cloud.dataproc.manager.v1.UpdateJobStatusRequest.application_info', index=3,
...
_UPDATEJOBSTATUSREQUEST.fields_by_name['application_info'].message_type = yandex_dot_cloud_dot_dataproc_dot_manager_dot_v1_dot_job__pb2._APPLICATIONINFO
