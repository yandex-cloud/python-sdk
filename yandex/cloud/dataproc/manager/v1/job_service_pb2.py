...
UpdateJobStatusRequest = _reflection.GeneratedProtocolMessageType('UpdateJobStatusRequest', (_message.Message,), dict(
...
UpdateJobStatusResponse = _reflection.GeneratedProtocolMessageType('UpdateJobStatusResponse', (_message.Message,), dict(
