...
_CREATESUBCLUSTERCONFIGSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='assign_public_ip', full_name='yandex.cloud.dataproc.v1.CreateSubclusterConfigSpec.assign_public_ip', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='autoscaling_config', full_name='yandex.cloud.dataproc.v1.CreateSubclusterConfigSpec.autoscaling_config', index=6,
