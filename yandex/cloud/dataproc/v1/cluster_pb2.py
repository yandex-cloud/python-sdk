...
_CLUSTER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ui_proxy', full_name='yandex.cloud.dataproc.v1.Cluster.ui_proxy', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='security_group_ids', full_name='yandex.cloud.dataproc.v1.Cluster.security_group_ids', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='host_group_ids', full_name='yandex.cloud.dataproc.v1.Cluster.host_group_ids', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='deletion_protection', full_name='yandex.cloud.dataproc.v1.Cluster.deletion_protection', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='log_group_id', full_name='yandex.cloud.dataproc.v1.Cluster.log_group_id', index=17,
...
_HADOOPCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='initialization_actions', full_name='yandex.cloud.dataproc.v1.HadoopConfig.initialization_actions', index=3,
...
_INITIALIZATIONACTION = _descriptor.Descriptor(
  name='InitializationAction',
  full_name='yandex.cloud.dataproc.v1.InitializationAction',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='uri', full_name='yandex.cloud.dataproc.v1.InitializationAction.uri', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='args', full_name='yandex.cloud.dataproc.v1.InitializationAction.args', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='yandex.cloud.dataproc.v1.InitializationAction.timeout', index=2,
...
_HADOOPCONFIG.fields_by_name['initialization_actions'].message_type = _INITIALIZATIONACTION
...
DESCRIPTOR.message_types_by_name['InitializationAction'] = _INITIALIZATIONACTION
