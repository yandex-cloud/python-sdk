...
_NODETEMPLATE = _descriptor.Descriptor(
  ...
  nested_types=[_NODETEMPLATE_LABELSENTRY, _NODETEMPLATE_METADATAENTRY, _NODETEMPLATE_NETWORKSETTINGS, _NODETEMPLATE_CONTAINERRUNTIMESETTINGS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
