...
_UPDATENODEGROUPREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='version', full_name='yandex.cloud.k8s.v1.UpdateNodeGroupRequest.version', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='maintenance_policy', full_name='yandex.cloud.k8s.v1.UpdateNodeGroupRequest.maintenance_policy', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='allowed_unsafe_sysctls', full_name='yandex.cloud.k8s.v1.UpdateNodeGroupRequest.allowed_unsafe_sysctls', index=10,
  ...
  nested_types=[_UPDATENODEGROUPREQUEST_LABELSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_CREATENODEGROUPREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='version', full_name='yandex.cloud.k8s.v1.CreateNodeGroupRequest.version', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='maintenance_policy', full_name='yandex.cloud.k8s.v1.CreateNodeGroupRequest.maintenance_policy', index=8,
      number=9, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='allowed_unsafe_sysctls', full_name='yandex.cloud.k8s.v1.CreateNodeGroupRequest.allowed_unsafe_sysctls', index=9,
  ...
  nested_types=[_CREATENODEGROUPREQUEST_LABELSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_UPDATENODEGROUPREQUEST.fields_by_name['node_template'].message_type = yandex_dot_cloud_dot_k8s_dot_v1_dot_node__group__pb2._NODETEMPLATE
...
_CREATENODEGROUPREQUEST.fields_by_name['node_template'].message_type = yandex_dot_cloud_dot_k8s_dot_v1_dot_node__group__pb2._NODETEMPLATE
...
GetNodeGroupRequest = _reflection.GeneratedProtocolMessageType('GetNodeGroupRequest', (_message.Message,), dict(
...
ListNodeGroupsRequest = _reflection.GeneratedProtocolMessageType('ListNodeGroupsRequest', (_message.Message,), dict(
...
ListNodeGroupsResponse = _reflection.GeneratedProtocolMessageType('ListNodeGroupsResponse', (_message.Message,), dict(
...
DeleteNodeGroupRequest = _reflection.GeneratedProtocolMessageType('DeleteNodeGroupRequest', (_message.Message,), dict(
...
DeleteNodeGroupMetadata = _reflection.GeneratedProtocolMessageType('DeleteNodeGroupMetadata', (_message.Message,), dict(
...
UpdateNodeGroupRequest = _reflection.GeneratedProtocolMessageType('UpdateNodeGroupRequest', (_message.Message,), dict(
...
UpdateNodeGroupMetadata = _reflection.GeneratedProtocolMessageType('UpdateNodeGroupMetadata', (_message.Message,), dict(
...
CreateNodeGroupRequest = _reflection.GeneratedProtocolMessageType('CreateNodeGroupRequest', (_message.Message,), dict(
...
CreateNodeGroupMetadata = _reflection.GeneratedProtocolMessageType('CreateNodeGroupMetadata', (_message.Message,), dict(
...
AutoUpgradeNodeGroupMetadata = _reflection.GeneratedProtocolMessageType('AutoUpgradeNodeGroupMetadata', (_message.Message,), dict(
...
ListNodeGroupOperationsRequest = _reflection.GeneratedProtocolMessageType('ListNodeGroupOperationsRequest', (_message.Message,), dict(
...
ListNodeGroupOperationsResponse = _reflection.GeneratedProtocolMessageType('ListNodeGroupOperationsResponse', (_message.Message,), dict(
...
_NODEGROUPSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0023\0221/managed-kubernetes/v1/nodeGroups/{node_group_id}'),
  ),
  _descriptor.MethodDescriptor(
    name='List',
    ...
    serialized_options=_b('\202\323\344\223\002#\022!/managed-kubernetes/v1/nodeGroups'),
  ),
  _descriptor.MethodDescriptor(
    name='Create',
    ...
    serialized_options=_b('\202\323\344\223\002&\"!/managed-kubernetes/v1/nodeGroups:\001*\262\322*$\n\027CreateNodeGroupMetadata\022\tNodeGroup'),
  ),
  _descriptor.MethodDescriptor(
    name='Update',
    ...
    output_type=yandex_dot_cloud_dot_operation_dot_operation__pb2._OPERATION,
    serialized_options=_b('\202\323\344\223\002621/managed-kubernetes/v1/nodeGroups/{node_group_id}:\001*\262\322*$\n\027UpdateNodeGroupMetadata\022\tNodeGroup'),
  ),
  _descriptor.MethodDescriptor(
    name='Delete',
    ...
    output_type=yandex_dot_cloud_dot_operation_dot_operation__pb2._OPERATION,
    serialized_options=_b('\202\323\344\223\0023*1/managed-kubernetes/v1/nodeGroups/{node_group_id}\262\322*0\n\027DeleteNodeGroupMetadata\022\025google.protobuf.Empty'),
  ),
  _descriptor.MethodDescriptor(
    name='ListOperations',
    ...
    serialized_options=_b('\202\323\344\223\002>\022</managed-kubernetes/v1/nodeGroups/{node_group_id}/operations'),
  ),
])
