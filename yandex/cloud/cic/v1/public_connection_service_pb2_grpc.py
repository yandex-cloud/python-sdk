...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/cic/v1/public_connection_service_pb2_grpc.py depends on'
...
def add_PublicConnectionServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.cic.v1.PublicConnectionService', rpc_method_handlers)
