...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/cic/v1/partner_service_pb2_grpc.py depends on'
...
def add_PartnerServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.cic.v1.PartnerService', rpc_method_handlers)
