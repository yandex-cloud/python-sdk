...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PEERING'].fields_by_name['peering_subnet']._serialized_options = b'\212\3101\004<=50'
  _globals['_PEERING'].fields_by_name['peer_ip']._loaded_options = None
  _globals['_PEERING'].fields_by_name['peer_ip']._serialized_options = b'\212\3101\004<=50'
  _globals['_PEERING'].fields_by_name['cloud_ip']._loaded_options = None
  _globals['_PEERING'].fields_by_name['cloud_ip']._serialized_options = b'\212\3101\004<=50'
  _globals['_PEERING'].fields_by_name['cloud_bgp_asn']._loaded_options = None
  _globals['_PEERING'].fields_by_name['cloud_bgp_asn']._serialized_options = b'\030\001'
  ...
  _globals['_PEERING']._serialized_end=274
