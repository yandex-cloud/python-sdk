...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/billing/v1/sku_service_pb2_grpc.py depends on'
...
def add_SkuServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.billing.v1.SkuService', rpc_method_handlers)
