...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/iot/devices/v1/registry_service_pb2_grpc.py depends on'
...
def add_RegistryServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.iot.devices.v1.RegistryService', rpc_method_handlers)
