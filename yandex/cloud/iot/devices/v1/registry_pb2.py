...
RegistryCertificate = _reflection.GeneratedProtocolMessageType('RegistryCertificate', (_message.Message,), dict(
...
DeviceAlias = _reflection.GeneratedProtocolMessageType('DeviceAlias', (_message.Message,), dict(
