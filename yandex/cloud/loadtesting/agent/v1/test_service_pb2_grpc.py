...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/loadtesting/agent/v1/test_service_pb2_grpc.py depends on'
...
def add_TestServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.loadtesting.agent.v1.TestService', rpc_method_handlers)
