...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _UPDATETESTREQUEST.fields_by_name['name']._serialized_options = b'\030\001'
  _UPDATETESTREQUEST.fields_by_name['description']._options = None
  _UPDATETESTREQUEST.fields_by_name['description']._serialized_options = b'\030\001'
  _UPDATETESTREQUEST.fields_by_name['labels']._options = None
  _UPDATETESTREQUEST.fields_by_name['labels']._serialized_options = b'\030\001'
  _UPDATETESTREQUEST.fields_by_name['favorite']._options = None
  _UPDATETESTREQUEST.fields_by_name['favorite']._serialized_options = b'\030\001'
  _UPDATETESTREQUEST.fields_by_name['target_version']._options = None
  _UPDATETESTREQUEST.fields_by_name['target_version']._serialized_options = b'\030\001'
