...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GETTESTREQUEST.fields_by_name['test_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _CREATETESTREQUEST_LABELSENTRY._options = None
  _CREATETESTREQUEST_LABELSENTRY._serialized_options = b'8\001'
  _CREATETESTREQUEST.fields_by_name['folder_id']._options = None
  _CREATETESTREQUEST.fields_by_name['folder_id']._serialized_options = b'\212\3101\004<=50'
  _CREATETESTREQUEST.fields_by_name['name']._options = None
  _CREATETESTREQUEST.fields_by_name['name']._serialized_options = b'\362\3071\035|[a-z][-a-z0-9]{1,61}[a-z0-9]'
  _CREATETESTREQUEST.fields_by_name['description']._options = None
  _CREATETESTREQUEST.fields_by_name['description']._serialized_options = b'\212\3101\005<=256'
  _CREATETESTREQUEST.fields_by_name['labels']._options = None
  _CREATETESTREQUEST.fields_by_name['labels']._serialized_options = b'\362\3071\013[-_0-9a-z]*\202\3101\004<=64\212\3101\004<=63\262\3101\030\022\020[a-z][-_0-9a-z]*\032\0041-63'
  _CREATETESTREQUEST.fields_by_name['agent_instance_id']._options = None
  _CREATETESTREQUEST.fields_by_name['agent_instance_id']._serialized_options = b'\212\3101\004<=50'
  _CREATETESTREQUEST.fields_by_name['target_address']._options = None
  _CREATETESTREQUEST.fields_by_name['target_address']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _CREATETESTREQUEST.fields_by_name['target_version']._options = None
  _CREATETESTREQUEST.fields_by_name['target_version']._serialized_options = b'\212\3101\004<=50'
  _CREATETESTREQUEST.fields_by_name['config']._options = None
  _CREATETESTREQUEST.fields_by_name['config']._serialized_options = b'\350\3071\001'
  _CREATETESTREQUEST.fields_by_name['ammo_id']._options = None
  _CREATETESTREQUEST.fields_by_name['ammo_id']._serialized_options = b'\212\3101\004<=50'
  _CREATETESTREQUEST.fields_by_name['ammo_urls']._options = None
  _CREATETESTREQUEST.fields_by_name['ammo_urls']._serialized_options = b'\212\3101\006<=1024'
  _UPDATETESTREQUEST_LABELSENTRY._options = None
  _UPDATETESTREQUEST_LABELSENTRY._serialized_options = b'8\001'
  _UPDATETESTREQUEST.fields_by_name['test_id']._options = None
  _UPDATETESTREQUEST.fields_by_name['test_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _UPDATETESTREQUEST.fields_by_name['name']._options = None
  _UPDATETESTREQUEST.fields_by_name['name']._serialized_options = b'\362\3071\035|[a-z][-a-z0-9]{1,61}[a-z0-9]'
  _UPDATETESTREQUEST.fields_by_name['description']._options = None
  _UPDATETESTREQUEST.fields_by_name['description']._serialized_options = b'\212\3101\005<=256'
  _UPDATETESTREQUEST.fields_by_name['labels']._options = None
  _UPDATETESTREQUEST.fields_by_name['labels']._serialized_options = b'\362\3071\013[-_0-9a-z]*\202\3101\004<=64\212\3101\004<=63\262\3101\030\022\020[a-z][-_0-9a-z]*\032\0041-63'
  _UPDATETESTREQUEST.fields_by_name['target_version']._options = None
  _UPDATETESTREQUEST.fields_by_name['target_version']._serialized_options = b'\212\3101\004<=50'
  _TESTSERVICE.methods_by_name['Get']._options = None
  _TESTSERVICE.methods_by_name['Get']._serialized_options = b'\202\323\344\223\002\'\022%/loadtesting/agent/v1/tests/{test_id}'
  _TESTSERVICE.methods_by_name['Create']._options = None
  _TESTSERVICE.methods_by_name['Create']._serialized_options = b'\262\322*\032\n\022CreateTestMetadata\022\004Test\202\323\344\223\002 \"\033/loadtesting/agent/v1/tests:\001*'
  _TESTSERVICE.methods_by_name['Update']._options = None
  _TESTSERVICE.methods_by_name['Update']._serialized_options = b'\262\322*\032\n\022UpdateTestMetadata\022\004Test\202\323\344\223\002*2%/loadtesting/agent/v1/tests/{test_id}:\001*'
  _globals['_GETTESTREQUEST']._serialized_start=306
  _globals['_GETTESTREQUEST']._serialized_end=353
  _globals['_CREATETESTREQUEST']._serialized_start=356
  _globals['_CREATETESTREQUEST']._serialized_end=1219
  _globals['_CREATETESTREQUEST_LABELSENTRY']._serialized_start=1174
  _globals['_CREATETESTREQUEST_LABELSENTRY']._serialized_end=1219
  _globals['_CREATETESTMETADATA']._serialized_start=1221
  _globals['_CREATETESTMETADATA']._serialized_end=1258
  _globals['_UPDATETESTREQUEST']._serialized_start=1261
  _globals['_UPDATETESTREQUEST']._serialized_end=1758
  _globals['_UPDATETESTREQUEST_LABELSENTRY']._serialized_start=1174
  _globals['_UPDATETESTREQUEST_LABELSENTRY']._serialized_end=1219
  _globals['_UPDATETESTMETADATA']._serialized_start=1760
  _globals['_UPDATETESTMETADATA']._serialized_end=1797
  _globals['_TESTSERVICE']._serialized_start=1800
  _globals['_TESTSERVICE']._serialized_end=2310
