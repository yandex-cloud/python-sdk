...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CREATECOMPUTEINSTANCE_LABELSENTRY']._loaded_options = None
  _globals['_CREATECOMPUTEINSTANCE_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_CREATECOMPUTEINSTANCE_METADATAENTRY']._loaded_options = None
  _globals['_CREATECOMPUTEINSTANCE_METADATAENTRY']._serialized_options = b'8\001'
  _globals['_CREATECOMPUTEINSTANCE'].fields_by_name['labels']._loaded_options = None
  _globals['_CREATECOMPUTEINSTANCE'].fields_by_name['labels']._serialized_options = b'\362\3071\017[-_./\\@0-9a-z]*\202\3101\004<=64\212\3101\004<=63\262\3101\034\022\024[a-z][-_./\\@0-9a-z]*\032\0041-63'
  _globals['_CREATECOMPUTEINSTANCE'].fields_by_name['zone_id']._loaded_options = None
  _globals['_CREATECOMPUTEINSTANCE'].fields_by_name['zone_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _globals['_CREATECOMPUTEINSTANCE'].fields_by_name['resources_spec']._loaded_options = None
  _globals['_CREATECOMPUTEINSTANCE'].fields_by_name['resources_spec']._serialized_options = b'\350\3071\001'
  _globals['_CREATECOMPUTEINSTANCE'].fields_by_name['boot_disk_spec']._loaded_options = None
  _globals['_CREATECOMPUTEINSTANCE'].fields_by_name['boot_disk_spec']._serialized_options = b'\350\3071\001'
  _globals['_CREATECOMPUTEINSTANCE'].fields_by_name['network_interface_specs']._loaded_options = None
  _globals['_CREATECOMPUTEINSTANCE'].fields_by_name['network_interface_specs']._serialized_options = b'\202\3101\0011'
  _globals['_CREATECOMPUTEINSTANCE']._serialized_start=190
  _globals['_CREATECOMPUTEINSTANCE']._serialized_end=873
