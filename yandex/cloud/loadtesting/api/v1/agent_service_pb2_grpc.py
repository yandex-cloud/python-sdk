...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/loadtesting/api/v1/agent_service_pb2_grpc.py depends on'
...
def add_AgentServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.loadtesting.api.v1.AgentService', rpc_method_handlers)
