...
_UPDATEINSTANCEGROUPREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='application_load_balancer_spec', full_name='yandex.cloud.compute.v1.instancegroup.UpdateInstanceGroupRequest.application_load_balancer_spec', index=14,
...
_UPDATEINSTANCEGROUPREQUEST.fields_by_name['application_load_balancer_spec'].message_type = yandex_dot_cloud_dot_compute_dot_v1_dot_instancegroup_dot_instance__group__pb2._APPLICATIONLOADBALANCERSPEC
