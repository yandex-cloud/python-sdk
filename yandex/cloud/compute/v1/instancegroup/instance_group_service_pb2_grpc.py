...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/compute/v1/instancegroup/instance_group_service_pb2_grpc.py depends on'
...
def add_InstanceGroupServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.compute.v1.instancegroup.InstanceGroupService', rpc_method_handlers)
