...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/compute/v1/gpu_cluster_service_pb2_grpc.py depends on'
...
def add_GpuClusterServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.compute.v1.GpuClusterService', rpc_method_handlers)
