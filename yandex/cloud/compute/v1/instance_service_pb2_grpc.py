...
class InstanceService(object):
    ...
    def ListAccessBindings(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/yandex.cloud.compute.v1.InstanceService/ListAccessBindings',
    ...
    def SetAccessBindings(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/yandex.cloud.compute.v1.InstanceService/SetAccessBindings',
    ...
    def UpdateAccessBindings(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/yandex.cloud.compute.v1.InstanceService/UpdateAccessBindings',
