...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/compute/v1/zone_service_pb2_grpc.py depends on'
...
def add_ZoneServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.compute.v1.ZoneService', rpc_method_handlers)
