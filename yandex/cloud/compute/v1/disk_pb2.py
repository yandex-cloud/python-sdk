...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DISK_LABELSENTRY']._loaded_options = None
  _globals['_DISK_LABELSENTRY']._serialized_options = b'8\001'
