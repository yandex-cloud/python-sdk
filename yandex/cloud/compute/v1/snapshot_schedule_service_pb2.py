...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SNAPSHOTSCHEDULESERVICE.methods_by_name['ListAccessBindings']._options = None
  _SNAPSHOTSCHEDULESERVICE.methods_by_name['ListAccessBindings']._serialized_options = b'\202\323\344\223\002@\022>/compute/v1/snapshotSchedules/{resource_id}:listAccessBindings'
  _SNAPSHOTSCHEDULESERVICE.methods_by_name['SetAccessBindings']._options = None
  _SNAPSHOTSCHEDULESERVICE.methods_by_name['SetAccessBindings']._serialized_options = b'\262\322*H\n access.SetAccessBindingsMetadata\022$access.AccessBindingsOperationResult\202\323\344\223\002B\"=/compute/v1/snapshotSchedules/{resource_id}:setAccessBindings:\001*'
  _SNAPSHOTSCHEDULESERVICE.methods_by_name['UpdateAccessBindings']._options = None
  _SNAPSHOTSCHEDULESERVICE.methods_by_name['UpdateAccessBindings']._serialized_options = b'\262\322*K\n#access.UpdateAccessBindingsMetadata\022$access.AccessBindingsOperationResult\202\323\344\223\002E\"@/compute/v1/snapshotSchedules/{resource_id}:updateAccessBindings:\001*'
