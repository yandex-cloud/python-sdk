...
class SnapshotScheduleService(object):
    ...
    def ListAccessBindings(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/yandex.cloud.compute.v1.SnapshotScheduleService/ListAccessBindings',
    ...
    def SetAccessBindings(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/yandex.cloud.compute.v1.SnapshotScheduleService/SetAccessBindings',
    ...
    def UpdateAccessBindings(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/yandex.cloud.compute.v1.SnapshotScheduleService/UpdateAccessBindings',
