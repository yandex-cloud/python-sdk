...
_APIKEYSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\036*\034/iam/v1/apiKeys/{api_key_id}\262\322*-\n\024DeleteApiKeyMetadata\022\025google.protobuf.Empty'),
  ),
  _descriptor.MethodDescriptor(
    name='ListOperations',
    ...
    serialized_options=_b('\202\323\344\223\002)\022\'/iam/v1/apiKeys/{api_key_id}/operations'),
  ),
])
