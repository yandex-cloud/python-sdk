...
_GETROLEREQUEST.fields_by_name['role_id'].has_options = True
_GETROLEREQUEST.fields_by_name['role_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\350\3071\001\212\3101\004<=50'))
_LISTROLESREQUEST.fields_by_name['page_size'].has_options = True
_LISTROLESREQUEST.fields_by_name['page_size']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\372\3071\006<=1000'))
_LISTROLESREQUEST.fields_by_name['page_token'].has_options = True
_LISTROLESREQUEST.fields_by_name['page_token']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\212\3101\005<=100'))
_LISTROLESREQUEST.fields_by_name['filter'].has_options = True
_LISTROLESREQUEST.fields_by_name['filter']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\212\3101\006<=1000'))
...
_ROLESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\031\022\027/iam/v1/roles/{role_id}')),
  ),
  _descriptor.MethodDescriptor(
    name='List',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\017\022\r/iam/v1/roles')),
  ),
])
