...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in yandex/cloud/iam/v1/awscompatibility/access_key_service_pb2_grpc.py depends on'
...
def add_AccessKeyServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.iam.v1.awscompatibility.AccessKeyService', rpc_method_handlers)
