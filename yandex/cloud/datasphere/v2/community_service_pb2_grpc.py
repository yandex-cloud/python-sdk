...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in yandex/cloud/datasphere/v2/community_service_pb2_grpc.py depends on'
...
def add_CommunityServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.datasphere.v2.CommunityService', rpc_method_handlers)
