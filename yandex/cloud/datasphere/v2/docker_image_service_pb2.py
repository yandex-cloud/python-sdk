...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ACTIVATEDOCKERIMAGEREQUEST.fields_by_name['project_id']._options = None
  _ACTIVATEDOCKERIMAGEREQUEST.fields_by_name['project_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _ACTIVATEDOCKERIMAGEREQUEST.fields_by_name['docker_id']._options = None
  _ACTIVATEDOCKERIMAGEREQUEST.fields_by_name['docker_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _DOCKERIMAGESERVICE.methods_by_name['Activate']._options = None
  _DOCKERIMAGESERVICE.methods_by_name['Activate']._serialized_options = b'\262\322*\027\022\025google.protobuf.Empty\202\323\344\223\002#\"\036/datasphere/v2/docker/activate:\001*'
