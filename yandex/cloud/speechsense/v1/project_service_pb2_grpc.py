...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/speechsense/v1/project_service_pb2_grpc.py depends on'
...
def add_ProjectServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.speechsense.v1.ProjectService', rpc_method_handlers)
