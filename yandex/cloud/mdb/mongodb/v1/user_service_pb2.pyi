...
class ListUsersResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        users: collections.abc.Iterable[yandex.cloud.mdb.mongodb.v1.user_pb2.User] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
...
class CreateUserRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        cluster_id: builtins.str = ...,
        user_spec: yandex.cloud.mdb.mongodb.v1.user_pb2.UserSpec | None = ...,
    ) -> None: ...
...
class UpdateUserRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["deletion_protection", b"deletion_protection", "generate_password", b"generate_password", "update_mask", b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cluster_id", b"cluster_id", "deletion_protection", b"deletion_protection", "generate_password", b"generate_password", "password", b"password", "permissions", b"permissions", "update_mask", b"update_mask", "user_name", b"user_name"]) -> None: ...
...
class GrantUserPermissionRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        cluster_id: builtins.str = ...,
        user_name: builtins.str = ...,
        permission: yandex.cloud.mdb.mongodb.v1.user_pb2.Permission | None = ...,
    ) -> None: ...
