...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'yandex.cloud.mdb.mongodb.v1.resource_preset_service_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RESOURCEPRESETSERVICE'].methods_by_name['Get']._serialized_options = b'\202\323\344\223\002:\0228/managed-mongodb/v1/resourcePresets/{resource_preset_id}'
  _globals['_RESOURCEPRESETSERVICE'].methods_by_name['List']._loaded_options = None
  _globals['_RESOURCEPRESETSERVICE'].methods_by_name['List']._serialized_options = b'\202\323\344\223\002%\022#/managed-mongodb/v1/resourcePresets'
