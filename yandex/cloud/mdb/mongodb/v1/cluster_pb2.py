...
_MONGODB4_2 = _descriptor.Descriptor(
  ...
  nested_types=[_MONGODB4_2_MONGOD, _MONGODB4_2_MONGOCFG, _MONGODB4_2_MONGOS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
