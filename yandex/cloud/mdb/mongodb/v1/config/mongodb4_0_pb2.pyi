...
class MongodConfig4_0(google.protobuf.message.Message):
    ...
    class Storage(google.protobuf.message.Message):
        ...
        class WiredTiger(google.protobuf.message.Message):
            ...
            def __init__(
                self,
                *,
                engine_config: global___MongodConfig4_0.Storage.WiredTiger.EngineConfig | None = ...,
                collection_config: global___MongodConfig4_0.Storage.WiredTiger.CollectionConfig | None = ...,
            ) -> None: ...
        ...
        def __init__(
            self,
            *,
            wired_tiger: global___MongodConfig4_0.Storage.WiredTiger | None = ...,
            journal: global___MongodConfig4_0.Storage.Journal | None = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        *,
        storage: global___MongodConfig4_0.Storage | None = ...,
        operation_profiling: global___MongodConfig4_0.OperationProfiling | None = ...,
        net: global___MongodConfig4_0.Network | None = ...,
    ) -> None: ...
...
class MongoCfgConfig4_0(google.protobuf.message.Message):
    ...
    class Storage(google.protobuf.message.Message):
        ...
        class WiredTiger(google.protobuf.message.Message):
            ...
            def __init__(
                self,
                *,
                engine_config: global___MongoCfgConfig4_0.Storage.WiredTiger.EngineConfig | None = ...,
            ) -> None: ...
        ...
        def __init__(
            self,
            *,
            wired_tiger: global___MongoCfgConfig4_0.Storage.WiredTiger | None = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        *,
        storage: global___MongoCfgConfig4_0.Storage | None = ...,
        operation_profiling: global___MongoCfgConfig4_0.OperationProfiling | None = ...,
        net: global___MongoCfgConfig4_0.Network | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["net", b"net", "operation_profiling", b"operation_profiling", "storage", b"storage"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["net", b"net", "operation_profiling", b"operation_profiling", "storage", b"storage"]) -> None: ...
...
class MongosConfig4_0(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        net: global___MongosConfig4_0.Network | None = ...,
    ) -> None: ...
...
class MongodConfigSet4_0(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        effective_config: global___MongodConfig4_0 | None = ...,
        user_config: global___MongodConfig4_0 | None = ...,
        default_config: global___MongodConfig4_0 | None = ...,
    ) -> None: ...
...
class MongoCfgConfigSet4_0(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        effective_config: global___MongoCfgConfig4_0 | None = ...,
        user_config: global___MongoCfgConfig4_0 | None = ...,
        default_config: global___MongoCfgConfig4_0 | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["default_config", b"default_config", "effective_config", b"effective_config", "user_config", b"user_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["default_config", b"default_config", "effective_config", b"effective_config", "user_config", b"user_config"]) -> None: ...
...
class MongosConfigSet4_0(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        effective_config: global___MongosConfig4_0 | None = ...,
        user_config: global___MongosConfig4_0 | None = ...,
        default_config: global___MongosConfig4_0 | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["default_config", b"default_config", "effective_config", b"effective_config", "user_config", b"user_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["default_config", b"default_config", "effective_config", b"effective_config", "user_config", b"user_config"]) -> None: ...
