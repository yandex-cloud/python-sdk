...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/mdb/elasticsearch/v1/extension_service_pb2_grpc.py depends on'
...
def add_ExtensionServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.mdb.elasticsearch.v1.ExtensionService', rpc_method_handlers)
