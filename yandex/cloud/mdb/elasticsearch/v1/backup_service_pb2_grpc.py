...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/mdb/elasticsearch/v1/backup_service_pb2_grpc.py depends on'
...
def add_BackupServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.mdb.elasticsearch.v1.BackupService', rpc_method_handlers)
