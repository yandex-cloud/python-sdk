...
class BackupServiceServicer(metaclass=abc.ABCMeta):
    ...
    ) -> typing.Union[yandex.cloud.mdb.greenplum.v1.backup_pb2.Backup, collections.abc.Awaitable[yandex.cloud.mdb.greenplum.v1.backup_pb2.Backup]]:
        """Returns the specified backup of Greenplum® cluster."""
    ...
    def List(
        ...
        context: _ServicerContext,
    ) -> typing.Union[yandex.cloud.mdb.greenplum.v1.backup_service_pb2.ListBackupsResponse, collections.abc.Awaitable[yandex.cloud.mdb.greenplum.v1.backup_service_pb2.ListBackupsResponse]]:
        """Returns the list of available backups for the specified Greenplum® cluster."""
