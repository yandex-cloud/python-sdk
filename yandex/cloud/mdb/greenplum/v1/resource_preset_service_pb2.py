...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='yandex/cloud/mdb/greenplum/v1/resource_preset_service.proto',
...
_GETRESOURCEPRESETREQUEST = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.mdb.greenplum.v1.GetResourcePresetRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_preset_id', full_name='yandex.cloud.mdb.greenplum.v1.GetResourcePresetRequest.resource_preset_id', index=0,
...
_LISTRESOURCEPRESETSREQUEST = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.mdb.greenplum.v1.ListResourcePresetsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='page_size', full_name='yandex.cloud.mdb.greenplum.v1.ListResourcePresetsRequest.page_size', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='page_token', full_name='yandex.cloud.mdb.greenplum.v1.ListResourcePresetsRequest.page_token', index=1,
...
_LISTRESOURCEPRESETSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.mdb.greenplum.v1.ListResourcePresetsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_presets', full_name='yandex.cloud.mdb.greenplum.v1.ListResourcePresetsResponse.resource_presets', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='yandex.cloud.mdb.greenplum.v1.ListResourcePresetsResponse.next_page_token', index=1,
...
GetResourcePresetRequest = _reflection.GeneratedProtocolMessageType('GetResourcePresetRequest', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.greenplum.v1.resource_preset_service_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.greenplum.v1.GetResourcePresetRequest)
  })
...
ListResourcePresetsRequest = _reflection.GeneratedProtocolMessageType('ListResourcePresetsRequest', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.greenplum.v1.resource_preset_service_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.greenplum.v1.ListResourcePresetsRequest)
  })
...
ListResourcePresetsResponse = _reflection.GeneratedProtocolMessageType('ListResourcePresetsResponse', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.greenplum.v1.resource_preset_service_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.greenplum.v1.ListResourcePresetsResponse)
  })
...
_RESOURCEPRESETSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='yandex.cloud.mdb.greenplum.v1.ResourcePresetService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Get',
    full_name='yandex.cloud.mdb.greenplum.v1.ResourcePresetService.Get',
    index=0,
    containing_service=None,
    input_type=_GETRESOURCEPRESETREQUEST,
    output_type=yandex_dot_cloud_dot_mdb_dot_greenplum_dot_v1_dot_resource__preset__pb2._RESOURCEPRESET,
    serialized_options=b'\202\323\344\223\002<\022:/managed-greenplum/v1/resourcePresets/{resource_preset_id}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='List',
    full_name='yandex.cloud.mdb.greenplum.v1.ResourcePresetService.List',
    index=1,
    containing_service=None,
    input_type=_LISTRESOURCEPRESETSREQUEST,
    output_type=_LISTRESOURCEPRESETSRESPONSE,
    serialized_options=b'\202\323\344\223\002\'\022%/managed-greenplum/v1/resourcePresets',
    create_key=_descriptor._internal_create_key,
  ),
])
