...
_LISTCLUSTERLOGSREQUEST_SERVICETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='GREENPLUM_PXF', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_CONFIGSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='greenplum_config_6_21', full_name='yandex.cloud.mdb.greenplum.v1.ConfigSpec.greenplum_config_6_21', index=2,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='greenplumConfig_6_21', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='greenplum_config_6_22', full_name='yandex.cloud.mdb.greenplum.v1.ConfigSpec.greenplum_config_6_22', index=3,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='greenplumConfig_6_22', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pool', full_name='yandex.cloud.mdb.greenplum.v1.ConfigSpec.pool', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='background_activities', full_name='yandex.cloud.mdb.greenplum.v1.ConfigSpec.background_activities', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pxf_config', full_name='yandex.cloud.mdb.greenplum.v1.ConfigSpec.pxf_config', index=6,
      number=8, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADDCLUSTERHOSTSMETADATA = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.mdb.greenplum.v1.AddClusterHostsMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='cluster_id', full_name='yandex.cloud.mdb.greenplum.v1.AddClusterHostsMetadata.cluster_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXPANDREQUEST = _descriptor.Descriptor(
  name='ExpandRequest',
  full_name='yandex.cloud.mdb.greenplum.v1.ExpandRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='cluster_id', full_name='yandex.cloud.mdb.greenplum.v1.ExpandRequest.cluster_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\350\3071\001\212\3101\004<=50', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='segment_host_count', full_name='yandex.cloud.mdb.greenplum.v1.ExpandRequest.segment_host_count', index=1,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='add_segments_per_host_count', full_name='yandex.cloud.mdb.greenplum.v1.ExpandRequest.add_segments_per_host_count', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='duration', full_name='yandex.cloud.mdb.greenplum.v1.ExpandRequest.duration', index=3,
...
_RESTORECLUSTERREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\350\3071\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='time', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.time', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='folder_id', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.folder_id', index=2,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\350\3071\001\212\3101\004<=50', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='name', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.name', index=3,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\350\3071\001\212\3101\004<=63\362\3071\016[a-zA-Z0-9_-]*', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='description', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.description', index=4,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\212\3101\005<=256', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='labels', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.labels', index=5,
      ...
      serialized_options=b'\202\3101\004<=64\212\3101\004<=63\362\3071\013[-_0-9a-z]*\262\3101\006\032\004<=63\262\3101\022\022\020[a-z][-_0-9a-z]*', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='environment', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.environment', index=6,
      ...
      serialized_options=b'\350\3071\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='config', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.config', index=7,
      number=7, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='master_resources', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.master_resources', index=8,
      number=8, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='segment_resources', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.segment_resources', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='network_id', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.network_id', index=10,
      ...
      serialized_options=b'\350\3071\001\212\3101\004<=50', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='security_group_ids', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.security_group_ids', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='deletion_protection', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.deletion_protection', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='host_group_ids', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.host_group_ids', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='placement_group_id', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.placement_group_id', index=14,
      number=14, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='maintenance_window', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.maintenance_window', index=15,
      number=15, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='segment_host_count', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.segment_host_count', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='segment_in_host', full_name='yandex.cloud.mdb.greenplum.v1.RestoreClusterRequest.segment_in_host', index=17,
...
_CONFIGSPEC.fields_by_name['greenplum_config_6_21'].message_type = yandex_dot_cloud_dot_mdb_dot_greenplum_dot_v1_dot_config__pb2._GREENPLUMCONFIG6_21
_CONFIGSPEC.fields_by_name['greenplum_config_6_22'].message_type = yandex_dot_cloud_dot_mdb_dot_greenplum_dot_v1_dot_config__pb2._GREENPLUMCONFIG6_22
...
_CONFIGSPEC.fields_by_name['background_activities'].message_type = yandex_dot_cloud_dot_mdb_dot_greenplum_dot_v1_dot_config__pb2._BACKGROUNDACTIVITIESCONFIG
_CONFIGSPEC.fields_by_name['pxf_config'].message_type = yandex_dot_cloud_dot_mdb_dot_greenplum_dot_v1_dot_pxf__pb2._PXFCONFIG
...
_CONFIGSPEC.oneofs_by_name['greenplum_config'].fields.append(
  _CONFIGSPEC.fields_by_name['greenplum_config_6_21'])
_CONFIGSPEC.fields_by_name['greenplum_config_6_21'].containing_oneof = _CONFIGSPEC.oneofs_by_name['greenplum_config']
_CONFIGSPEC.oneofs_by_name['greenplum_config'].fields.append(
  _CONFIGSPEC.fields_by_name['greenplum_config_6_22'])
_CONFIGSPEC.fields_by_name['greenplum_config_6_22'].containing_oneof = _CONFIGSPEC.oneofs_by_name['greenplum_config']
...
AddClusterHostsMetadata = _reflection.GeneratedProtocolMessageType('AddClusterHostsMetadata', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.greenplum.v1.cluster_service_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.greenplum.v1.AddClusterHostsMetadata)
  })
...
ExpandRequest = _reflection.GeneratedProtocolMessageType('ExpandRequest', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.greenplum.v1.cluster_service_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.greenplum.v1.ExpandRequest)
  })
...
_CLUSTERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Expand',
    full_name='yandex.cloud.mdb.greenplum.v1.ClusterService.Expand',
    index=4,
    containing_service=None,
    input_type=_EXPANDREQUEST,
    output_type=yandex_dot_cloud_dot_operation_dot_operation__pb2._OPERATION,
    serialized_options=b'\202\323\344\223\0027\"2/managed-greenplum/v1/clusters/{cluster_id}/expand:\001*\262\322*\"\n\027AddClusterHostsMetadata\022\007Cluster',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='Delete',
