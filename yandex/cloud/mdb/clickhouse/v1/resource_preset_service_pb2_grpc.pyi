...
import grpc.aio
import typing
import yandex.cloud.mdb.clickhouse.v1.resource_preset_pb2
import yandex.cloud.mdb.clickhouse.v1.resource_preset_service_pb2
...
class ResourcePresetServiceServicer(metaclass=abc.ABCMeta):
    ...
    ) -> typing.Union[yandex.cloud.mdb.clickhouse.v1.resource_preset_pb2.ResourcePreset, collections.abc.Awaitable[yandex.cloud.mdb.clickhouse.v1.resource_preset_pb2.ResourcePreset]]:
        """Returns the specified ResourcePreset resource.
    ...
    def List(
        ...
        context: _ServicerContext,
    ) -> typing.Union[yandex.cloud.mdb.clickhouse.v1.resource_preset_service_pb2.ListResourcePresetsResponse, collections.abc.Awaitable[yandex.cloud.mdb.clickhouse.v1.resource_preset_service_pb2.ListResourcePresetsResponse]]:
        """Retrieves the list of available ResourcePreset resources."""
