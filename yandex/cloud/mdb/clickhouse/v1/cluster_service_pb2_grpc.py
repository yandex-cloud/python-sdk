...
class ClusterServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.StreamLogs = channel.unary_stream(
        ...
        response_deserializer=yandex_dot_cloud_dot_mdb_dot_clickhouse_dot_v1_dot_cluster__service__pb2.LogRecord.FromString,
        )
...
def add_ClusterServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'StreamLogs': grpc.unary_stream_rpc_method_handler(
          ...
          response_serializer=yandex_dot_cloud_dot_mdb_dot_clickhouse_dot_v1_dot_cluster__service__pb2.LogRecord.SerializeToString,
      ),
