...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/mdb/clickhouse/v1/user_service_pb2_grpc.py depends on'
...
def add_UserServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.mdb.clickhouse.v1.UserService', rpc_method_handlers)
