...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/mdb/clickhouse/v1/backup_service_pb2_grpc.py depends on'
...
class BackupServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                ...
                request_serializer=yandex_dot_cloud_dot_mdb_dot_clickhouse_dot_v1_dot_backup__service__pb2.GetBackupRequest.SerializeToString,
                response_deserializer=yandex_dot_cloud_dot_mdb_dot_clickhouse_dot_v1_dot_backup__pb2.Backup.FromString,
...
def add_BackupServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=yandex_dot_cloud_dot_mdb_dot_clickhouse_dot_v1_dot_backup__service__pb2.GetBackupRequest.FromString,
                    response_serializer=yandex_dot_cloud_dot_mdb_dot_clickhouse_dot_v1_dot_backup__pb2.Backup.SerializeToString,
            ),
    ...
    server.add_registered_method_handlers('yandex.cloud.mdb.clickhouse.v1.BackupService', rpc_method_handlers)
...
class BackupService(object):
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/yandex.cloud.mdb.clickhouse.v1.BackupService/Get',
            yandex_dot_cloud_dot_mdb_dot_clickhouse_dot_v1_dot_backup__service__pb2.GetBackupRequest.SerializeToString,
            yandex_dot_cloud_dot_mdb_dot_clickhouse_dot_v1_dot_backup__pb2.Backup.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
