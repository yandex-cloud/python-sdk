...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _USERSETTINGS.fields_by_name['max_insert_threads']._options = None
  _USERSETTINGS.fields_by_name['max_insert_threads']._serialized_options = b'\372\3071\003>=0'
  _USERSETTINGS.fields_by_name['idle_connection_timeout']._options = None
  _USERSETTINGS.fields_by_name['idle_connection_timeout']._serialized_options = b'\372\3071\003>=0'
  _USERSETTINGS.fields_by_name['hedged_connection_timeout_ms']._options = None
  _USERSETTINGS.fields_by_name['hedged_connection_timeout_ms']._serialized_options = b'\372\3071\003>=0'
