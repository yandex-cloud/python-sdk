...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_LISTMLMODELSREQUEST'].fields_by_name['page_size']._serialized_options = b'\372\3071\006<=1000'
  _globals['_LISTMLMODELSREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTMLMODELSREQUEST'].fields_by_name['page_token']._serialized_options = b'\212\3101\005<=100'
  _globals['_CREATEMLMODELREQUEST'].fields_by_name['cluster_id']._loaded_options = None
  _globals['_CREATEMLMODELREQUEST'].fields_by_name['cluster_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _globals['_CREATEMLMODELREQUEST'].fields_by_name['ml_model_name']._loaded_options = None
  _globals['_CREATEMLMODELREQUEST'].fields_by_name['ml_model_name']._serialized_options = b'\350\3071\001\362\3071\016[a-zA-Z0-9_-]*\212\3101\004<=63'
  _globals['_CREATEMLMODELREQUEST'].fields_by_name['type']._loaded_options = None
  _globals['_CREATEMLMODELREQUEST'].fields_by_name['type']._serialized_options = b'\350\3071\001'
  _globals['_CREATEMLMODELREQUEST'].fields_by_name['uri']._loaded_options = None
  _globals['_CREATEMLMODELREQUEST'].fields_by_name['uri']._serialized_options = b'\350\3071\001'
  ...
  _globals['_MLMODELSERVICE'].methods_by_name['List']._serialized_options = b'\202\323\344\223\0027\0225/managed-clickhouse/v1/clusters/{cluster_id}/mlModels'
  _globals['_MLMODELSERVICE'].methods_by_name['Create']._loaded_options = None
  _globals['_MLMODELSERVICE'].methods_by_name['Create']._serialized_options = b'\262\322* \n\025CreateMlModelMetadata\022\007MlModel\202\323\344\223\002:\"5/managed-clickhouse/v1/clusters/{cluster_id}/mlModels:\001*'
  _globals['_MLMODELSERVICE'].methods_by_name['Update']._loaded_options = None
  _globals['_MLMODELSERVICE'].methods_by_name['Update']._serialized_options = b'\262\322* \n\025UpdateMlModelMetadata\022\007MlModel\202\323\344\223\002J2E/managed-clickhouse/v1/clusters/{cluster_id}/mlModels/{ml_model_name}:\001*'
