...
_CONNECTORSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='connector_config_s3_sink', full_name='yandex.cloud.mdb.kafka.v1.ConnectorSpec.connector_config_s3_sink', index=4,
...
_UPDATECONNECTORSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='connector_config_s3_sink', full_name='yandex.cloud.mdb.kafka.v1.UpdateConnectorSpec.connector_config_s3_sink', index=3,
      number=11, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXTERNALCLUSTERCONNECTIONSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ssl_truststore_certificates', full_name='yandex.cloud.mdb.kafka.v1.ExternalClusterConnectionSpec.ssl_truststore_certificates', index=5,
...
_CONNECTOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='connector_config_s3_sink', full_name='yandex.cloud.mdb.kafka.v1.Connector.connector_config_s3_sink', index=7,
      number=11, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CONNECTORCONFIGS3SINK = _descriptor.Descriptor(
  name='ConnectorConfigS3Sink',
  full_name='yandex.cloud.mdb.kafka.v1.ConnectorConfigS3Sink',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='topics', full_name='yandex.cloud.mdb.kafka.v1.ConnectorConfigS3Sink.topics', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='file_compression_type', full_name='yandex.cloud.mdb.kafka.v1.ConnectorConfigS3Sink.file_compression_type', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='file_max_records', full_name='yandex.cloud.mdb.kafka.v1.ConnectorConfigS3Sink.file_max_records', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='s3_connection', full_name='yandex.cloud.mdb.kafka.v1.ConnectorConfigS3Sink.s3_connection', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CONNECTORSPEC.fields_by_name['connector_config_s3_sink'].message_type = _CONNECTORCONFIGS3SINKSPEC
...
_CONNECTORSPEC.oneofs_by_name['connector_config'].fields.append(
  _CONNECTORSPEC.fields_by_name['connector_config_s3_sink'])
_CONNECTORSPEC.fields_by_name['connector_config_s3_sink'].containing_oneof = _CONNECTORSPEC.oneofs_by_name['connector_config']
...
_UPDATECONNECTORSPEC.fields_by_name['connector_config_s3_sink'].message_type = _UPDATECONNECTORCONFIGS3SINKSPEC
...
_UPDATECONNECTORSPEC.oneofs_by_name['connector_config'].fields.append(
  _UPDATECONNECTORSPEC.fields_by_name['connector_config_s3_sink'])
_UPDATECONNECTORSPEC.fields_by_name['connector_config_s3_sink'].containing_oneof = _UPDATECONNECTORSPEC.oneofs_by_name['connector_config']
...
_CONNECTOR.fields_by_name['connector_config_s3_sink'].message_type = _CONNECTORCONFIGS3SINK
...
_CONNECTOR.oneofs_by_name['connector_config'].fields.append(
  _CONNECTOR.fields_by_name['connector_config_s3_sink'])
_CONNECTOR.fields_by_name['connector_config_s3_sink'].containing_oneof = _CONNECTOR.oneofs_by_name['connector_config']
...
ExternalS3Storage = _reflection.GeneratedProtocolMessageType('ExternalS3Storage', (_message.Message,), {
  'DESCRIPTOR' : _EXTERNALS3STORAGE,
  '__module__' : 'yandex.cloud.mdb.kafka.v1.connector_pb2'
