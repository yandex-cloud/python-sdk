...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in yandex/cloud/mdb/kafka/v1/maintenance_service_pb2_grpc.py depends on'
...
def add_MaintenanceServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'yandex.cloud.mdb.kafka.v1.MaintenanceService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('yandex.cloud.mdb.kafka.v1.MaintenanceService', rpc_method_handlers)
