...
class Topic(google.protobuf.message.Message):
    ...
    TOPIC_CONFIG_4_FIELD_NUMBER: builtins.int
    name: builtins.str
    """Name of the topic."""
    ...
    def __init__(
        ...
        *,
        ...
        topic_config_4: global___TopicConfig4 | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["partitions", b"partitions", "replication_factor", b"replication_factor", "topic_config", b"topic_config", "topic_config_2_8", b"topic_config_2_8", "topic_config_3", b"topic_config_3", "topic_config_4", b"topic_config_4"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cluster_id", b"cluster_id", "name", b"name", "partitions", b"partitions", "replication_factor", b"replication_factor", "topic_config", b"topic_config", "topic_config_2_8", b"topic_config_2_8", "topic_config_3", b"topic_config_3", "topic_config_4", b"topic_config_4"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["topic_config", b"topic_config"]) -> typing.Literal["topic_config_2_8", "topic_config_3", "topic_config_4"] | None: ...
...
class TopicSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["partitions", b"partitions", "replication_factor", b"replication_factor", "topic_config", b"topic_config", "topic_config_2_8", b"topic_config_2_8", "topic_config_3", b"topic_config_3", "topic_config_4", b"topic_config_4"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["name", b"name", "partitions", b"partitions", "replication_factor", b"replication_factor", "topic_config", b"topic_config", "topic_config_2_8", b"topic_config_2_8", "topic_config_3", b"topic_config_3", "topic_config_4", b"topic_config_4"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["topic_config", b"topic_config"]) -> typing.Literal["topic_config_2_8", "topic_config_3", "topic_config_4"] | None: ...
...
@typing.final
class TopicConfig4(google.protobuf.message.Message):
    ...
    class _CleanupPolicyEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[TopicConfig4._CleanupPolicy.ValueType], builtins.type):
        ...
        """This policy compacts messages in log."""
        CLEANUP_POLICY_COMPACT_AND_DELETE: TopicConfig4._CleanupPolicy.ValueType  # 3
        """This policy use both compaction and deletion for messages and log segments."""
    ...
    """This policy compacts messages in log."""
    CLEANUP_POLICY_COMPACT_AND_DELETE: TopicConfig4.CleanupPolicy.ValueType  # 3
    """This policy use both compaction and deletion for messages and log segments."""
