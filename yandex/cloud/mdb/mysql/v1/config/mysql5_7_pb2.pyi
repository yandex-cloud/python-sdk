...
class MysqlConfig5_7(google.protobuf.message.Message):
    ...
    class _SQLModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[MysqlConfig5_7._SQLMode.ValueType], builtins.type):
        ...
        ANSI_QUOTES: MysqlConfig5_7._SQLMode.ValueType  # 2
        ...
        ERROR_FOR_DIVISION_BY_ZERO: MysqlConfig5_7._SQLMode.ValueType  # 3
        ...
        HIGH_NOT_PRECEDENCE: MysqlConfig5_7._SQLMode.ValueType  # 4
        ...
        IGNORE_SPACE: MysqlConfig5_7._SQLMode.ValueType  # 5
        ...
        NO_AUTO_VALUE_ON_ZERO: MysqlConfig5_7._SQLMode.ValueType  # 6
        ...
        NO_BACKSLASH_ESCAPES: MysqlConfig5_7._SQLMode.ValueType  # 7
        ...
        NO_ENGINE_SUBSTITUTION: MysqlConfig5_7._SQLMode.ValueType  # 8
        ...
        NO_UNSIGNED_SUBTRACTION: MysqlConfig5_7._SQLMode.ValueType  # 9
        ...
        NO_ZERO_DATE: MysqlConfig5_7._SQLMode.ValueType  # 10
        ...
        NO_ZERO_IN_DATE: MysqlConfig5_7._SQLMode.ValueType  # 11
        ...
        NO_FIELD_OPTIONS: MysqlConfig5_7._SQLMode.ValueType  # 12
        ...
        NO_KEY_OPTIONS: MysqlConfig5_7._SQLMode.ValueType  # 13
        ...
        NO_TABLE_OPTIONS: MysqlConfig5_7._SQLMode.ValueType  # 14
        ...
        ONLY_FULL_GROUP_BY: MysqlConfig5_7._SQLMode.ValueType  # 15
        ...
        PAD_CHAR_TO_FULL_LENGTH: MysqlConfig5_7._SQLMode.ValueType  # 16
        ...
        PIPES_AS_CONCAT: MysqlConfig5_7._SQLMode.ValueType  # 17
        ...
        REAL_AS_FLOAT: MysqlConfig5_7._SQLMode.ValueType  # 18
        ...
        STRICT_ALL_TABLES: MysqlConfig5_7._SQLMode.ValueType  # 19
        ...
        STRICT_TRANS_TABLES: MysqlConfig5_7._SQLMode.ValueType  # 20
        ...
        ANSI: MysqlConfig5_7._SQLMode.ValueType  # 21
        ...
        TRADITIONAL: MysqlConfig5_7._SQLMode.ValueType  # 22
        ...
        MYSQL323: MysqlConfig5_7._SQLMode.ValueType  # 26
    ...
    """Treat `"` as an identifier quote character (like the `` ` `` quote character) rather than as a string quote character. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_ansi_quotes)."""
    ERROR_FOR_DIVISION_BY_ZERO: MysqlConfig5_7.SQLMode.ValueType  # 3
    """Produce an error for divisions by zero. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_error_for_division_by_zero)."""
    HIGH_NOT_PRECEDENCE: MysqlConfig5_7.SQLMode.ValueType  # 4
    """Give `NOT` higher precedence in negation than it has in non-high-precedence mode. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_high_not_precedence)."""
    IGNORE_SPACE: MysqlConfig5_7.SQLMode.ValueType  # 5
    """Allow spaces between a function name and the `(` character. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_ignore_space)."""
    NO_AUTO_VALUE_ON_ZERO: MysqlConfig5_7.SQLMode.ValueType  # 6
    """Do not reset the AUTO_INCREMENT column to 0 when inserting 0 into it. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_no_auto_value_on_zero)."""
    NO_BACKSLASH_ESCAPES: MysqlConfig5_7.SQLMode.ValueType  # 7
    """Disable the use of the backslash character (`\\`) as an escape character within strings. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_no_backslash_escapes)."""
    NO_ENGINE_SUBSTITUTION: MysqlConfig5_7.SQLMode.ValueType  # 8
    """Do not substitute the default storage engine when a statement specifies a storage engine that is disabled or not compiled in. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_no_engine_substitution)."""
    NO_UNSIGNED_SUBTRACTION: MysqlConfig5_7.SQLMode.ValueType  # 9
    """Disable unsigned subtraction so that subtraction results are always signed. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_no_unsigned_subtraction)."""
    NO_ZERO_DATE: MysqlConfig5_7.SQLMode.ValueType  # 10
    """Disable the MySQL-specific date `0000-00-00`. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_no_zero_date)."""
    NO_ZERO_IN_DATE: MysqlConfig5_7.SQLMode.ValueType  # 11
    """Disable month or day parts of `0` in dates. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_no_zero_in_date)."""
    NO_FIELD_OPTIONS: MysqlConfig5_7.SQLMode.ValueType  # 12
    """Ignore field options in `CREATE TABLE` statements (MySQL 5.7 compatibility). See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_no_field_options)."""
    NO_KEY_OPTIONS: MysqlConfig5_7.SQLMode.ValueType  # 13
    """Ignore key options in `CREATE TABLE` statements (MySQL 5.7 compatibility). See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_no_key_options)."""
    NO_TABLE_OPTIONS: MysqlConfig5_7.SQLMode.ValueType  # 14
    """Ignore table options in `CREATE TABLE` statements (MySQL 5.7 compatibility). See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_no_table_options)."""
    ONLY_FULL_GROUP_BY: MysqlConfig5_7.SQLMode.ValueType  # 15
    """Reject queries for which the select list, `HAVING` condition, or `ORDER BY` list refer to non-aggregated columns that are not named in the `GROUP BY` clause. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_only_full_group_by)."""
    PAD_CHAR_TO_FULL_LENGTH: MysqlConfig5_7.SQLMode.ValueType  # 16
    """Pad `CHAR` column values with spaces to the full column length when retrieving them. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_pad_char_to_full_length)."""
    PIPES_AS_CONCAT: MysqlConfig5_7.SQLMode.ValueType  # 17
    """Treat `||` as a string concatenation operator rather than as `OR`. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_pipes_as_concat)."""
    REAL_AS_FLOAT: MysqlConfig5_7.SQLMode.ValueType  # 18
    """Treat `REAL` as a synonym for `FLOAT` rather than `DOUBLE`. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_real_as_float)."""
    STRICT_ALL_TABLES: MysqlConfig5_7.SQLMode.ValueType  # 19
    """Strict mode for all storage engines. Invalid data values cause errors, not warnings. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_strict_all_tables)."""
    STRICT_TRANS_TABLES: MysqlConfig5_7.SQLMode.ValueType  # 20
    """Strict mode for transactional storage engines. Invalid data values cause errors, not warnings. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_strict_trans_tables)."""
    ANSI: MysqlConfig5_7.SQLMode.ValueType  # 21
    """Equivalent to `REAL_AS_FLOAT`, `PIPES_AS_CONCAT`, `ANSI_QUOTES`, `IGNORE_SPACE`, and `ONLY_FULL_GROUP_BY`. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_ansi)."""
    TRADITIONAL: MysqlConfig5_7.SQLMode.ValueType  # 22
    """Equivalent to `STRICT_TRANS_TABLES`, `STRICT_ALL_TABLES`, `NO_ZERO_IN_DATE`, `NO_ZERO_DATE`, `ERROR_FOR_DIVISION_BY_ZERO`, and `NO_AUTO_CREATE_USER`. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_traditional)."""
    DB2: MysqlConfig5_7.SQLMode.ValueType  # 23
    """IBM DB2 compatibility mode. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_db2)."""
    MAXDB: MysqlConfig5_7.SQLMode.ValueType  # 24
    """SAP MaxDB compatibility mode. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_maxdb)."""
    MSSQL: MysqlConfig5_7.SQLMode.ValueType  # 25
    """Microsoft SQL Server compatibility mode. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_mssql)."""
    MYSQL323: MysqlConfig5_7.SQLMode.ValueType  # 26
    """MySQL 3.23 compatibility mode. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_mysql323)."""
    MYSQL40: MysqlConfig5_7.SQLMode.ValueType  # 27
    """MySQL 4.0 compatibility mode. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_mysql40)."""
    ORACLE: MysqlConfig5_7.SQLMode.ValueType  # 28
    """Oracle compatibility mode. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_oracle)."""
    POSTGRESQL: MysqlConfig5_7.SQLMode.ValueType  # 29
    """PostgreSQL compatibility mode. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_postgresql)."""
    NO_AUTO_CREATE_USER: MysqlConfig5_7.SQLMode.ValueType  # 30
    """Prevent `GRANT` from creating new users implicitly. See [MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/sql-mode.html#sqlmode_no_auto_create_user)."""
    ...
    class _LogSlowFilterTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[MysqlConfig5_7._LogSlowFilterType.ValueType], builtins.type):
        ...
        FULL_JOIN: MysqlConfig5_7._LogSlowFilterType.ValueType  # 2
        """Queries that perform a full join (a join without indexes)."""
        TMP_TABLE: MysqlConfig5_7._LogSlowFilterType.ValueType  # 3
    ...
    """Queries that perform a full join (a join without indexes)."""
    TMP_TABLE: MysqlConfig5_7.LogSlowFilterType.ValueType  # 3
    """Queries that create an implicit internal temporary table."""
    TMP_TABLE_ON_DISK: MysqlConfig5_7.LogSlowFilterType.ValueType  # 4
    """Queries that create an implicit internal temporary table on disk."""
    FILESORT: MysqlConfig5_7.LogSlowFilterType.ValueType  # 5
    """Queries that use a filesort."""
    ...
    """Transactions are made dependent based on the write set of rows modified by the transaction."""
    WRITESET_SESSION: MysqlConfig5_7.BinlogTransactionDependencyTracking.ValueType  # 3
    """Transactions are made dependent based on the write set and the commit order within a session."""
    ...
    class _AuditLogPolicyEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[MysqlConfig5_7._AuditLogPolicy.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        AUDIT_LOG_POLICY_UNSPECIFIED: MysqlConfig5_7._AuditLogPolicy.ValueType  # 0
        """Unspecified."""
        ALL: MysqlConfig5_7._AuditLogPolicy.ValueType  # 1
        """Log all events."""
        LOGINS: MysqlConfig5_7._AuditLogPolicy.ValueType  # 2
        """Log only login events."""
        QUERIES: MysqlConfig5_7._AuditLogPolicy.ValueType  # 3
        """Log only query events."""
        NONE: MysqlConfig5_7._AuditLogPolicy.ValueType  # 4
        """Do not log events."""

    class AuditLogPolicy(_AuditLogPolicy, metaclass=_AuditLogPolicyEnumTypeWrapper): ...
    AUDIT_LOG_POLICY_UNSPECIFIED: MysqlConfig5_7.AuditLogPolicy.ValueType  # 0
    """Unspecified."""
    ALL: MysqlConfig5_7.AuditLogPolicy.ValueType  # 1
    """Log all events."""
    LOGINS: MysqlConfig5_7.AuditLogPolicy.ValueType  # 2
    """Log only login events."""
    QUERIES: MysqlConfig5_7.AuditLogPolicy.ValueType  # 3
    """Log only query events."""
    NONE: MysqlConfig5_7.AuditLogPolicy.ValueType  # 4
    """Do not log events."""
    ...
    class _InnodbChangeBufferingEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[MysqlConfig5_7._InnodbChangeBuffering.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        INNODB_CHANGE_BUFFERING_UNSPECIFIED: MysqlConfig5_7._InnodbChangeBuffering.ValueType  # 0
        """Unspecified."""
        INNODB_CHANGE_BUFFERING_NONE: MysqlConfig5_7._InnodbChangeBuffering.ValueType  # 1
        """Do not buffer any operations."""
        INNODB_CHANGE_BUFFERING_INSERTS: MysqlConfig5_7._InnodbChangeBuffering.ValueType  # 2
        """Buffer insert operations."""
        INNODB_CHANGE_BUFFERING_DELETES: MysqlConfig5_7._InnodbChangeBuffering.ValueType  # 3
        """Buffer delete-marking operations."""
        INNODB_CHANGE_BUFFERING_CHANGES: MysqlConfig5_7._InnodbChangeBuffering.ValueType  # 4
        """Buffer insert and delete-marking operations."""
        INNODB_CHANGE_BUFFERING_PURGES: MysqlConfig5_7._InnodbChangeBuffering.ValueType  # 5
        """Buffer operations where undo log records are discarded."""
        INNODB_CHANGE_BUFFERING_ALL: MysqlConfig5_7._InnodbChangeBuffering.ValueType  # 6
    ...
    INNODB_CHANGE_BUFFERING_UNSPECIFIED: MysqlConfig5_7.InnodbChangeBuffering.ValueType  # 0
    """Unspecified."""
    INNODB_CHANGE_BUFFERING_NONE: MysqlConfig5_7.InnodbChangeBuffering.ValueType  # 1
    """Do not buffer any operations."""
    INNODB_CHANGE_BUFFERING_INSERTS: MysqlConfig5_7.InnodbChangeBuffering.ValueType  # 2
    """Buffer insert operations."""
    INNODB_CHANGE_BUFFERING_DELETES: MysqlConfig5_7.InnodbChangeBuffering.ValueType  # 3
    """Buffer delete-marking operations."""
    INNODB_CHANGE_BUFFERING_CHANGES: MysqlConfig5_7.InnodbChangeBuffering.ValueType  # 4
    """Buffer insert and delete-marking operations."""
    INNODB_CHANGE_BUFFERING_PURGES: MysqlConfig5_7.InnodbChangeBuffering.ValueType  # 5
    """Buffer operations where undo log records are discarded."""
    INNODB_CHANGE_BUFFERING_ALL: MysqlConfig5_7.InnodbChangeBuffering.ValueType  # 6
    """Buffer all types of eligible operations."""
    ...
    SHOW_COMPATIBILITY_56_FIELD_NUMBER: builtins.int
    ...
    QUERY_CACHE_LIMIT_FIELD_NUMBER: builtins.int
    QUERY_CACHE_SIZE_FIELD_NUMBER: builtins.int
    QUERY_CACHE_TYPE_FIELD_NUMBER: builtins.int
    ...
    QUERY_RESPONSE_TIME_STATS_FIELD_NUMBER: builtins.int
    ...
    """
    audit_log_policy: global___MysqlConfig5_7.AuditLogPolicy.ValueType
    ...
    @property
    def query_cache_limit(self) -> google.protobuf.wrappers_pb2.Int64Value:
    ...
    @property
    def query_cache_size(self) -> google.protobuf.wrappers_pb2.Int64Value:
    ...
    @property
    def query_cache_type(self) -> google.protobuf.wrappers_pb2.Int64Value:
    ...
    @property
    def query_response_time_stats(self) -> google.protobuf.wrappers_pb2.BoolValue:
    ...
    def __init__(
        ...
        *,
        ...
        query_cache_limit: google.protobuf.wrappers_pb2.Int64Value | None = ...,
        query_cache_size: google.protobuf.wrappers_pb2.Int64Value | None = ...,
        query_cache_type: google.protobuf.wrappers_pb2.Int64Value | None = ...,
        ...
        query_response_time_stats: google.protobuf.wrappers_pb2.BoolValue | None = ...,
