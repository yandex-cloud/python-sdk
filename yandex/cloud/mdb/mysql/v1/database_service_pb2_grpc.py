...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/mdb/mysql/v1/database_service_pb2_grpc.py depends on'
...
class DatabaseServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Update = channel.unary_unary(
                ...
                request_serializer=yandex_dot_cloud_dot_mdb_dot_mysql_dot_v1_dot_database__service__pb2.UpdateDatabaseRequest.SerializeToString,
                response_deserializer=yandex_dot_cloud_dot_operation_dot_operation__pb2.Operation.FromString,
                _registered_method=True)
...
def add_DatabaseServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Update': grpc.unary_unary_rpc_method_handler(
                    servicer.Update,
                    request_deserializer=yandex_dot_cloud_dot_mdb_dot_mysql_dot_v1_dot_database__service__pb2.UpdateDatabaseRequest.FromString,
                    response_serializer=yandex_dot_cloud_dot_operation_dot_operation__pb2.Operation.SerializeToString,
            ),
    ...
    server.add_registered_method_handlers('yandex.cloud.mdb.mysql.v1.DatabaseService', rpc_method_handlers)
...
class DatabaseService(object):
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/yandex.cloud.mdb.mysql.v1.DatabaseService/Get',
            yandex_dot_cloud_dot_mdb_dot_mysql_dot_v1_dot_database__service__pb2.GetDatabaseRequest.SerializeToString,
            yandex_dot_cloud_dot_mdb_dot_mysql_dot_v1_dot_database__pb2.Database.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def List(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/yandex.cloud.mdb.mysql.v1.DatabaseService/List',
            yandex_dot_cloud_dot_mdb_dot_mysql_dot_v1_dot_database__service__pb2.ListDatabasesRequest.SerializeToString,
            yandex_dot_cloud_dot_mdb_dot_mysql_dot_v1_dot_database__service__pb2.ListDatabasesResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Create(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/yandex.cloud.mdb.mysql.v1.DatabaseService/Create',
            yandex_dot_cloud_dot_mdb_dot_mysql_dot_v1_dot_database__service__pb2.CreateDatabaseRequest.SerializeToString,
    ...
    def Update(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/yandex.cloud.mdb.mysql.v1.DatabaseService/Update',
            yandex_dot_cloud_dot_mdb_dot_mysql_dot_v1_dot_database__service__pb2.UpdateDatabaseRequest.SerializeToString,
            yandex_dot_cloud_dot_operation_dot_operation__pb2.Operation.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def Delete(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/yandex.cloud.mdb.mysql.v1.DatabaseService/Delete',
            yandex_dot_cloud_dot_mdb_dot_mysql_dot_v1_dot_database__service__pb2.DeleteDatabaseRequest.SerializeToString,
            yandex_dot_cloud_dot_operation_dot_operation__pb2.Operation.FromString,
            options,
            channel_credentials,
            insecure,
