...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/mdb/mysql/v1/cluster_service_pb2_grpc.py depends on'
...
class ClusterServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetAccessBindings = channel.unary_unary(
                '/yandex.cloud.mdb.mysql.v1.ClusterService/SetAccessBindings',
...
def add_ClusterServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.mdb.mysql.v1.ClusterService', rpc_method_handlers)
