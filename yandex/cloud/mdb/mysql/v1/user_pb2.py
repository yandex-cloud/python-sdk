...
_CONNECTIONLIMITS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='max_questions', full_name='yandex.cloud.mdb.mysql.v1.ConnectionLimits.max_questions', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='max_updates', full_name='yandex.cloud.mdb.mysql.v1.ConnectionLimits.max_updates', index=1,
      ...
      serialized_options=b'\372\3071\003>=0', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_connections', full_name='yandex.cloud.mdb.mysql.v1.ConnectionLimits.max_connections', index=2,
...
_CONNECTIONLIMITS.fields_by_name['max_questions'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
_CONNECTIONLIMITS.fields_by_name['max_updates'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
_CONNECTIONLIMITS.fields_by_name['max_connections'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
...
_CONNECTIONLIMITS.fields_by_name['max_questions']._options = None
_CONNECTIONLIMITS.fields_by_name['max_updates']._options = None
_CONNECTIONLIMITS.fields_by_name['max_connections']._options = None
