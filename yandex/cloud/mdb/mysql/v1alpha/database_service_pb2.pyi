...
class ListDatabasesResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        databases: collections.abc.Iterable[yandex.cloud.mdb.mysql.v1alpha.database_pb2.Database] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
...
class CreateDatabaseRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        cluster_id: builtins.str = ...,
        database_spec: yandex.cloud.mdb.mysql.v1alpha.database_pb2.DatabaseSpec | None = ...,
    ) -> None: ...
