...
class ListUsersResponse(google.protobuf.message.Message):
    ...
    @property
    def users(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[yandex.cloud.mdb.mysql.v1alpha.user_pb2.User]:
        """Requested list of MySQL users."""

    def __init__(
        self,
        *,
        users: collections.abc.Iterable[yandex.cloud.mdb.mysql.v1alpha.user_pb2.User] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
...
class CreateUserRequest(google.protobuf.message.Message):
    ...
    @property
    def user_spec(self) -> yandex.cloud.mdb.mysql.v1alpha.user_pb2.UserSpec:
    ...
    def __init__(
        ...
        *,
        cluster_id: builtins.str = ...,
        user_spec: yandex.cloud.mdb.mysql.v1alpha.user_pb2.UserSpec | None = ...,
    ) -> None: ...
...
class UpdateUserRequest(google.protobuf.message.Message):
    ...
    @property
    def permissions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[yandex.cloud.mdb.mysql.v1alpha.user_pb2.Permission]:
    ...
    def __init__(
        ...
        *,
        ...
        password: builtins.str = ...,
        permissions: collections.abc.Iterable[yandex.cloud.mdb.mysql.v1alpha.user_pb2.Permission] | None = ...,
    ) -> None: ...
...
class GrantUserPermissionRequest(google.protobuf.message.Message):
    ...
    @property
    def permission(self) -> yandex.cloud.mdb.mysql.v1alpha.user_pb2.Permission:
    ...
    def __init__(
        ...
        *,
        cluster_id: builtins.str = ...,
        user_name: builtins.str = ...,
        permission: yandex.cloud.mdb.mysql.v1alpha.user_pb2.Permission | None = ...,
    ) -> None: ...
