...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in yandex/cloud/mdb/mysql/v1alpha/database_service_pb2_grpc.py depends on'
...
def add_DatabaseServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.mdb.mysql.v1alpha.DatabaseService', rpc_method_handlers)
