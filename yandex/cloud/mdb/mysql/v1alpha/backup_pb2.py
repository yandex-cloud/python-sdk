...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='yandex/cloud/mdb/mysql/v1alpha/backup.proto',
...
_BACKUP = _descriptor.Descriptor(
  name='Backup',
  full_name='yandex.cloud.mdb.mysql.v1alpha.Backup',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='yandex.cloud.mdb.mysql.v1alpha.Backup.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='folder_id', full_name='yandex.cloud.mdb.mysql.v1alpha.Backup.folder_id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='created_at', full_name='yandex.cloud.mdb.mysql.v1alpha.Backup.created_at', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='source_cluster_id', full_name='yandex.cloud.mdb.mysql.v1alpha.Backup.source_cluster_id', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='started_at', full_name='yandex.cloud.mdb.mysql.v1alpha.Backup.started_at', index=4,
