...
class DatabaseServiceServicer(metaclass=abc.ABCMeta):
    ...
    ) -> typing.Union[yandex.cloud.mdb.mysql.v1alpha.database_pb2.Database, collections.abc.Awaitable[yandex.cloud.mdb.mysql.v1alpha.database_pb2.Database]]:
        """Returns the specified MySQL database.
    ...
    def List(
        ...
        context: _ServicerContext,
    ) -> typing.Union[yandex.cloud.mdb.mysql.v1alpha.database_service_pb2.ListDatabasesResponse, collections.abc.Awaitable[yandex.cloud.mdb.mysql.v1alpha.database_service_pb2.ListDatabasesResponse]]:
        """Retrieves the list of MySQL databases in the specified cluster."""
