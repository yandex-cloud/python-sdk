...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='yandex/cloud/mdb/mysql/v1alpha/resource_preset_service.proto',
...
_GETRESOURCEPRESETREQUEST = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.mdb.mysql.v1alpha.GetResourcePresetRequest',
  filename=None,
  file=DESCRIPTOR,
...
_LISTRESOURCEPRESETSREQUEST = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.mdb.mysql.v1alpha.ListResourcePresetsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_LISTRESOURCEPRESETSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.mdb.mysql.v1alpha.ListResourcePresetsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_LISTRESOURCEPRESETSRESPONSE.fields_by_name['resource_presets'].message_type = yandex_dot_cloud_dot_mdb_dot_mysql_dot_v1alpha_dot_resource__preset__pb2._RESOURCEPRESET
...
_RESOURCEPRESETSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='yandex.cloud.mdb.mysql.v1alpha.ResourcePresetService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='Get',
    full_name='yandex.cloud.mdb.mysql.v1alpha.ResourcePresetService.Get',
    index=0,
    ...
    serialized_options=_b('\202\323\344\223\002=\022;/managed-mysql/v1alpha/resourcePresets/{resource_preset_id}'),
  ),
  _descriptor.MethodDescriptor(
    name='List',
    full_name='yandex.cloud.mdb.mysql.v1alpha.ResourcePresetService.List',
    index=1,
    containing_service=None,
    input_type=_LISTRESOURCEPRESETSREQUEST,
    output_type=_LISTRESOURCEPRESETSRESPONSE,
    serialized_options=_b('\202\323\344\223\002(\022&/managed-mysql/v1alpha/resourcePresets'),
  ),
])
