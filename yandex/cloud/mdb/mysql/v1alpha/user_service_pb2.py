...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_USERSERVICE'].methods_by_name['Get']._serialized_options = b'\202\323\344\223\002<\022:/mdb/mysql/v1alpha/clusters/{cluster_id}/users/{user_name}'
  _globals['_USERSERVICE'].methods_by_name['List']._loaded_options = None
  _globals['_USERSERVICE'].methods_by_name['List']._serialized_options = b'\202\323\344\223\0020\022./mdb/mysql/v1alpha/clusters/{cluster_id}/users'
  _globals['_USERSERVICE'].methods_by_name['Create']._loaded_options = None
  _globals['_USERSERVICE'].methods_by_name['Create']._serialized_options = b'\262\322*\032\n\022CreateUserMetadata\022\004User\202\323\344\223\0023\"./mdb/mysql/v1alpha/clusters/{cluster_id}/users:\001*'
  _globals['_USERSERVICE'].methods_by_name['Update']._loaded_options = None
  _globals['_USERSERVICE'].methods_by_name['Update']._serialized_options = b'\262\322*\032\n\022UpdateUserMetadata\022\004User\202\323\344\223\002?2:/mdb/mysql/v1alpha/clusters/{cluster_id}/users/{user_name}:\001*'
  _globals['_USERSERVICE'].methods_by_name['Delete']._loaded_options = None
  _globals['_USERSERVICE'].methods_by_name['Delete']._serialized_options = b'\262\322*+\n\022DeleteUserMetadata\022\025google.protobuf.Empty\202\323\344\223\002<*:/mdb/mysql/v1alpha/clusters/{cluster_id}/users/{user_name}'
  _globals['_USERSERVICE'].methods_by_name['GrantPermission']._loaded_options = None
  _globals['_USERSERVICE'].methods_by_name['GrantPermission']._serialized_options = b'\262\322*#\n\033GrantUserPermissionMetadata\022\004User\202\323\344\223\002O\"J/mdb/mysql/v1alpha/clusters/{cluster_id}/users/{user_name}:grantPermission:\001*'
  _globals['_USERSERVICE'].methods_by_name['RevokePermission']._loaded_options = None
  _globals['_USERSERVICE'].methods_by_name['RevokePermission']._serialized_options = b'\262\322*$\n\034RevokeUserPermissionMetadata\022\004User\202\323\344\223\002P\"K/mdb/mysql/v1alpha/clusters/{cluster_id}/users/{user_name}:revokePermission:\001*'
  ...
  _globals['_USERSERVICE']._serialized_end=3194
