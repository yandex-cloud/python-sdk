...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='yandex/cloud/mdb/postgresql/v1/maintenance.proto',
...
_WEEKLYMAINTENANCEWINDOW_WEEKDAY = _descriptor.EnumDescriptor(
  name='WeekDay',
  full_name='yandex.cloud.mdb.postgresql.v1.WeeklyMaintenanceWindow.WeekDay',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_MAINTENANCEWINDOW = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.mdb.postgresql.v1.MaintenanceWindow',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anytime', full_name='yandex.cloud.mdb.postgresql.v1.MaintenanceWindow.anytime', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='weekly_maintenance_window', full_name='yandex.cloud.mdb.postgresql.v1.MaintenanceWindow.weekly_maintenance_window', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='policy', full_name='yandex.cloud.mdb.postgresql.v1.MaintenanceWindow.policy',
...
_ANYTIMEMAINTENANCEWINDOW = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.mdb.postgresql.v1.AnytimeMaintenanceWindow',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_WEEKLYMAINTENANCEWINDOW = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.mdb.postgresql.v1.WeeklyMaintenanceWindow',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='day', full_name='yandex.cloud.mdb.postgresql.v1.WeeklyMaintenanceWindow.day', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hour', full_name='yandex.cloud.mdb.postgresql.v1.WeeklyMaintenanceWindow.hour', index=1,
...
_MAINTENANCEOPERATION = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.mdb.postgresql.v1.MaintenanceOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='info', full_name='yandex.cloud.mdb.postgresql.v1.MaintenanceOperation.info', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='delayed_until', full_name='yandex.cloud.mdb.postgresql.v1.MaintenanceOperation.delayed_until', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
