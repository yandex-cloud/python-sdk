...
class BackupServiceServicer(metaclass=abc.ABCMeta):
    ...
    ) -> typing.Union[yandex.cloud.mdb.postgresql.v1.backup_pb2.Backup, collections.abc.Awaitable[yandex.cloud.mdb.postgresql.v1.backup_pb2.Backup]]:
        """Returns the specified PostgreSQL Backup resource.
    ...
    def List(
        ...
        context: _ServicerContext,
    ) -> typing.Union[yandex.cloud.mdb.postgresql.v1.backup_service_pb2.ListBackupsResponse, collections.abc.Awaitable[yandex.cloud.mdb.postgresql.v1.backup_service_pb2.ListBackupsResponse]]:
        """Retrieves the list of Backup resources available for the specified folder."""
