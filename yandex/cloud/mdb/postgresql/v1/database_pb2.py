...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n-yandex/cloud/mdb/postgresql/v1/database.proto\x12\x1eyandex.cloud.mdb.postgresql.v1\x1a\x1dyandex/cloud/validation.proto\"\xa0\x01\n\x08\x44\x61tabase\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x12\n\ncluster_id\x18\x02 \x01(\t\x12\r\n\x05owner\x18\x03 \x01(\t\x12\x12\n\nlc_collate\x18\x04 \x01(\t\x12\x10\n\x08lc_ctype\x18\x05 \x01(\t\x12=\n\nextensions\x18\x06 \x03(\x0b\x32).yandex.cloud.mdb.postgresql.v1.Extension\"*\n\tExtension\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x0f\n\x07version\x18\x02 \x01(\t\"\xfe\x01\n\x0c\x44\x61tabaseSpec\x12+\n\x04name\x18\x01 \x01(\tB\x1d\xe8\xc7\x31\x01\x8a\xc8\x31\x04\x31-63\xf2\xc7\x31\r[a-zA-Z0-9_]+\x12,\n\x05owner\x18\x02 \x01(\tB\x1d\xe8\xc7\x31\x01\x8a\xc8\x31\x04\x31-63\xf2\xc7\x31\r[a-zA-Z0-9_]+\x12*\n\nlc_collate\x18\x03 \x01(\tB\x16\xf2\xc7\x31\x12[a-zA-Z_]+.UTF-8|C\x12(\n\x08lc_ctype\x18\x04 \x01(\tB\x16\xf2\xc7\x31\x12[a-zA-Z_]+.UTF-8|C\x12=\n\nextensions\x18\x05 \x03(\x0b\x32).yandex.cloud.mdb.postgresql.v1.ExtensionBOZMgithub.com/yandex-cloud/go-genproto/yandex/cloud/mdb/postgresql/v1;postgresqlb\x06proto3')
  ,
...
_DATABASESPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\3071\022[a-zA-Z_]+.UTF-8|C')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_DATABASESPEC.fields_by_name['owner'].has_options = True
_DATABASESPEC.fields_by_name['owner']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\350\3071\001\212\3101\0041-63\362\3071\r[a-zA-Z0-9_]+'))
_DATABASESPEC.fields_by_name['lc_collate'].has_options = True
_DATABASESPEC.fields_by_name['lc_collate']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\3071\022[a-zA-Z_]+.UTF-8|C'))
_DATABASESPEC.fields_by_name['lc_ctype'].has_options = True
_DATABASESPEC.fields_by_name['lc_ctype']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\3071\022[a-zA-Z_]+.UTF-8|C'))
