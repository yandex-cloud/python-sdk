...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'yandex/cloud/mdb/postgresql/v1/config/host17_1c.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_POSTGRESQLHOSTCONFIG17_1C_BACKSLASHQUOTE'].values_by_name["BACKSLASH_QUOTE"]._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG17_1C_BACKSLASHQUOTE'].values_by_name["BACKSLASH_QUOTE"]._serialized_options = b'\010\001'
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['backend_flush_after']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['backend_flush_after']._serialized_options = b'\372\3071\t0-2097152'
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['from_collapse_limit']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['from_collapse_limit']._serialized_options = b'\372\3071\0141-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['join_collapse_limit']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['join_collapse_limit']._serialized_options = b'\372\3071\0141-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['lock_timeout']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['lock_timeout']._serialized_options = b'\372\3071\0140-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['idle_in_transaction_session_timeout']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['idle_in_transaction_session_timeout']._serialized_options = b'\372\3071\0140-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['deadlock_timeout']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['deadlock_timeout']._serialized_options = b'\372\3071\0141-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['seq_page_cost']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['seq_page_cost']._serialized_options = b'\372\3071\003>=0'
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['random_page_cost']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['random_page_cost']._serialized_options = b'\372\3071\003>=0'
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['max_parallel_workers']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['max_parallel_workers']._serialized_options = b'\372\3071\0060-1024'
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['max_parallel_workers_per_gather']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['max_parallel_workers_per_gather']._serialized_options = b'\372\3071\0060-1024'
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['effective_io_concurrency']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['effective_io_concurrency']._serialized_options = b'\372\3071\0060-1000'
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['effective_cache_size']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['effective_cache_size']._serialized_options = b'\372\3071\0241048576-549755813888'
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['idle_session_timeout']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG17_1C'].fields_by_name['idle_session_timeout']._serialized_options = b'\372\3071\0140-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG17_1C']._serialized_start=160
  _globals['_POSTGRESQLHOSTCONFIG17_1C']._serialized_end=6397
  _globals['_POSTGRESQLHOSTCONFIG17_1C_BACKSLASHQUOTE']._serialized_start=4661
  _globals['_POSTGRESQLHOSTCONFIG17_1C_BACKSLASHQUOTE']._serialized_end=4819
  _globals['_POSTGRESQLHOSTCONFIG17_1C_BYTEAOUTPUT']._serialized_start=4821
  _globals['_POSTGRESQLHOSTCONFIG17_1C_BYTEAOUTPUT']._serialized_end=4912
  _globals['_POSTGRESQLHOSTCONFIG17_1C_CONSTRAINTEXCLUSION']._serialized_start=4915
  _globals['_POSTGRESQLHOSTCONFIG17_1C_CONSTRAINTEXCLUSION']._serialized_end=5069
  _globals['_POSTGRESQLHOSTCONFIG17_1C_DEBUGPARALLELQUERY']._serialized_start=5072
  _globals['_POSTGRESQLHOSTCONFIG17_1C_DEBUGPARALLELQUERY']._serialized_end=5223
  _globals['_POSTGRESQLHOSTCONFIG17_1C_FORCEPARALLELMODE']._serialized_start=5226
  _globals['_POSTGRESQLHOSTCONFIG17_1C_FORCEPARALLELMODE']._serialized_end=5372
  _globals['_POSTGRESQLHOSTCONFIG17_1C_LOGERRORVERBOSITY']._serialized_start=5375
  _globals['_POSTGRESQLHOSTCONFIG17_1C_LOGERRORVERBOSITY']._serialized_end=5528
  _globals['_POSTGRESQLHOSTCONFIG17_1C_LOGLEVEL']._serialized_start=5531
  _globals['_POSTGRESQLHOSTCONFIG17_1C_LOGLEVEL']._serialized_end=5825
  _globals['_POSTGRESQLHOSTCONFIG17_1C_LOGSTATEMENT']._serialized_start=5828
  _globals['_POSTGRESQLHOSTCONFIG17_1C_LOGSTATEMENT']._serialized_end=5966
  _globals['_POSTGRESQLHOSTCONFIG17_1C_TRANSACTIONISOLATION']._serialized_start=5969
  _globals['_POSTGRESQLHOSTCONFIG17_1C_TRANSACTIONISOLATION']._serialized_end=6199
  _globals['_POSTGRESQLHOSTCONFIG17_1C_XMLBINARY']._serialized_start=6201
  _globals['_POSTGRESQLHOSTCONFIG17_1C_XMLBINARY']._serialized_end=6283
  _globals['_POSTGRESQLHOSTCONFIG17_1C_XMLOPTION']._serialized_start=6285
  _globals['_POSTGRESQLHOSTCONFIG17_1C_XMLOPTION']._serialized_end=6373
