...
@typing.final
class PostgresqlHostConfig19(google.protobuf.message.Message):
    ...
    class _BackslashQuoteEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig19._BackslashQuote.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        BACKSLASH_QUOTE_UNSPECIFIED: PostgresqlHostConfig19._BackslashQuote.ValueType  # 0
        """Not specified."""
        BACKSLASH_QUOTE: PostgresqlHostConfig19._BackslashQuote.ValueType  # 1
        """Legacy invalid value. Do not use."""
        BACKSLASH_QUOTE_ON: PostgresqlHostConfig19._BackslashQuote.ValueType  # 2
        """Quotation mark can be represented as \\'."""
        BACKSLASH_QUOTE_OFF: PostgresqlHostConfig19._BackslashQuote.ValueType  # 3
        """Quotation mark can only be represented using the standard SQL syntax ''."""
        BACKSLASH_QUOTE_SAFE_ENCODING: PostgresqlHostConfig19._BackslashQuote.ValueType  # 4
    ...
    BACKSLASH_QUOTE_UNSPECIFIED: PostgresqlHostConfig19.BackslashQuote.ValueType  # 0
    """Not specified."""
    BACKSLASH_QUOTE: PostgresqlHostConfig19.BackslashQuote.ValueType  # 1
    """Legacy invalid value. Do not use."""
    BACKSLASH_QUOTE_ON: PostgresqlHostConfig19.BackslashQuote.ValueType  # 2
    """Quotation mark can be represented as \\'."""
    BACKSLASH_QUOTE_OFF: PostgresqlHostConfig19.BackslashQuote.ValueType  # 3
    """Quotation mark can only be represented using the standard SQL syntax ''."""
    BACKSLASH_QUOTE_SAFE_ENCODING: PostgresqlHostConfig19.BackslashQuote.ValueType  # 4
    """Representing a quotation mark as \\' is only permitted for client encodings where \\ is not used for multibyte characters."""
    ...
    class _ByteaOutputEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig19._ByteaOutput.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        BYTEA_OUTPUT_UNSPECIFIED: PostgresqlHostConfig19._ByteaOutput.ValueType  # 0
        """Not specified."""
        BYTEA_OUTPUT_HEX: PostgresqlHostConfig19._ByteaOutput.ValueType  # 1
        """Each byte is represented by two hexadecimal characters, e.g., 'SELECT '\\xDEADBEEF';'."""
        BYTEA_OUTPUT_ESCAPED: PostgresqlHostConfig19._ByteaOutput.ValueType  # 2
    ...
    BYTEA_OUTPUT_UNSPECIFIED: PostgresqlHostConfig19.ByteaOutput.ValueType  # 0
    """Not specified."""
    BYTEA_OUTPUT_HEX: PostgresqlHostConfig19.ByteaOutput.ValueType  # 1
    """Each byte is represented by two hexadecimal characters, e.g., 'SELECT '\\xDEADBEEF';'."""
    BYTEA_OUTPUT_ESCAPED: PostgresqlHostConfig19.ByteaOutput.ValueType  # 2
    """Standard PostgreSQL format with ASCII characters only."""
    ...
    class _ConstraintExclusionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig19._ConstraintExclusion.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        CONSTRAINT_EXCLUSION_UNSPECIFIED: PostgresqlHostConfig19._ConstraintExclusion.ValueType  # 0
        """Not specified."""
        CONSTRAINT_EXCLUSION_ON: PostgresqlHostConfig19._ConstraintExclusion.ValueType  # 1
        """Enable planner's use of constraints for all tables."""
        CONSTRAINT_EXCLUSION_OFF: PostgresqlHostConfig19._ConstraintExclusion.ValueType  # 2
        """Disable planner's use of constraints for all tables"""
        CONSTRAINT_EXCLUSION_PARTITION: PostgresqlHostConfig19._ConstraintExclusion.ValueType  # 3
    ...
    CONSTRAINT_EXCLUSION_UNSPECIFIED: PostgresqlHostConfig19.ConstraintExclusion.ValueType  # 0
    """Not specified."""
    CONSTRAINT_EXCLUSION_ON: PostgresqlHostConfig19.ConstraintExclusion.ValueType  # 1
    """Enable planner's use of constraints for all tables."""
    CONSTRAINT_EXCLUSION_OFF: PostgresqlHostConfig19.ConstraintExclusion.ValueType  # 2
    """Disable planner's use of constraints for all tables"""
    CONSTRAINT_EXCLUSION_PARTITION: PostgresqlHostConfig19.ConstraintExclusion.ValueType  # 3
    """Only use constraints for child tables and UNION ALL clauses."""
    ...
    class _DebugParallelQueryEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig19._DebugParallelQuery.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        DEBUG_PARALLEL_QUERY_UNSPECIFIED: PostgresqlHostConfig19._DebugParallelQuery.ValueType  # 0
        """Not specified."""
        DEBUG_PARALLEL_QUERY_ON: PostgresqlHostConfig19._DebugParallelQuery.ValueType  # 1
        """Forces parallel mode for queries considered safe, even when no performance benefit is expected."""
        DEBUG_PARALLEL_QUERY_OFF: PostgresqlHostConfig19._DebugParallelQuery.ValueType  # 2
        """Uses parallel mode only when the planner expects it to improve performance."""
        DEBUG_PARALLEL_QUERY_REGRESS: PostgresqlHostConfig19._DebugParallelQuery.ValueType  # 3
    ...
    DEBUG_PARALLEL_QUERY_UNSPECIFIED: PostgresqlHostConfig19.DebugParallelQuery.ValueType  # 0
    """Not specified."""
    DEBUG_PARALLEL_QUERY_ON: PostgresqlHostConfig19.DebugParallelQuery.ValueType  # 1
    """Forces parallel mode for queries considered safe, even when no performance benefit is expected."""
    DEBUG_PARALLEL_QUERY_OFF: PostgresqlHostConfig19.DebugParallelQuery.ValueType  # 2
    """Uses parallel mode only when the planner expects it to improve performance."""
    DEBUG_PARALLEL_QUERY_REGRESS: PostgresqlHostConfig19.DebugParallelQuery.ValueType  # 3
    """Behaves like ON, but hides added Gather nodes in EXPLAIN output and
    suppresses parallel-worker context lines to stabilize regression-test output.
    """
    ...
    class _ForceParallelModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig19._ForceParallelMode.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        FORCE_PARALLEL_MODE_UNSPECIFIED: PostgresqlHostConfig19._ForceParallelMode.ValueType  # 0
        """Not specified."""
        FORCE_PARALLEL_MODE_ON: PostgresqlHostConfig19._ForceParallelMode.ValueType  # 1
        """Forces parallel mode for queries considered safe, even when no performance benefit is expected."""
        FORCE_PARALLEL_MODE_OFF: PostgresqlHostConfig19._ForceParallelMode.ValueType  # 2
        """Uses parallel mode only when the planner expects it to improve performance."""
        FORCE_PARALLEL_MODE_REGRESS: PostgresqlHostConfig19._ForceParallelMode.ValueType  # 3
        """Behaves like ON, but hides added Gather nodes in EXPLAIN output and
        suppresses parallel-worker context lines to stabilize regression-test output.
        """

    class ForceParallelMode(_ForceParallelMode, metaclass=_ForceParallelModeEnumTypeWrapper): ...
    FORCE_PARALLEL_MODE_UNSPECIFIED: PostgresqlHostConfig19.ForceParallelMode.ValueType  # 0
    """Not specified."""
    FORCE_PARALLEL_MODE_ON: PostgresqlHostConfig19.ForceParallelMode.ValueType  # 1
    """Forces parallel mode for queries considered safe, even when no performance benefit is expected."""
    FORCE_PARALLEL_MODE_OFF: PostgresqlHostConfig19.ForceParallelMode.ValueType  # 2
    """Uses parallel mode only when the planner expects it to improve performance."""
    FORCE_PARALLEL_MODE_REGRESS: PostgresqlHostConfig19.ForceParallelMode.ValueType  # 3
    """Behaves like ON, but hides added Gather nodes in EXPLAIN output and
    suppresses parallel-worker context lines to stabilize regression-test output.
    """
    ...
    class _LogErrorVerbosityEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig19._LogErrorVerbosity.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        LOG_ERROR_VERBOSITY_UNSPECIFIED: PostgresqlHostConfig19._LogErrorVerbosity.ValueType  # 0
        """Not specified."""
        LOG_ERROR_VERBOSITY_TERSE: PostgresqlHostConfig19._LogErrorVerbosity.ValueType  # 1
        """DETAIL, HINT, QUERY, and CONTEXT fields are excluded from the error message."""
        LOG_ERROR_VERBOSITY_DEFAULT: PostgresqlHostConfig19._LogErrorVerbosity.ValueType  # 2
        """Default."""
        LOG_ERROR_VERBOSITY_VERBOSE: PostgresqlHostConfig19._LogErrorVerbosity.ValueType  # 3
    ...
    LOG_ERROR_VERBOSITY_UNSPECIFIED: PostgresqlHostConfig19.LogErrorVerbosity.ValueType  # 0
    """Not specified."""
    LOG_ERROR_VERBOSITY_TERSE: PostgresqlHostConfig19.LogErrorVerbosity.ValueType  # 1
    """DETAIL, HINT, QUERY, and CONTEXT fields are excluded from the error message."""
    LOG_ERROR_VERBOSITY_DEFAULT: PostgresqlHostConfig19.LogErrorVerbosity.ValueType  # 2
    """Default."""
    LOG_ERROR_VERBOSITY_VERBOSE: PostgresqlHostConfig19.LogErrorVerbosity.ValueType  # 3
    """Error message includes the SQLSTATE error code, source filename, function name, and the line number where the error occurred."""
    ...
    class _LogLevelEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig19._LogLevel.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        LOG_LEVEL_UNSPECIFIED: PostgresqlHostConfig19._LogLevel.ValueType  # 0
        """Not specified."""
        LOG_LEVEL_DEBUG5: PostgresqlHostConfig19._LogLevel.ValueType  # 1
        """Provides the most detailed diagnostic information for developers."""
        LOG_LEVEL_DEBUG4: PostgresqlHostConfig19._LogLevel.ValueType  # 2
        """Provides more detailed diagnostic information than DEBUG3."""
        LOG_LEVEL_DEBUG3: PostgresqlHostConfig19._LogLevel.ValueType  # 3
        """Provides more detailed diagnostic information than DEBUG2."""
        LOG_LEVEL_DEBUG2: PostgresqlHostConfig19._LogLevel.ValueType  # 4
        """Provides more detailed diagnostic information than DEBUG1."""
        LOG_LEVEL_DEBUG1: PostgresqlHostConfig19._LogLevel.ValueType  # 5
        """Provides diagnostic information for developers."""
        LOG_LEVEL_INFO: PostgresqlHostConfig19._LogLevel.ValueType  # 12
        """Reports information implicitly requested by the user."""
        LOG_LEVEL_LOG: PostgresqlHostConfig19._LogLevel.ValueType  # 6
        """Reports information of interest to database administrators."""
        LOG_LEVEL_NOTICE: PostgresqlHostConfig19._LogLevel.ValueType  # 7
        """Reports information that may be helpful to users."""
        LOG_LEVEL_WARNING: PostgresqlHostConfig19._LogLevel.ValueType  # 8
        """Reports a warning about a likely problem."""
        LOG_LEVEL_ERROR: PostgresqlHostConfig19._LogLevel.ValueType  # 9
        """Reports an error that aborts the current command."""
        LOG_LEVEL_FATAL: PostgresqlHostConfig19._LogLevel.ValueType  # 10
        """Reports an error that aborts the current session."""
        LOG_LEVEL_PANIC: PostgresqlHostConfig19._LogLevel.ValueType  # 11
        """Reports an error that aborts all database sessions."""

    class LogLevel(_LogLevel, metaclass=_LogLevelEnumTypeWrapper): ...
    LOG_LEVEL_UNSPECIFIED: PostgresqlHostConfig19.LogLevel.ValueType  # 0
    """Not specified."""
    LOG_LEVEL_DEBUG5: PostgresqlHostConfig19.LogLevel.ValueType  # 1
    """Provides the most detailed diagnostic information for developers."""
    LOG_LEVEL_DEBUG4: PostgresqlHostConfig19.LogLevel.ValueType  # 2
    """Provides more detailed diagnostic information than DEBUG3."""
    LOG_LEVEL_DEBUG3: PostgresqlHostConfig19.LogLevel.ValueType  # 3
    """Provides more detailed diagnostic information than DEBUG2."""
    LOG_LEVEL_DEBUG2: PostgresqlHostConfig19.LogLevel.ValueType  # 4
    """Provides more detailed diagnostic information than DEBUG1."""
    LOG_LEVEL_DEBUG1: PostgresqlHostConfig19.LogLevel.ValueType  # 5
    """Provides diagnostic information for developers."""
    LOG_LEVEL_INFO: PostgresqlHostConfig19.LogLevel.ValueType  # 12
    """Reports information implicitly requested by the user."""
    LOG_LEVEL_LOG: PostgresqlHostConfig19.LogLevel.ValueType  # 6
    """Reports information of interest to database administrators."""
    LOG_LEVEL_NOTICE: PostgresqlHostConfig19.LogLevel.ValueType  # 7
    """Reports information that may be helpful to users."""
    LOG_LEVEL_WARNING: PostgresqlHostConfig19.LogLevel.ValueType  # 8
    """Reports a warning about a likely problem."""
    LOG_LEVEL_ERROR: PostgresqlHostConfig19.LogLevel.ValueType  # 9
    """Reports an error that aborts the current command."""
    LOG_LEVEL_FATAL: PostgresqlHostConfig19.LogLevel.ValueType  # 10
    """Reports an error that aborts the current session."""
    LOG_LEVEL_PANIC: PostgresqlHostConfig19.LogLevel.ValueType  # 11
    """Reports an error that aborts all database sessions."""
    ...
    class _LogStatementEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig19._LogStatement.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        LOG_STATEMENT_UNSPECIFIED: PostgresqlHostConfig19._LogStatement.ValueType  # 0
        """Not specified."""
        LOG_STATEMENT_NONE: PostgresqlHostConfig19._LogStatement.ValueType  # 1
        """The filter is disabled, no SQL statements are logged."""
        LOG_STATEMENT_DDL: PostgresqlHostConfig19._LogStatement.ValueType  # 2
        """System logs DDL statements, e.g., CREATE, ALTER, DROP etc."""
        LOG_STATEMENT_MOD: PostgresqlHostConfig19._LogStatement.ValueType  # 3
        """System logs ddl-statements along with data modification commands, e.g., INSERT, UPDATE, etc."""
        LOG_STATEMENT_ALL: PostgresqlHostConfig19._LogStatement.ValueType  # 4
        """System logs all SQL statements."""

    class LogStatement(_LogStatement, metaclass=_LogStatementEnumTypeWrapper): ...
    LOG_STATEMENT_UNSPECIFIED: PostgresqlHostConfig19.LogStatement.ValueType  # 0
    """Not specified."""
    LOG_STATEMENT_NONE: PostgresqlHostConfig19.LogStatement.ValueType  # 1
    """The filter is disabled, no SQL statements are logged."""
    LOG_STATEMENT_DDL: PostgresqlHostConfig19.LogStatement.ValueType  # 2
    """System logs DDL statements, e.g., CREATE, ALTER, DROP etc."""
    LOG_STATEMENT_MOD: PostgresqlHostConfig19.LogStatement.ValueType  # 3
    """System logs ddl-statements along with data modification commands, e.g., INSERT, UPDATE, etc."""
    LOG_STATEMENT_ALL: PostgresqlHostConfig19.LogStatement.ValueType  # 4
    """System logs all SQL statements."""
    ...
    class _TransactionIsolationEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig19._TransactionIsolation.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        TRANSACTION_ISOLATION_UNSPECIFIED: PostgresqlHostConfig19._TransactionIsolation.ValueType  # 0
        """Not specified."""
        TRANSACTION_ISOLATION_READ_UNCOMMITTED: PostgresqlHostConfig19._TransactionIsolation.ValueType  # 1
        """This level behaves like `TRANSACTION_ISOLATION_READ_COMMITTED` in PostgreSQL."""
        TRANSACTION_ISOLATION_READ_COMMITTED: PostgresqlHostConfig19._TransactionIsolation.ValueType  # 2
        """On this level query sees only data committed before the query began."""
        TRANSACTION_ISOLATION_REPEATABLE_READ: PostgresqlHostConfig19._TransactionIsolation.ValueType  # 3
        ...
        TRANSACTION_ISOLATION_SERIALIZABLE: PostgresqlHostConfig19._TransactionIsolation.ValueType  # 4
    ...
    TRANSACTION_ISOLATION_UNSPECIFIED: PostgresqlHostConfig19.TransactionIsolation.ValueType  # 0
    """Not specified."""
    TRANSACTION_ISOLATION_READ_UNCOMMITTED: PostgresqlHostConfig19.TransactionIsolation.ValueType  # 1
    """This level behaves like `TRANSACTION_ISOLATION_READ_COMMITTED` in PostgreSQL."""
    TRANSACTION_ISOLATION_READ_COMMITTED: PostgresqlHostConfig19.TransactionIsolation.ValueType  # 2
    """On this level query sees only data committed before the query began."""
    TRANSACTION_ISOLATION_REPEATABLE_READ: PostgresqlHostConfig19.TransactionIsolation.ValueType  # 3
    """On this level all subsequent queries in a transaction will see the same rows, that were read by the first `SELECT` or `INSERT` query in this transaction, unchanged (these rows are locked during the first query)."""
    TRANSACTION_ISOLATION_SERIALIZABLE: PostgresqlHostConfig19.TransactionIsolation.ValueType  # 4
    """This level provides the strictest transaction isolation.
    All queries in the current transaction see only the rows that were fixed prior to execution of the first `SELECT` or `INSERT` query in this transaction.
    If read and write operations in a concurrent set of serializable transactions overlap and this may cause an inconsistency that is not possible during the serial transaction execution, then one of the transaction will be rolled back, triggering a serialization failure.
    """
    ...
    class _XmlBinaryEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig19._XmlBinary.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        XML_BINARY_UNSPECIFIED: PostgresqlHostConfig19._XmlBinary.ValueType  # 0
        """Not specified."""
        XML_BINARY_BASE64: PostgresqlHostConfig19._XmlBinary.ValueType  # 1
        """Encodes binary values using Base64."""
        XML_BINARY_HEX: PostgresqlHostConfig19._XmlBinary.ValueType  # 2
        """Encodes binary values using hexadecimal notation."""

    class XmlBinary(_XmlBinary, metaclass=_XmlBinaryEnumTypeWrapper): ...
    XML_BINARY_UNSPECIFIED: PostgresqlHostConfig19.XmlBinary.ValueType  # 0
    """Not specified."""
    XML_BINARY_BASE64: PostgresqlHostConfig19.XmlBinary.ValueType  # 1
    """Encodes binary values using Base64."""
    XML_BINARY_HEX: PostgresqlHostConfig19.XmlBinary.ValueType  # 2
    """Encodes binary values using hexadecimal notation."""
    ...
    class _XmlOptionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig19._XmlOption.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        XML_OPTION_UNSPECIFIED: PostgresqlHostConfig19._XmlOption.ValueType  # 0
        """Not specified."""
        XML_OPTION_DOCUMENT: PostgresqlHostConfig19._XmlOption.ValueType  # 1
        """Treats an XML value as a complete, well-formed document."""
        XML_OPTION_CONTENT: PostgresqlHostConfig19._XmlOption.ValueType  # 2
    ...
    XML_OPTION_UNSPECIFIED: PostgresqlHostConfig19.XmlOption.ValueType  # 0
    """Not specified."""
    XML_OPTION_DOCUMENT: PostgresqlHostConfig19.XmlOption.ValueType  # 1
    """Treats an XML value as a complete, well-formed document."""
    XML_OPTION_CONTENT: PostgresqlHostConfig19.XmlOption.ValueType  # 2
    """Treats an XML value as a content fragment, which may contain multiple top-level elements or character nodes."""
    ...
    constraint_exclusion: global___PostgresqlHostConfig19.ConstraintExclusion.ValueType
    """Enables the planner to use constraints to optimize queries."""
    debug_parallel_query: global___PostgresqlHostConfig19.DebugParallelQuery.ValueType
    """Forces the planner's use parallel query nodes."""
    client_min_messages: global___PostgresqlHostConfig19.LogLevel.ValueType
    """Sets the message levels that are sent to the client."""
    log_min_messages: global___PostgresqlHostConfig19.LogLevel.ValueType
    """Sets the message levels that are logged."""
    log_min_error_statement: global___PostgresqlHostConfig19.LogLevel.ValueType
    """Causes all statements generating error at or above this level to be logged."""
    log_error_verbosity: global___PostgresqlHostConfig19.LogErrorVerbosity.ValueType
    """Sets the verbosity of logged messages."""
    log_statement: global___PostgresqlHostConfig19.LogStatement.ValueType
    """Sets the type of statements logged."""
    search_path: builtins.str
    """Sets the schema search order for names that are not schema-qualified."""
    default_transaction_isolation: global___PostgresqlHostConfig19.TransactionIsolation.ValueType
    """Sets the transaction isolation level of each new transaction."""
    bytea_output: global___PostgresqlHostConfig19.ByteaOutput.ValueType
    """Sets the output format for bytea."""
    xmlbinary: global___PostgresqlHostConfig19.XmlBinary.ValueType
    """Sets how binary values are to be encoded in XML."""
    xmloption: global___PostgresqlHostConfig19.XmlOption.ValueType
    ...
    backslash_quote: global___PostgresqlHostConfig19.BackslashQuote.ValueType
...
global___PostgresqlHostConfig19 = PostgresqlHostConfig19
