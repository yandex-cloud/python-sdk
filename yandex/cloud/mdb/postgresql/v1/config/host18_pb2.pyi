...
@typing.final
class PostgresqlHostConfig18(google.protobuf.message.Message):
    ...
    class _BackslashQuoteEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig18._BackslashQuote.ValueType], builtins.type):
        ...
        BACKSLASH_QUOTE_SAFE_ENCODING: PostgresqlHostConfig18._BackslashQuote.ValueType  # 4
    ...
    BACKSLASH_QUOTE_SAFE_ENCODING: PostgresqlHostConfig18.BackslashQuote.ValueType  # 4
    ...
    class _ConstraintExclusionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig18._ConstraintExclusion.ValueType], builtins.type):
        ...
        CONSTRAINT_EXCLUSION_PARTITION: PostgresqlHostConfig18._ConstraintExclusion.ValueType  # 3
    ...
    CONSTRAINT_EXCLUSION_PARTITION: PostgresqlHostConfig18.ConstraintExclusion.ValueType  # 3
    ...
    class _LogErrorVerbosityEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig18._LogErrorVerbosity.ValueType], builtins.type):
        ...
        LOG_ERROR_VERBOSITY_VERBOSE: PostgresqlHostConfig18._LogErrorVerbosity.ValueType  # 3
    ...
    LOG_ERROR_VERBOSITY_VERBOSE: PostgresqlHostConfig18.LogErrorVerbosity.ValueType  # 3

    class _LogLevel:
        ValueType = typing.NewType("ValueType", builtins.int)
        V: typing_extensions.TypeAlias = ValueType

    class _LogLevelEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig18._LogLevel.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        LOG_LEVEL_UNSPECIFIED: PostgresqlHostConfig18._LogLevel.ValueType  # 0
        LOG_LEVEL_DEBUG5: PostgresqlHostConfig18._LogLevel.ValueType  # 1
        LOG_LEVEL_DEBUG4: PostgresqlHostConfig18._LogLevel.ValueType  # 2
        LOG_LEVEL_DEBUG3: PostgresqlHostConfig18._LogLevel.ValueType  # 3
        LOG_LEVEL_DEBUG2: PostgresqlHostConfig18._LogLevel.ValueType  # 4
        LOG_LEVEL_DEBUG1: PostgresqlHostConfig18._LogLevel.ValueType  # 5
        LOG_LEVEL_INFO: PostgresqlHostConfig18._LogLevel.ValueType  # 12
        LOG_LEVEL_LOG: PostgresqlHostConfig18._LogLevel.ValueType  # 6
        LOG_LEVEL_NOTICE: PostgresqlHostConfig18._LogLevel.ValueType  # 7
        LOG_LEVEL_WARNING: PostgresqlHostConfig18._LogLevel.ValueType  # 8
        LOG_LEVEL_ERROR: PostgresqlHostConfig18._LogLevel.ValueType  # 9
        LOG_LEVEL_FATAL: PostgresqlHostConfig18._LogLevel.ValueType  # 10
        LOG_LEVEL_PANIC: PostgresqlHostConfig18._LogLevel.ValueType  # 11

    class LogLevel(_LogLevel, metaclass=_LogLevelEnumTypeWrapper): ...
    LOG_LEVEL_UNSPECIFIED: PostgresqlHostConfig18.LogLevel.ValueType  # 0
    LOG_LEVEL_DEBUG5: PostgresqlHostConfig18.LogLevel.ValueType  # 1
    LOG_LEVEL_DEBUG4: PostgresqlHostConfig18.LogLevel.ValueType  # 2
    LOG_LEVEL_DEBUG3: PostgresqlHostConfig18.LogLevel.ValueType  # 3
    LOG_LEVEL_DEBUG2: PostgresqlHostConfig18.LogLevel.ValueType  # 4
    LOG_LEVEL_DEBUG1: PostgresqlHostConfig18.LogLevel.ValueType  # 5
    LOG_LEVEL_INFO: PostgresqlHostConfig18.LogLevel.ValueType  # 12
    LOG_LEVEL_LOG: PostgresqlHostConfig18.LogLevel.ValueType  # 6
    LOG_LEVEL_NOTICE: PostgresqlHostConfig18.LogLevel.ValueType  # 7
    LOG_LEVEL_WARNING: PostgresqlHostConfig18.LogLevel.ValueType  # 8
    LOG_LEVEL_ERROR: PostgresqlHostConfig18.LogLevel.ValueType  # 9
    LOG_LEVEL_FATAL: PostgresqlHostConfig18.LogLevel.ValueType  # 10
    LOG_LEVEL_PANIC: PostgresqlHostConfig18.LogLevel.ValueType  # 11
    ...
    class _LogStatementEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig18._LogStatement.ValueType], builtins.type):
        ...
        LOG_STATEMENT_MOD: PostgresqlHostConfig18._LogStatement.ValueType  # 3
        LOG_STATEMENT_ALL: PostgresqlHostConfig18._LogStatement.ValueType  # 4
    ...
    LOG_STATEMENT_MOD: PostgresqlHostConfig18.LogStatement.ValueType  # 3
    LOG_STATEMENT_ALL: PostgresqlHostConfig18.LogStatement.ValueType  # 4
    ...
    class _TransactionIsolationEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlHostConfig18._TransactionIsolation.ValueType], builtins.type):
        ...
        TRANSACTION_ISOLATION_REPEATABLE_READ: PostgresqlHostConfig18._TransactionIsolation.ValueType  # 3
        TRANSACTION_ISOLATION_SERIALIZABLE: PostgresqlHostConfig18._TransactionIsolation.ValueType  # 4
    ...
    TRANSACTION_ISOLATION_REPEATABLE_READ: PostgresqlHostConfig18.TransactionIsolation.ValueType  # 3
    TRANSACTION_ISOLATION_SERIALIZABLE: PostgresqlHostConfig18.TransactionIsolation.ValueType  # 4
    ...
    constraint_exclusion: global___PostgresqlHostConfig18.ConstraintExclusion.ValueType
    debug_parallel_query: global___PostgresqlHostConfig18.DebugParallelQuery.ValueType
    client_min_messages: global___PostgresqlHostConfig18.LogLevel.ValueType
    log_min_messages: global___PostgresqlHostConfig18.LogLevel.ValueType
    log_min_error_statement: global___PostgresqlHostConfig18.LogLevel.ValueType
    log_error_verbosity: global___PostgresqlHostConfig18.LogErrorVerbosity.ValueType
    log_statement: global___PostgresqlHostConfig18.LogStatement.ValueType
    search_path: builtins.str
    default_transaction_isolation: global___PostgresqlHostConfig18.TransactionIsolation.ValueType
    bytea_output: global___PostgresqlHostConfig18.ByteaOutput.ValueType
    xmlbinary: global___PostgresqlHostConfig18.XmlBinary.ValueType
    xmloption: global___PostgresqlHostConfig18.XmlOption.ValueType
    backslash_quote: global___PostgresqlHostConfig18.BackslashQuote.ValueType
...
global___PostgresqlHostConfig18 = PostgresqlHostConfig18
