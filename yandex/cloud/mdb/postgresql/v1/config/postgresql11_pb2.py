...
_POSTGRESQLCONFIG11 = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='geqo_seed', full_name='yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig11.geqo_seed', index=128,
