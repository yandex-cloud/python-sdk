...
_POSTGRESQLCONFIG11 = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\372\3071\0070.0-1.0', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pg_trgm_similarity_threshold', full_name='yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig11.pg_trgm_similarity_threshold', index=132,
      ...
      serialized_options=b'\372\3071\0070.0-1.0', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pg_trgm_word_similarity_threshold', full_name='yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig11.pg_trgm_word_similarity_threshold', index=133,
      ...
      serialized_options=b'\372\3071\0070.0-1.0', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pg_trgm_strict_word_similarity_threshold', full_name='yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig11.pg_trgm_strict_word_similarity_threshold', index=134,
      ...
      serialized_options=b'\372\3071\0070.0-1.0', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_standby_archive_delay', full_name='yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig11.max_standby_archive_delay', index=135,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='session_duration_timeout', full_name='yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig11.session_duration_timeout', index=136,
    ...
    _descriptor.FieldDescriptor(
      name='log_replication_commands', full_name='yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig11.log_replication_commands', index=137,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='log_autovacuum_min_duration', full_name='yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig11.log_autovacuum_min_duration', index=138,
...
_POSTGRESQLCONFIG11.fields_by_name['pg_trgm_similarity_threshold'].message_type = google_dot_protobuf_dot_wrappers__pb2._DOUBLEVALUE
_POSTGRESQLCONFIG11.fields_by_name['pg_trgm_word_similarity_threshold'].message_type = google_dot_protobuf_dot_wrappers__pb2._DOUBLEVALUE
_POSTGRESQLCONFIG11.fields_by_name['pg_trgm_strict_word_similarity_threshold'].message_type = google_dot_protobuf_dot_wrappers__pb2._DOUBLEVALUE
_POSTGRESQLCONFIG11.fields_by_name['max_standby_archive_delay'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
_POSTGRESQLCONFIG11.fields_by_name['session_duration_timeout'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
_POSTGRESQLCONFIG11.fields_by_name['log_replication_commands'].message_type = google_dot_protobuf_dot_wrappers__pb2._BOOLVALUE
_POSTGRESQLCONFIG11.fields_by_name['log_autovacuum_min_duration'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
...
_POSTGRESQLCONFIG11.fields_by_name['pg_trgm_similarity_threshold']._options = None
_POSTGRESQLCONFIG11.fields_by_name['pg_trgm_word_similarity_threshold']._options = None
_POSTGRESQLCONFIG11.fields_by_name['pg_trgm_strict_word_similarity_threshold']._options = None
_POSTGRESQLCONFIG11.fields_by_name['session_duration_timeout']._options = None
_POSTGRESQLCONFIG11.fields_by_name['log_autovacuum_min_duration']._options = None
