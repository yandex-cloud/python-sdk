...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['backend_flush_after']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['backend_flush_after']._serialized_options = b'\372\3071\0060-2048'
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['old_snapshot_threshold']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['old_snapshot_threshold']._serialized_options = b'\372\3071\010-1-86400'
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['from_collapse_limit']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['from_collapse_limit']._serialized_options = b'\372\3071\0141-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['join_collapse_limit']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['join_collapse_limit']._serialized_options = b'\372\3071\0141-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['idle_in_transaction_session_timeout']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['idle_in_transaction_session_timeout']._serialized_options = b'\372\3071\0140-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['deadlock_timeout']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['deadlock_timeout']._serialized_options = b'\372\3071\0141-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['max_parallel_workers']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['max_parallel_workers']._serialized_options = b'\372\3071\0060-1024'
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['max_parallel_workers_per_gather']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG10_1C'].fields_by_name['max_parallel_workers_per_gather']._serialized_options = b'\372\3071\0060-1024'
  ...
  _globals['_POSTGRESQLHOSTCONFIG10_1C']._serialized_end=6285
  _globals['_POSTGRESQLHOSTCONFIG10_1C_CONSTRAINTEXCLUSION']._serialized_start=4745
  _globals['_POSTGRESQLHOSTCONFIG10_1C_CONSTRAINTEXCLUSION']._serialized_end=4899
  _globals['_POSTGRESQLHOSTCONFIG10_1C_FORCEPARALLELMODE']._serialized_start=4902
  _globals['_POSTGRESQLHOSTCONFIG10_1C_FORCEPARALLELMODE']._serialized_end=5048
  _globals['_POSTGRESQLHOSTCONFIG10_1C_LOGLEVEL']._serialized_start=5051
  _globals['_POSTGRESQLHOSTCONFIG10_1C_LOGLEVEL']._serialized_end=5325
  _globals['_POSTGRESQLHOSTCONFIG10_1C_LOGERRORVERBOSITY']._serialized_start=5328
  _globals['_POSTGRESQLHOSTCONFIG10_1C_LOGERRORVERBOSITY']._serialized_end=5481
  _globals['_POSTGRESQLHOSTCONFIG10_1C_LOGSTATEMENT']._serialized_start=5484
  _globals['_POSTGRESQLHOSTCONFIG10_1C_LOGSTATEMENT']._serialized_end=5622
  _globals['_POSTGRESQLHOSTCONFIG10_1C_TRANSACTIONISOLATION']._serialized_start=5625
  _globals['_POSTGRESQLHOSTCONFIG10_1C_TRANSACTIONISOLATION']._serialized_end=5855
  _globals['_POSTGRESQLHOSTCONFIG10_1C_BYTEAOUTPUT']._serialized_start=5857
  _globals['_POSTGRESQLHOSTCONFIG10_1C_BYTEAOUTPUT']._serialized_end=5948
  _globals['_POSTGRESQLHOSTCONFIG10_1C_XMLBINARY']._serialized_start=5950
  _globals['_POSTGRESQLHOSTCONFIG10_1C_XMLBINARY']._serialized_end=6032
  _globals['_POSTGRESQLHOSTCONFIG10_1C_XMLOPTION']._serialized_start=6034
  _globals['_POSTGRESQLHOSTCONFIG10_1C_XMLOPTION']._serialized_end=6122
  _globals['_POSTGRESQLHOSTCONFIG10_1C_BACKSLASHQUOTE']._serialized_start=6125
  _globals['_POSTGRESQLHOSTCONFIG10_1C_BACKSLASHQUOTE']._serialized_end=6279
