...
@typing.final
class PostgresqlConfig19_1C(google.protobuf.message.Message):
    ...
    class _AutoExplainLogFormatEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._AutoExplainLogFormat.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        AUTO_EXPLAIN_LOG_FORMAT_UNSPECIFIED: PostgresqlConfig19_1C._AutoExplainLogFormat.ValueType  # 0
        """Not specified."""
        AUTO_EXPLAIN_LOG_FORMAT_TEXT: PostgresqlConfig19_1C._AutoExplainLogFormat.ValueType  # 1
        """Formats logged execution plans as plain text."""
        AUTO_EXPLAIN_LOG_FORMAT_XML: PostgresqlConfig19_1C._AutoExplainLogFormat.ValueType  # 2
        """Formats logged execution plans as XML."""
        AUTO_EXPLAIN_LOG_FORMAT_JSON: PostgresqlConfig19_1C._AutoExplainLogFormat.ValueType  # 3
        """Formats logged execution plans as JSON."""
        AUTO_EXPLAIN_LOG_FORMAT_YAML: PostgresqlConfig19_1C._AutoExplainLogFormat.ValueType  # 4
    ...
    AUTO_EXPLAIN_LOG_FORMAT_UNSPECIFIED: PostgresqlConfig19_1C.AutoExplainLogFormat.ValueType  # 0
    """Not specified."""
    AUTO_EXPLAIN_LOG_FORMAT_TEXT: PostgresqlConfig19_1C.AutoExplainLogFormat.ValueType  # 1
    """Formats logged execution plans as plain text."""
    AUTO_EXPLAIN_LOG_FORMAT_XML: PostgresqlConfig19_1C.AutoExplainLogFormat.ValueType  # 2
    """Formats logged execution plans as XML."""
    AUTO_EXPLAIN_LOG_FORMAT_JSON: PostgresqlConfig19_1C.AutoExplainLogFormat.ValueType  # 3
    """Formats logged execution plans as JSON."""
    AUTO_EXPLAIN_LOG_FORMAT_YAML: PostgresqlConfig19_1C.AutoExplainLogFormat.ValueType  # 4
    """Formats logged execution plans as YAML."""
    ...
    class _BackslashQuoteEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._BackslashQuote.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        BACKSLASH_QUOTE_UNSPECIFIED: PostgresqlConfig19_1C._BackslashQuote.ValueType  # 0
        """Not specified."""
        BACKSLASH_QUOTE: PostgresqlConfig19_1C._BackslashQuote.ValueType  # 1
        """Legacy invalid value. Do not use."""
        BACKSLASH_QUOTE_ON: PostgresqlConfig19_1C._BackslashQuote.ValueType  # 2
        """Quotation mark can be represented as \\'."""
        BACKSLASH_QUOTE_OFF: PostgresqlConfig19_1C._BackslashQuote.ValueType  # 3
        """Quotation mark can only be represented using the standard SQL syntax ''."""
        BACKSLASH_QUOTE_SAFE_ENCODING: PostgresqlConfig19_1C._BackslashQuote.ValueType  # 4
    ...
    BACKSLASH_QUOTE_UNSPECIFIED: PostgresqlConfig19_1C.BackslashQuote.ValueType  # 0
    """Not specified."""
    BACKSLASH_QUOTE: PostgresqlConfig19_1C.BackslashQuote.ValueType  # 1
    """Legacy invalid value. Do not use."""
    BACKSLASH_QUOTE_ON: PostgresqlConfig19_1C.BackslashQuote.ValueType  # 2
    """Quotation mark can be represented as \\'."""
    BACKSLASH_QUOTE_OFF: PostgresqlConfig19_1C.BackslashQuote.ValueType  # 3
    """Quotation mark can only be represented using the standard SQL syntax ''."""
    BACKSLASH_QUOTE_SAFE_ENCODING: PostgresqlConfig19_1C.BackslashQuote.ValueType  # 4
    """Representing a quotation mark as \\' is only permitted for client encodings where \\ is not used for multibyte characters."""
    ...
    class _ByteaOutputEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._ByteaOutput.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        BYTEA_OUTPUT_UNSPECIFIED: PostgresqlConfig19_1C._ByteaOutput.ValueType  # 0
        """Not specified."""
        BYTEA_OUTPUT_HEX: PostgresqlConfig19_1C._ByteaOutput.ValueType  # 1
        """Each byte is represented by two hexadecimal characters, e.g., 'SELECT '\\xDEADBEEF';'."""
        BYTEA_OUTPUT_ESCAPED: PostgresqlConfig19_1C._ByteaOutput.ValueType  # 2
    ...
    BYTEA_OUTPUT_UNSPECIFIED: PostgresqlConfig19_1C.ByteaOutput.ValueType  # 0
    """Not specified."""
    BYTEA_OUTPUT_HEX: PostgresqlConfig19_1C.ByteaOutput.ValueType  # 1
    """Each byte is represented by two hexadecimal characters, e.g., 'SELECT '\\xDEADBEEF';'."""
    BYTEA_OUTPUT_ESCAPED: PostgresqlConfig19_1C.ByteaOutput.ValueType  # 2
    """Standard PostgreSQL format with ASCII characters only."""
    ...
    class _ConstraintExclusionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._ConstraintExclusion.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        CONSTRAINT_EXCLUSION_UNSPECIFIED: PostgresqlConfig19_1C._ConstraintExclusion.ValueType  # 0
        """Not specified."""
        CONSTRAINT_EXCLUSION_ON: PostgresqlConfig19_1C._ConstraintExclusion.ValueType  # 1
        """Enable planner's use of constraints for all tables."""
        CONSTRAINT_EXCLUSION_OFF: PostgresqlConfig19_1C._ConstraintExclusion.ValueType  # 2
        """Disable planner's use of constraints for all tables"""
        CONSTRAINT_EXCLUSION_PARTITION: PostgresqlConfig19_1C._ConstraintExclusion.ValueType  # 3
    ...
    CONSTRAINT_EXCLUSION_UNSPECIFIED: PostgresqlConfig19_1C.ConstraintExclusion.ValueType  # 0
    """Not specified."""
    CONSTRAINT_EXCLUSION_ON: PostgresqlConfig19_1C.ConstraintExclusion.ValueType  # 1
    """Enable planner's use of constraints for all tables."""
    CONSTRAINT_EXCLUSION_OFF: PostgresqlConfig19_1C.ConstraintExclusion.ValueType  # 2
    """Disable planner's use of constraints for all tables"""
    CONSTRAINT_EXCLUSION_PARTITION: PostgresqlConfig19_1C.ConstraintExclusion.ValueType  # 3
    """Only use constraints for child tables and UNION ALL clauses."""
    ...
    class _DebugParallelQueryEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._DebugParallelQuery.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        DEBUG_PARALLEL_QUERY_UNSPECIFIED: PostgresqlConfig19_1C._DebugParallelQuery.ValueType  # 0
        """Not specified."""
        DEBUG_PARALLEL_QUERY_ON: PostgresqlConfig19_1C._DebugParallelQuery.ValueType  # 1
        """Forces parallel mode for queries considered safe, even when no performance benefit is expected."""
        DEBUG_PARALLEL_QUERY_OFF: PostgresqlConfig19_1C._DebugParallelQuery.ValueType  # 2
        """Uses parallel mode only when the planner expects it to improve performance."""
        DEBUG_PARALLEL_QUERY_REGRESS: PostgresqlConfig19_1C._DebugParallelQuery.ValueType  # 3
    ...
    DEBUG_PARALLEL_QUERY_UNSPECIFIED: PostgresqlConfig19_1C.DebugParallelQuery.ValueType  # 0
    """Not specified."""
    DEBUG_PARALLEL_QUERY_ON: PostgresqlConfig19_1C.DebugParallelQuery.ValueType  # 1
    """Forces parallel mode for queries considered safe, even when no performance benefit is expected."""
    DEBUG_PARALLEL_QUERY_OFF: PostgresqlConfig19_1C.DebugParallelQuery.ValueType  # 2
    """Uses parallel mode only when the planner expects it to improve performance."""
    DEBUG_PARALLEL_QUERY_REGRESS: PostgresqlConfig19_1C.DebugParallelQuery.ValueType  # 3
    """Behaves like ON, but hides added Gather nodes in EXPLAIN output and
    suppresses parallel-worker context lines to stabilize regression-test output.
    """
    ...
    class _LogErrorVerbosityEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._LogErrorVerbosity.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        LOG_ERROR_VERBOSITY_UNSPECIFIED: PostgresqlConfig19_1C._LogErrorVerbosity.ValueType  # 0
        """Not specified."""
        LOG_ERROR_VERBOSITY_TERSE: PostgresqlConfig19_1C._LogErrorVerbosity.ValueType  # 1
        """DETAIL, HINT, QUERY, and CONTEXT fields are excluded from the error message."""
        LOG_ERROR_VERBOSITY_DEFAULT: PostgresqlConfig19_1C._LogErrorVerbosity.ValueType  # 2
        """Default."""
        LOG_ERROR_VERBOSITY_VERBOSE: PostgresqlConfig19_1C._LogErrorVerbosity.ValueType  # 3
    ...
    LOG_ERROR_VERBOSITY_UNSPECIFIED: PostgresqlConfig19_1C.LogErrorVerbosity.ValueType  # 0
    """Not specified."""
    LOG_ERROR_VERBOSITY_TERSE: PostgresqlConfig19_1C.LogErrorVerbosity.ValueType  # 1
    """DETAIL, HINT, QUERY, and CONTEXT fields are excluded from the error message."""
    LOG_ERROR_VERBOSITY_DEFAULT: PostgresqlConfig19_1C.LogErrorVerbosity.ValueType  # 2
    """Default."""
    LOG_ERROR_VERBOSITY_VERBOSE: PostgresqlConfig19_1C.LogErrorVerbosity.ValueType  # 3
    """Error message includes the SQLSTATE error code, source filename, function name, and the line number where the error occurred."""
    ...
    class _LogLevelEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._LogLevel.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        LOG_LEVEL_UNSPECIFIED: PostgresqlConfig19_1C._LogLevel.ValueType  # 0
        """Not specified."""
        LOG_LEVEL_DEBUG5: PostgresqlConfig19_1C._LogLevel.ValueType  # 1
        """Provides the most detailed diagnostic information for developers."""
        LOG_LEVEL_DEBUG4: PostgresqlConfig19_1C._LogLevel.ValueType  # 2
        """Provides more detailed diagnostic information than DEBUG3."""
        LOG_LEVEL_DEBUG3: PostgresqlConfig19_1C._LogLevel.ValueType  # 3
        """Provides more detailed diagnostic information than DEBUG2."""
        LOG_LEVEL_DEBUG2: PostgresqlConfig19_1C._LogLevel.ValueType  # 4
        """Provides more detailed diagnostic information than DEBUG1."""
        LOG_LEVEL_DEBUG1: PostgresqlConfig19_1C._LogLevel.ValueType  # 5
        """Provides diagnostic information for developers."""
        LOG_LEVEL_INFO: PostgresqlConfig19_1C._LogLevel.ValueType  # 12
        """Reports information implicitly requested by the user."""
        LOG_LEVEL_LOG: PostgresqlConfig19_1C._LogLevel.ValueType  # 6
        """Reports information of interest to database administrators."""
        LOG_LEVEL_NOTICE: PostgresqlConfig19_1C._LogLevel.ValueType  # 7
        """Reports information that may be helpful to users."""
        LOG_LEVEL_WARNING: PostgresqlConfig19_1C._LogLevel.ValueType  # 8
        """Reports a warning about a likely problem."""
        LOG_LEVEL_ERROR: PostgresqlConfig19_1C._LogLevel.ValueType  # 9
        """Reports an error that aborts the current command."""
        LOG_LEVEL_FATAL: PostgresqlConfig19_1C._LogLevel.ValueType  # 10
        """Reports an error that aborts the current session."""
        LOG_LEVEL_PANIC: PostgresqlConfig19_1C._LogLevel.ValueType  # 11
        """Reports an error that aborts all database sessions."""

    class LogLevel(_LogLevel, metaclass=_LogLevelEnumTypeWrapper): ...
    LOG_LEVEL_UNSPECIFIED: PostgresqlConfig19_1C.LogLevel.ValueType  # 0
    """Not specified."""
    LOG_LEVEL_DEBUG5: PostgresqlConfig19_1C.LogLevel.ValueType  # 1
    """Provides the most detailed diagnostic information for developers."""
    LOG_LEVEL_DEBUG4: PostgresqlConfig19_1C.LogLevel.ValueType  # 2
    """Provides more detailed diagnostic information than DEBUG3."""
    LOG_LEVEL_DEBUG3: PostgresqlConfig19_1C.LogLevel.ValueType  # 3
    """Provides more detailed diagnostic information than DEBUG2."""
    LOG_LEVEL_DEBUG2: PostgresqlConfig19_1C.LogLevel.ValueType  # 4
    """Provides more detailed diagnostic information than DEBUG1."""
    LOG_LEVEL_DEBUG1: PostgresqlConfig19_1C.LogLevel.ValueType  # 5
    """Provides diagnostic information for developers."""
    LOG_LEVEL_INFO: PostgresqlConfig19_1C.LogLevel.ValueType  # 12
    """Reports information implicitly requested by the user."""
    LOG_LEVEL_LOG: PostgresqlConfig19_1C.LogLevel.ValueType  # 6
    """Reports information of interest to database administrators."""
    LOG_LEVEL_NOTICE: PostgresqlConfig19_1C.LogLevel.ValueType  # 7
    """Reports information that may be helpful to users."""
    LOG_LEVEL_WARNING: PostgresqlConfig19_1C.LogLevel.ValueType  # 8
    """Reports a warning about a likely problem."""
    LOG_LEVEL_ERROR: PostgresqlConfig19_1C.LogLevel.ValueType  # 9
    """Reports an error that aborts the current command."""
    LOG_LEVEL_FATAL: PostgresqlConfig19_1C.LogLevel.ValueType  # 10
    """Reports an error that aborts the current session."""
    LOG_LEVEL_PANIC: PostgresqlConfig19_1C.LogLevel.ValueType  # 11
    """Reports an error that aborts all database sessions."""
    ...
    class _LogStatementEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._LogStatement.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        LOG_STATEMENT_UNSPECIFIED: PostgresqlConfig19_1C._LogStatement.ValueType  # 0
        """Not specified."""
        LOG_STATEMENT_NONE: PostgresqlConfig19_1C._LogStatement.ValueType  # 1
        """The filter is disabled, no SQL statements are logged."""
        LOG_STATEMENT_DDL: PostgresqlConfig19_1C._LogStatement.ValueType  # 2
        """System logs DDL statements, e.g., CREATE, ALTER, DROP etc."""
        LOG_STATEMENT_MOD: PostgresqlConfig19_1C._LogStatement.ValueType  # 3
        """System logs ddl-statements along with data modification commands, e.g., INSERT, UPDATE, etc."""
        LOG_STATEMENT_ALL: PostgresqlConfig19_1C._LogStatement.ValueType  # 4
        """System logs all SQL statements."""

    class LogStatement(_LogStatement, metaclass=_LogStatementEnumTypeWrapper): ...
    LOG_STATEMENT_UNSPECIFIED: PostgresqlConfig19_1C.LogStatement.ValueType  # 0
    """Not specified."""
    LOG_STATEMENT_NONE: PostgresqlConfig19_1C.LogStatement.ValueType  # 1
    """The filter is disabled, no SQL statements are logged."""
    LOG_STATEMENT_DDL: PostgresqlConfig19_1C.LogStatement.ValueType  # 2
    """System logs DDL statements, e.g., CREATE, ALTER, DROP etc."""
    LOG_STATEMENT_MOD: PostgresqlConfig19_1C.LogStatement.ValueType  # 3
    """System logs ddl-statements along with data modification commands, e.g., INSERT, UPDATE, etc."""
    LOG_STATEMENT_ALL: PostgresqlConfig19_1C.LogStatement.ValueType  # 4
    """System logs all SQL statements."""
    ...
    class _PasswordEncryptionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._PasswordEncryption.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        PASSWORD_ENCRYPTION_UNSPECIFIED: PostgresqlConfig19_1C._PasswordEncryption.ValueType  # 0
        """Not specified."""
        PASSWORD_ENCRYPTION_MD5: PostgresqlConfig19_1C._PasswordEncryption.ValueType  # 1
        ...
        PASSWORD_ENCRYPTION_SCRAM_SHA_256: PostgresqlConfig19_1C._PasswordEncryption.ValueType  # 2
    ...
    PASSWORD_ENCRYPTION_UNSPECIFIED: PostgresqlConfig19_1C.PasswordEncryption.ValueType  # 0
    """Not specified."""
    PASSWORD_ENCRYPTION_MD5: PostgresqlConfig19_1C.PasswordEncryption.ValueType  # 1
    """The method md5 uses a custom less secure challenge-response mechanism. It prevents password sniffing and avoids storing passwords on the server in plain text but provides no protection if an attacker manages to steal the password hash from the server. Also, the MD5 hash algorithm is nowadays no longer considered secure against determined attacks."""
    PASSWORD_ENCRYPTION_SCRAM_SHA_256: PostgresqlConfig19_1C.PasswordEncryption.ValueType  # 2
    """The method scram-sha-256 performs SCRAM-SHA-256 authentication, as described in RFC 7677. It is a challenge-response scheme that prevents password sniffing on untrusted connections and supports storing passwords on the server in a cryptographically hashed form that is thought to be secure.
    This is the most secure of the currently provided methods, but it is not supported by older client libraries.
    """
    ...
    class _PgHintPlanDebugPrintEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._PgHintPlanDebugPrint.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        PG_HINT_PLAN_DEBUG_PRINT_UNSPECIFIED: PostgresqlConfig19_1C._PgHintPlanDebugPrint.ValueType  # 0
        """Not specified."""
        PG_HINT_PLAN_DEBUG_PRINT_OFF: PostgresqlConfig19_1C._PgHintPlanDebugPrint.ValueType  # 1
        """Disables diagnostic logging."""
        PG_HINT_PLAN_DEBUG_PRINT_ON: PostgresqlConfig19_1C._PgHintPlanDebugPrint.ValueType  # 2
        """Logs hint-processing results grouped by used, unused, duplicate, and erroneous hints."""
        PG_HINT_PLAN_DEBUG_PRINT_DETAILED: PostgresqlConfig19_1C._PgHintPlanDebugPrint.ValueType  # 3
        """Logs hint-processing results together with detailed planner diagnostics."""
        PG_HINT_PLAN_DEBUG_PRINT_VERBOSE: PostgresqlConfig19_1C._PgHintPlanDebugPrint.ValueType  # 4
    ...
    PG_HINT_PLAN_DEBUG_PRINT_UNSPECIFIED: PostgresqlConfig19_1C.PgHintPlanDebugPrint.ValueType  # 0
    """Not specified."""
    PG_HINT_PLAN_DEBUG_PRINT_OFF: PostgresqlConfig19_1C.PgHintPlanDebugPrint.ValueType  # 1
    """Disables diagnostic logging."""
    PG_HINT_PLAN_DEBUG_PRINT_ON: PostgresqlConfig19_1C.PgHintPlanDebugPrint.ValueType  # 2
    """Logs hint-processing results grouped by used, unused, duplicate, and erroneous hints."""
    PG_HINT_PLAN_DEBUG_PRINT_DETAILED: PostgresqlConfig19_1C.PgHintPlanDebugPrint.ValueType  # 3
    """Logs hint-processing results together with detailed planner diagnostics."""
    PG_HINT_PLAN_DEBUG_PRINT_VERBOSE: PostgresqlConfig19_1C.PgHintPlanDebugPrint.ValueType  # 4
    """Logs the most detailed diagnostics, including query strings used to extract hints."""
    ...
    class _PlanCacheModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._PlanCacheMode.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        PLAN_CACHE_MODE_UNSPECIFIED: PostgresqlConfig19_1C._PlanCacheMode.ValueType  # 0
        """Not specified."""
        PLAN_CACHE_MODE_AUTO: PostgresqlConfig19_1C._PlanCacheMode.ValueType  # 1
        """Automatic selection."""
        PLAN_CACHE_MODE_FORCE_CUSTOM_PLAN: PostgresqlConfig19_1C._PlanCacheMode.ValueType  # 2
        """Forces the use of custom plans."""
        PLAN_CACHE_MODE_FORCE_GENERIC_PLAN: PostgresqlConfig19_1C._PlanCacheMode.ValueType  # 3
        """Forces the use of generic plans."""

    class PlanCacheMode(_PlanCacheMode, metaclass=_PlanCacheModeEnumTypeWrapper): ...
    PLAN_CACHE_MODE_UNSPECIFIED: PostgresqlConfig19_1C.PlanCacheMode.ValueType  # 0
    """Not specified."""
    PLAN_CACHE_MODE_AUTO: PostgresqlConfig19_1C.PlanCacheMode.ValueType  # 1
    """Automatic selection."""
    PLAN_CACHE_MODE_FORCE_CUSTOM_PLAN: PostgresqlConfig19_1C.PlanCacheMode.ValueType  # 2
    """Forces the use of custom plans."""
    PLAN_CACHE_MODE_FORCE_GENERIC_PLAN: PostgresqlConfig19_1C.PlanCacheMode.ValueType  # 3
    """Forces the use of generic plans."""
    ...
    class _SharedPreloadLibrariesEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._SharedPreloadLibraries.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        SHARED_PRELOAD_LIBRARIES_UNSPECIFIED: PostgresqlConfig19_1C._SharedPreloadLibraries.ValueType  # 0
        """Not specified."""
        SHARED_PRELOAD_LIBRARIES_AUTO_EXPLAIN: PostgresqlConfig19_1C._SharedPreloadLibraries.ValueType  # 1
        """Required for the [auto_explain](https://www.postgresql.org/docs/current/auto-explain.html) extension."""
        SHARED_PRELOAD_LIBRARIES_PG_HINT_PLAN: PostgresqlConfig19_1C._SharedPreloadLibraries.ValueType  # 2
        """Required for the [pg_hint_plan](https://github.com/ossc-db/pg_hint_plan) extension."""
        SHARED_PRELOAD_LIBRARIES_TIMESCALEDB: PostgresqlConfig19_1C._SharedPreloadLibraries.ValueType  # 3
        """Required for [TimescaleDB](https://github.com/timescale/timescaledb) to function."""
        SHARED_PRELOAD_LIBRARIES_PG_QUALSTATS: PostgresqlConfig19_1C._SharedPreloadLibraries.ValueType  # 4
        """Required for the [pg_qualstats](https://github.com/powa-team/pg_qualstats) extension."""
        SHARED_PRELOAD_LIBRARIES_PG_CRON: PostgresqlConfig19_1C._SharedPreloadLibraries.ValueType  # 5
        """Required for the [pg_cron](https://github.com/citusdata/pg_cron) extension."""
        SHARED_PRELOAD_LIBRARIES_PGLOGICAL: PostgresqlConfig19_1C._SharedPreloadLibraries.ValueType  # 6
        """Required for the [pglogical](https://github.com/2ndQuadrant/pglogical) extension."""
        SHARED_PRELOAD_LIBRARIES_PG_PREWARM: PostgresqlConfig19_1C._SharedPreloadLibraries.ValueType  # 7
        ...
        SHARED_PRELOAD_LIBRARIES_PGAUDIT: PostgresqlConfig19_1C._SharedPreloadLibraries.ValueType  # 8
        """Required for the [pgaudit](https://www.pgaudit.org/) extension."""
        SHARED_PRELOAD_LIBRARIES_ANON: PostgresqlConfig19_1C._SharedPreloadLibraries.ValueType  # 9
        """Required for the [postgresql_anonymizer](https://postgresql-anonymizer.readthedocs.io/en/stable/) extension."""
        SHARED_PRELOAD_LIBRARIES_AGE: PostgresqlConfig19_1C._SharedPreloadLibraries.ValueType  # 10
        """Required for the [age](https://age.apache.org/) extension."""
        SHARED_PRELOAD_LIBRARIES_SPQRGUARD: PostgresqlConfig19_1C._SharedPreloadLibraries.ValueType  # 11
    ...
    SHARED_PRELOAD_LIBRARIES_UNSPECIFIED: PostgresqlConfig19_1C.SharedPreloadLibraries.ValueType  # 0
    """Not specified."""
    SHARED_PRELOAD_LIBRARIES_AUTO_EXPLAIN: PostgresqlConfig19_1C.SharedPreloadLibraries.ValueType  # 1
    """Required for the [auto_explain](https://www.postgresql.org/docs/current/auto-explain.html) extension."""
    SHARED_PRELOAD_LIBRARIES_PG_HINT_PLAN: PostgresqlConfig19_1C.SharedPreloadLibraries.ValueType  # 2
    """Required for the [pg_hint_plan](https://github.com/ossc-db/pg_hint_plan) extension."""
    SHARED_PRELOAD_LIBRARIES_TIMESCALEDB: PostgresqlConfig19_1C.SharedPreloadLibraries.ValueType  # 3
    """Required for [TimescaleDB](https://github.com/timescale/timescaledb) to function."""
    SHARED_PRELOAD_LIBRARIES_PG_QUALSTATS: PostgresqlConfig19_1C.SharedPreloadLibraries.ValueType  # 4
    """Required for the [pg_qualstats](https://github.com/powa-team/pg_qualstats) extension."""
    SHARED_PRELOAD_LIBRARIES_PG_CRON: PostgresqlConfig19_1C.SharedPreloadLibraries.ValueType  # 5
    """Required for the [pg_cron](https://github.com/citusdata/pg_cron) extension."""
    SHARED_PRELOAD_LIBRARIES_PGLOGICAL: PostgresqlConfig19_1C.SharedPreloadLibraries.ValueType  # 6
    """Required for the [pglogical](https://github.com/2ndQuadrant/pglogical) extension."""
    SHARED_PRELOAD_LIBRARIES_PG_PREWARM: PostgresqlConfig19_1C.SharedPreloadLibraries.ValueType  # 7
    """Shared library of extension [pg_prewarm](https://www.postgresql.org/docs/current/pgprewarm.html#PGPREWARM), which ensures loading of extension on server start"""
    SHARED_PRELOAD_LIBRARIES_PGAUDIT: PostgresqlConfig19_1C.SharedPreloadLibraries.ValueType  # 8
    """Required for the [pgaudit](https://www.pgaudit.org/) extension."""
    SHARED_PRELOAD_LIBRARIES_ANON: PostgresqlConfig19_1C.SharedPreloadLibraries.ValueType  # 9
    """Required for the [postgresql_anonymizer](https://postgresql-anonymizer.readthedocs.io/en/stable/) extension."""
    SHARED_PRELOAD_LIBRARIES_AGE: PostgresqlConfig19_1C.SharedPreloadLibraries.ValueType  # 10
    """Required for the [age](https://age.apache.org/) extension."""
    SHARED_PRELOAD_LIBRARIES_SPQRGUARD: PostgresqlConfig19_1C.SharedPreloadLibraries.ValueType  # 11
    """Required for the [spqrguard](https://github.com/pg-sharding/spqrguard) extension."""
    ...
    class _SynchronousCommitEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._SynchronousCommit.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        SYNCHRONOUS_COMMIT_UNSPECIFIED: PostgresqlConfig19_1C._SynchronousCommit.ValueType  # 0
        """Not specified."""
        SYNCHRONOUS_COMMIT_ON: PostgresqlConfig19_1C._SynchronousCommit.ValueType  # 1
        ...
        SYNCHRONOUS_COMMIT_OFF: PostgresqlConfig19_1C._SynchronousCommit.ValueType  # 2
        ...
        """
        SYNCHRONOUS_COMMIT_LOCAL: PostgresqlConfig19_1C._SynchronousCommit.ValueType  # 3
        ...
        """
        SYNCHRONOUS_COMMIT_REMOTE_WRITE: PostgresqlConfig19_1C._SynchronousCommit.ValueType  # 4
        ...
        """
        SYNCHRONOUS_COMMIT_REMOTE_APPLY: PostgresqlConfig19_1C._SynchronousCommit.ValueType  # 5
    ...
    SYNCHRONOUS_COMMIT_UNSPECIFIED: PostgresqlConfig19_1C.SynchronousCommit.ValueType  # 0
    """Not specified."""
    SYNCHRONOUS_COMMIT_ON: PostgresqlConfig19_1C.SynchronousCommit.ValueType  # 1
    """Success is reported to the client if the data is in WAL (Write-Ahead Log), and WAL is written to the storage of both the master and its synchronous standby server. Default value."""
    SYNCHRONOUS_COMMIT_OFF: PostgresqlConfig19_1C.SynchronousCommit.ValueType  # 2
    """Success is reported to the client even if the data is not in WAL.
    There is no synchronous write operation, data may be loss in case of storage subsystem failure.
    """
    SYNCHRONOUS_COMMIT_LOCAL: PostgresqlConfig19_1C.SynchronousCommit.ValueType  # 3
    """Success is reported to the client if the data is in WAL, and WAL is written to the storage of the master server.
    The transaction may be lost due to storage subsystem failure on the master server.
    """
    SYNCHRONOUS_COMMIT_REMOTE_WRITE: PostgresqlConfig19_1C.SynchronousCommit.ValueType  # 4
    """Success is reported to the client if the data is in WAL, WAL is written to the storage of the master server, and the server's synchronous standby indicates that it has received WAL and written it out to its operating system.
    The transaction may be lost due to simultaneous storage subsystem failure on the master and operating system's failure on the synchronous standby.
    """
    SYNCHRONOUS_COMMIT_REMOTE_APPLY: PostgresqlConfig19_1C.SynchronousCommit.ValueType  # 5
    """Success is reported to the client if the data is in WAL (Write-Ahead Log), WAL is written to the storage of the master server, and its synchronous standby indicates that it has received WAL and applied it.
    The transaction may be lost due to irrecoverably failure of both the master and its synchronous standby.
    """
    ...
    class _TransactionIsolationEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._TransactionIsolation.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        TRANSACTION_ISOLATION_UNSPECIFIED: PostgresqlConfig19_1C._TransactionIsolation.ValueType  # 0
        """Not specified."""
        TRANSACTION_ISOLATION_READ_UNCOMMITTED: PostgresqlConfig19_1C._TransactionIsolation.ValueType  # 1
        """This level behaves like `TRANSACTION_ISOLATION_READ_COMMITTED` in PostgreSQL."""
        TRANSACTION_ISOLATION_READ_COMMITTED: PostgresqlConfig19_1C._TransactionIsolation.ValueType  # 2
        """On this level query sees only data committed before the query began."""
        TRANSACTION_ISOLATION_REPEATABLE_READ: PostgresqlConfig19_1C._TransactionIsolation.ValueType  # 3
        ...
        TRANSACTION_ISOLATION_SERIALIZABLE: PostgresqlConfig19_1C._TransactionIsolation.ValueType  # 4
    ...
    TRANSACTION_ISOLATION_UNSPECIFIED: PostgresqlConfig19_1C.TransactionIsolation.ValueType  # 0
    """Not specified."""
    TRANSACTION_ISOLATION_READ_UNCOMMITTED: PostgresqlConfig19_1C.TransactionIsolation.ValueType  # 1
    """This level behaves like `TRANSACTION_ISOLATION_READ_COMMITTED` in PostgreSQL."""
    TRANSACTION_ISOLATION_READ_COMMITTED: PostgresqlConfig19_1C.TransactionIsolation.ValueType  # 2
    """On this level query sees only data committed before the query began."""
    TRANSACTION_ISOLATION_REPEATABLE_READ: PostgresqlConfig19_1C.TransactionIsolation.ValueType  # 3
    """On this level all subsequent queries in a transaction will see the same rows, that were read by the first `SELECT` or `INSERT` query in this transaction, unchanged (these rows are locked during the first query)."""
    TRANSACTION_ISOLATION_SERIALIZABLE: PostgresqlConfig19_1C.TransactionIsolation.ValueType  # 4
    """This level provides the strictest transaction isolation.
    All queries in the current transaction see only the rows that were fixed prior to execution of the first `SELECT` or `INSERT` query in this transaction.
    If read and write operations in a concurrent set of serializable transactions overlap and this may cause an inconsistency that is not possible during the serial transaction execution, then one of the transaction will be rolled back, triggering a serialization failure.
    """
    ...
    class _WalLevelEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._WalLevel.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        WAL_LEVEL_UNSPECIFIED: PostgresqlConfig19_1C._WalLevel.ValueType  # 0
        """Not specified."""
        WAL_LEVEL_REPLICA: PostgresqlConfig19_1C._WalLevel.ValueType  # 1
        """Supports WAL archiving and physical replication."""
        WAL_LEVEL_LOGICAL: PostgresqlConfig19_1C._WalLevel.ValueType  # 2
    ...
    WAL_LEVEL_UNSPECIFIED: PostgresqlConfig19_1C.WalLevel.ValueType  # 0
    """Not specified."""
    WAL_LEVEL_REPLICA: PostgresqlConfig19_1C.WalLevel.ValueType  # 1
    """Supports WAL archiving and physical replication."""
    WAL_LEVEL_LOGICAL: PostgresqlConfig19_1C.WalLevel.ValueType  # 2
    """Supports WAL archiving, physical replication, and logical decoding."""
    ...
    class _XmlBinaryEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._XmlBinary.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        XML_BINARY_UNSPECIFIED: PostgresqlConfig19_1C._XmlBinary.ValueType  # 0
        """Not specified."""
        XML_BINARY_BASE64: PostgresqlConfig19_1C._XmlBinary.ValueType  # 1
        """Encodes binary values using Base64."""
        XML_BINARY_HEX: PostgresqlConfig19_1C._XmlBinary.ValueType  # 2
        """Encodes binary values using hexadecimal notation."""

    class XmlBinary(_XmlBinary, metaclass=_XmlBinaryEnumTypeWrapper): ...
    XML_BINARY_UNSPECIFIED: PostgresqlConfig19_1C.XmlBinary.ValueType  # 0
    """Not specified."""
    XML_BINARY_BASE64: PostgresqlConfig19_1C.XmlBinary.ValueType  # 1
    """Encodes binary values using Base64."""
    XML_BINARY_HEX: PostgresqlConfig19_1C.XmlBinary.ValueType  # 2
    """Encodes binary values using hexadecimal notation."""
    ...
    class _XmlOptionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig19_1C._XmlOption.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        XML_OPTION_UNSPECIFIED: PostgresqlConfig19_1C._XmlOption.ValueType  # 0
        """Not specified."""
        XML_OPTION_DOCUMENT: PostgresqlConfig19_1C._XmlOption.ValueType  # 1
        """Treats an XML value as a complete, well-formed document."""
        XML_OPTION_CONTENT: PostgresqlConfig19_1C._XmlOption.ValueType  # 2
    ...
    XML_OPTION_UNSPECIFIED: PostgresqlConfig19_1C.XmlOption.ValueType  # 0
    """Not specified."""
    XML_OPTION_DOCUMENT: PostgresqlConfig19_1C.XmlOption.ValueType  # 1
    """Treats an XML value as a complete, well-formed document."""
    XML_OPTION_CONTENT: PostgresqlConfig19_1C.XmlOption.ValueType  # 2
    """Treats an XML value as a content fragment, which may contain multiple top-level elements or character nodes."""
    ...
    TRACK_COMMIT_TIMESTAMP_FIELD_NUMBER: builtins.int
    MAX_LOGICAL_REPLICATION_WORKERS_FIELD_NUMBER: builtins.int
    MAX_WAL_SENDERS_FIELD_NUMBER: builtins.int
    MAX_REPLICATION_SLOTS_FIELD_NUMBER: builtins.int
    IDLE_SESSION_TIMEOUT_FIELD_NUMBER: builtins.int
    CHECKPOINT_WARNING_FIELD_NUMBER: builtins.int
    VACUUM_TRUNCATE_FIELD_NUMBER: builtins.int
    AUTOVACUUM_VACUUM_THRESHOLD_FIELD_NUMBER: builtins.int
    AUTOVACUUM_ANALYZE_THRESHOLD_FIELD_NUMBER: builtins.int
    MAX_ACTIVE_REPLICATION_ORIGINS_FIELD_NUMBER: builtins.int
    AUTOVACUUM_MAX_PARALLEL_WORKERS_FIELD_NUMBER: builtins.int
    LOG_AUTOANALYZE_MIN_DURATION_FIELD_NUMBER: builtins.int
    MAX_REPACK_REPLICATION_SLOTS_FIELD_NUMBER: builtins.int
    AUTO_EXPLAIN_LOG_IO_FIELD_NUMBER: builtins.int
    wal_level: global___PostgresqlConfig19_1C.WalLevel.ValueType
    """Sets the level of information written to the WAL."""
    synchronous_commit: global___PostgresqlConfig19_1C.SynchronousCommit.ValueType
    """Sets the current transaction's synchronization level."""
    constraint_exclusion: global___PostgresqlConfig19_1C.ConstraintExclusion.ValueType
    """Enables the planner to use constraints to optimize queries."""
    debug_parallel_query: global___PostgresqlConfig19_1C.DebugParallelQuery.ValueType
    """Forces the planner's use parallel query nodes."""
    client_min_messages: global___PostgresqlConfig19_1C.LogLevel.ValueType
    """Sets the message levels that are sent to the client."""
    log_min_messages: global___PostgresqlConfig19_1C.LogLevel.ValueType
    """Sets the message levels that are logged."""
    log_min_error_statement: global___PostgresqlConfig19_1C.LogLevel.ValueType
    """Causes all statements generating error at or above this level to be logged."""
    log_error_verbosity: global___PostgresqlConfig19_1C.LogErrorVerbosity.ValueType
    """Sets the verbosity of logged messages."""
    log_statement: global___PostgresqlConfig19_1C.LogStatement.ValueType
    """Sets the type of statements logged."""
    search_path: builtins.str
    """Sets the schema search order for names that are not schema-qualified."""
    default_transaction_isolation: global___PostgresqlConfig19_1C.TransactionIsolation.ValueType
    """Sets the transaction isolation level of each new transaction."""
    bytea_output: global___PostgresqlConfig19_1C.ByteaOutput.ValueType
    """Sets the output format for bytea."""
    xmlbinary: global___PostgresqlConfig19_1C.XmlBinary.ValueType
    """Sets how binary values are to be encoded in XML."""
    xmloption: global___PostgresqlConfig19_1C.XmlOption.ValueType
    ...
    backslash_quote: global___PostgresqlConfig19_1C.BackslashQuote.ValueType
    """Sets whether \\"\\\\'\\" is allowed in string literals."""
    timezone: builtins.str
    """Sets the time zone for displaying and interpreting time stamps."""
    plan_cache_mode: global___PostgresqlConfig19_1C.PlanCacheMode.ValueType
    ...
    """
    pg_hint_plan_debug_print: global___PostgresqlConfig19_1C.PgHintPlanDebugPrint.ValueType
    """Controls whether and how verbosely hint parsing results are logged."""
    pg_hint_plan_message_level: global___PostgresqlConfig19_1C.LogLevel.ValueType
    """Sets the log level for pg_hint_plan debug messages."""
    password_encryption: global___PostgresqlConfig19_1C.PasswordEncryption.ValueType
    ...
    """
    auto_explain_log_format: global___PostgresqlConfig19_1C.AutoExplainLogFormat.ValueType
    ...
    @property
    def shared_preload_libraries(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[global___PostgresqlConfig19_1C.SharedPreloadLibraries.ValueType]:
    ...
    @property
    def track_commit_timestamp(self) -> google.protobuf.wrappers_pb2.BoolValue:
        """Collects transaction commit time."""

    @property
    def max_logical_replication_workers(self) -> google.protobuf.wrappers_pb2.Int64Value:
        """Maximum number of logical replication worker processes."""

    @property
    def max_wal_senders(self) -> google.protobuf.wrappers_pb2.Int64Value:
        """Sets the maximum number of simultaneously running WAL sender processes."""

    @property
    def max_replication_slots(self) -> google.protobuf.wrappers_pb2.Int64Value:
    ...
    @property
    def vacuum_truncate(self) -> google.protobuf.wrappers_pb2.BoolValue:
    ...
    @property
    def max_active_replication_origins(self) -> google.protobuf.wrappers_pb2.Int64Value:
        """Sets the maximum number of active replication origins."""

    @property
    def autovacuum_max_parallel_workers(self) -> google.protobuf.wrappers_pb2.Int64Value:
    ...
    @property
    def log_autoanalyze_min_duration(self) -> google.protobuf.wrappers_pb2.Int64Value:
    ...
    @property
    def max_repack_replication_slots(self) -> google.protobuf.wrappers_pb2.Int64Value:
        """Sets the maximum number of replication slots for use of the REPACK command. The default is 5."""

    @property
    def auto_explain_log_io(self) -> google.protobuf.wrappers_pb2.BoolValue:
    ...
    def __init__(
        ...
        *,
        ...
        shared_preload_libraries: collections.abc.Iterable[global___PostgresqlConfig19_1C.SharedPreloadLibraries.ValueType] | None = ...,
        ...
        password_encryption: global___PostgresqlConfig19_1C.PasswordEncryption.ValueType = ...,
        auto_explain_log_format: global___PostgresqlConfig19_1C.AutoExplainLogFormat.ValueType = ...,
        track_commit_timestamp: google.protobuf.wrappers_pb2.BoolValue | None = ...,
        max_logical_replication_workers: google.protobuf.wrappers_pb2.Int64Value | None = ...,
        max_wal_senders: google.protobuf.wrappers_pb2.Int64Value | None = ...,
        max_replication_slots: google.protobuf.wrappers_pb2.Int64Value | None = ...,
        ...
        vacuum_truncate: google.protobuf.wrappers_pb2.BoolValue | None = ...,
        ...
        max_active_replication_origins: google.protobuf.wrappers_pb2.Int64Value | None = ...,
        autovacuum_max_parallel_workers: google.protobuf.wrappers_pb2.Int64Value | None = ...,
        log_autoanalyze_min_duration: google.protobuf.wrappers_pb2.Int64Value | None = ...,
        max_repack_replication_slots: google.protobuf.wrappers_pb2.Int64Value | None = ...,
        auto_explain_log_io: google.protobuf.wrappers_pb2.BoolValue | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["archive_timeout", b"archive_timeout", "array_nulls", b"array_nulls", "auto_explain_log_analyze", b"auto_explain_log_analyze", "auto_explain_log_buffers", b"auto_explain_log_buffers", "auto_explain_log_io", b"auto_explain_log_io", "auto_explain_log_min_duration", b"auto_explain_log_min_duration", "auto_explain_log_nested_statements", b"auto_explain_log_nested_statements", "auto_explain_log_timing", b"auto_explain_log_timing", "auto_explain_log_triggers", b"auto_explain_log_triggers", "auto_explain_log_verbose", b"auto_explain_log_verbose", "auto_explain_sample_rate", b"auto_explain_sample_rate", "autovacuum_analyze_scale_factor", b"autovacuum_analyze_scale_factor", "autovacuum_analyze_threshold", b"autovacuum_analyze_threshold", "autovacuum_max_parallel_workers", b"autovacuum_max_parallel_workers", "autovacuum_max_workers", b"autovacuum_max_workers", "autovacuum_naptime", b"autovacuum_naptime", "autovacuum_vacuum_cost_delay", b"autovacuum_vacuum_cost_delay", "autovacuum_vacuum_cost_limit", b"autovacuum_vacuum_cost_limit", "autovacuum_vacuum_insert_scale_factor", b"autovacuum_vacuum_insert_scale_factor", "autovacuum_vacuum_insert_threshold", b"autovacuum_vacuum_insert_threshold", "autovacuum_vacuum_scale_factor", b"autovacuum_vacuum_scale_factor", "autovacuum_vacuum_threshold", b"autovacuum_vacuum_threshold", "autovacuum_work_mem", b"autovacuum_work_mem", "backend_flush_after", b"backend_flush_after", "bgwriter_delay", b"bgwriter_delay", "bgwriter_flush_after", b"bgwriter_flush_after", "bgwriter_lru_maxpages", b"bgwriter_lru_maxpages", "bgwriter_lru_multiplier", b"bgwriter_lru_multiplier", "checkpoint_completion_target", b"checkpoint_completion_target", "checkpoint_flush_after", b"checkpoint_flush_after", "checkpoint_timeout", b"checkpoint_timeout", "checkpoint_warning", b"checkpoint_warning", "client_connection_check_interval", b"client_connection_check_interval", "cursor_tuple_fraction", b"cursor_tuple_fraction", "deadlock_timeout", b"deadlock_timeout", "default_statistics_target", b"default_statistics_target", "default_transaction_read_only", b"default_transaction_read_only", "default_with_oids", b"default_with_oids", "effective_cache_size", b"effective_cache_size", "effective_io_concurrency", b"effective_io_concurrency", "enable_async_append", b"enable_async_append", "enable_bitmapscan", b"enable_bitmapscan", "enable_gathermerge", b"enable_gathermerge", "enable_group_by_reordering", b"enable_group_by_reordering", "enable_hashagg", b"enable_hashagg", "enable_hashjoin", b"enable_hashjoin", "enable_incremental_sort", b"enable_incremental_sort", "enable_indexonlyscan", b"enable_indexonlyscan", "enable_indexscan", b"enable_indexscan", "enable_material", b"enable_material", "enable_memoize", b"enable_memoize", "enable_mergejoin", b"enable_mergejoin", "enable_nestloop", b"enable_nestloop", "enable_parallel_append", b"enable_parallel_append", "enable_parallel_hash", b"enable_parallel_hash", "enable_partition_pruning", b"enable_partition_pruning", "enable_partitionwise_aggregate", b"enable_partitionwise_aggregate", "enable_partitionwise_join", b"enable_partitionwise_join", "enable_seqscan", b"enable_seqscan", "enable_sort", b"enable_sort", "enable_tidscan", b"enable_tidscan", "exit_on_error", b"exit_on_error", "from_collapse_limit", b"from_collapse_limit", "geqo", b"geqo", "geqo_effort", b"geqo_effort", "geqo_generations", b"geqo_generations", "geqo_pool_size", b"geqo_pool_size", "geqo_seed", b"geqo_seed", "geqo_selection_bias", b"geqo_selection_bias", "geqo_threshold", b"geqo_threshold", "gin_pending_list_limit", b"gin_pending_list_limit", "hash_mem_multiplier", b"hash_mem_multiplier", "idle_in_transaction_session_timeout", b"idle_in_transaction_session_timeout", "idle_session_timeout", b"idle_session_timeout", "jit", b"jit", "join_collapse_limit", b"join_collapse_limit", "lo_compat_privileges", b"lo_compat_privileges", "lock_timeout", b"lock_timeout", "log_autoanalyze_min_duration", b"log_autoanalyze_min_duration", "log_autovacuum_min_duration", b"log_autovacuum_min_duration", "log_checkpoints", b"log_checkpoints", "log_connections", b"log_connections", "log_disconnections", b"log_disconnections", "log_duration", b"log_duration", "log_lock_waits", b"log_lock_waits", "log_min_duration_sample", b"log_min_duration_sample", "log_min_duration_statement", b"log_min_duration_statement", "log_parameter_max_length", b"log_parameter_max_length", "log_parameter_max_length_on_error", b"log_parameter_max_length_on_error", "log_recovery_conflict_waits", b"log_recovery_conflict_waits", "log_replication_commands", b"log_replication_commands", "log_statement_sample_rate", b"log_statement_sample_rate", "log_temp_files", b"log_temp_files", "log_transaction_sample_rate", b"log_transaction_sample_rate", "logical_decoding_work_mem", b"logical_decoding_work_mem", "maintenance_io_concurrency", b"maintenance_io_concurrency", "maintenance_work_mem", b"maintenance_work_mem", "max_active_replication_origins", b"max_active_replication_origins", "max_connections", b"max_connections", "max_locks_per_transaction", b"max_locks_per_transaction", "max_logical_replication_workers", b"max_logical_replication_workers", "max_parallel_maintenance_workers", b"max_parallel_maintenance_workers", "max_parallel_workers", b"max_parallel_workers", "max_parallel_workers_per_gather", b"max_parallel_workers_per_gather", "max_pred_locks_per_transaction", b"max_pred_locks_per_transaction", "max_prepared_transactions", b"max_prepared_transactions", "max_repack_replication_slots", b"max_repack_replication_slots", "max_replication_slots", b"max_replication_slots", "max_slot_wal_keep_size", b"max_slot_wal_keep_size", "max_stack_depth", b"max_stack_depth", "max_standby_archive_delay", b"max_standby_archive_delay", "max_standby_streaming_delay", b"max_standby_streaming_delay", "max_wal_senders", b"max_wal_senders", "max_wal_size", b"max_wal_size", "max_worker_processes", b"max_worker_processes", "min_wal_size", b"min_wal_size", "online_analyze_enable", b"online_analyze_enable", "parallel_leader_participation", b"parallel_leader_participation", "pg_hint_plan_enable_hint", b"pg_hint_plan_enable_hint", "pg_hint_plan_enable_hint_table", b"pg_hint_plan_enable_hint_table", "pg_qualstats_enabled", b"pg_qualstats_enabled", "pg_qualstats_max", b"pg_qualstats_max", "pg_qualstats_resolve_oids", b"pg_qualstats_resolve_oids", "pg_qualstats_sample_rate", b"pg_qualstats_sample_rate", "pg_qualstats_track_constants", b"pg_qualstats_track_constants", "pg_trgm_similarity_threshold", b"pg_trgm_similarity_threshold", "pg_trgm_strict_word_similarity_threshold", b"pg_trgm_strict_word_similarity_threshold", "pg_trgm_word_similarity_threshold", b"pg_trgm_word_similarity_threshold", "plantuner_fix_empty_table", b"plantuner_fix_empty_table", "quote_all_identifiers", b"quote_all_identifiers", "random_page_cost", b"random_page_cost", "row_security", b"row_security", "seq_page_cost", b"seq_page_cost", "session_duration_timeout", b"session_duration_timeout", "shared_buffers", b"shared_buffers", "statement_timeout", b"statement_timeout", "synchronize_seqscans", b"synchronize_seqscans", "temp_buffers", b"temp_buffers", "temp_file_limit", b"temp_file_limit", "track_activity_query_size", b"track_activity_query_size", "track_commit_timestamp", b"track_commit_timestamp", "transform_null_equals", b"transform_null_equals", "vacuum_cost_delay", b"vacuum_cost_delay", "vacuum_cost_limit", b"vacuum_cost_limit", "vacuum_cost_page_dirty", b"vacuum_cost_page_dirty", "vacuum_cost_page_hit", b"vacuum_cost_page_hit", "vacuum_cost_page_miss", b"vacuum_cost_page_miss", "vacuum_failsafe_age", b"vacuum_failsafe_age", "vacuum_multixact_failsafe_age", b"vacuum_multixact_failsafe_age", "vacuum_truncate", b"vacuum_truncate", "wal_keep_size", b"wal_keep_size", "work_mem", b"work_mem"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["archive_timeout", b"archive_timeout", "array_nulls", b"array_nulls", "auto_explain_log_analyze", b"auto_explain_log_analyze", "auto_explain_log_buffers", b"auto_explain_log_buffers", "auto_explain_log_format", b"auto_explain_log_format", "auto_explain_log_io", b"auto_explain_log_io", "auto_explain_log_min_duration", b"auto_explain_log_min_duration", "auto_explain_log_nested_statements", b"auto_explain_log_nested_statements", "auto_explain_log_timing", b"auto_explain_log_timing", "auto_explain_log_triggers", b"auto_explain_log_triggers", "auto_explain_log_verbose", b"auto_explain_log_verbose", "auto_explain_sample_rate", b"auto_explain_sample_rate", "autovacuum_analyze_scale_factor", b"autovacuum_analyze_scale_factor", "autovacuum_analyze_threshold", b"autovacuum_analyze_threshold", "autovacuum_max_parallel_workers", b"autovacuum_max_parallel_workers", "autovacuum_max_workers", b"autovacuum_max_workers", "autovacuum_naptime", b"autovacuum_naptime", "autovacuum_vacuum_cost_delay", b"autovacuum_vacuum_cost_delay", "autovacuum_vacuum_cost_limit", b"autovacuum_vacuum_cost_limit", "autovacuum_vacuum_insert_scale_factor", b"autovacuum_vacuum_insert_scale_factor", "autovacuum_vacuum_insert_threshold", b"autovacuum_vacuum_insert_threshold", "autovacuum_vacuum_scale_factor", b"autovacuum_vacuum_scale_factor", "autovacuum_vacuum_threshold", b"autovacuum_vacuum_threshold", "autovacuum_work_mem", b"autovacuum_work_mem", "backend_flush_after", b"backend_flush_after", "backslash_quote", b"backslash_quote", "bgwriter_delay", b"bgwriter_delay", "bgwriter_flush_after", b"bgwriter_flush_after", "bgwriter_lru_maxpages", b"bgwriter_lru_maxpages", "bgwriter_lru_multiplier", b"bgwriter_lru_multiplier", "bytea_output", b"bytea_output", "checkpoint_completion_target", b"checkpoint_completion_target", "checkpoint_flush_after", b"checkpoint_flush_after", "checkpoint_timeout", b"checkpoint_timeout", "checkpoint_warning", b"checkpoint_warning", "client_connection_check_interval", b"client_connection_check_interval", "client_min_messages", b"client_min_messages", "constraint_exclusion", b"constraint_exclusion", "cursor_tuple_fraction", b"cursor_tuple_fraction", "deadlock_timeout", b"deadlock_timeout", "debug_parallel_query", b"debug_parallel_query", "default_statistics_target", b"default_statistics_target", "default_transaction_isolation", b"default_transaction_isolation", "default_transaction_read_only", b"default_transaction_read_only", "default_with_oids", b"default_with_oids", "effective_cache_size", b"effective_cache_size", "effective_io_concurrency", b"effective_io_concurrency", "enable_async_append", b"enable_async_append", "enable_bitmapscan", b"enable_bitmapscan", "enable_gathermerge", b"enable_gathermerge", "enable_group_by_reordering", b"enable_group_by_reordering", "enable_hashagg", b"enable_hashagg", "enable_hashjoin", b"enable_hashjoin", "enable_incremental_sort", b"enable_incremental_sort", "enable_indexonlyscan", b"enable_indexonlyscan", "enable_indexscan", b"enable_indexscan", "enable_material", b"enable_material", "enable_memoize", b"enable_memoize", "enable_mergejoin", b"enable_mergejoin", "enable_nestloop", b"enable_nestloop", "enable_parallel_append", b"enable_parallel_append", "enable_parallel_hash", b"enable_parallel_hash", "enable_partition_pruning", b"enable_partition_pruning", "enable_partitionwise_aggregate", b"enable_partitionwise_aggregate", "enable_partitionwise_join", b"enable_partitionwise_join", "enable_seqscan", b"enable_seqscan", "enable_sort", b"enable_sort", "enable_tidscan", b"enable_tidscan", "exit_on_error", b"exit_on_error", "from_collapse_limit", b"from_collapse_limit", "geqo", b"geqo", "geqo_effort", b"geqo_effort", "geqo_generations", b"geqo_generations", "geqo_pool_size", b"geqo_pool_size", "geqo_seed", b"geqo_seed", "geqo_selection_bias", b"geqo_selection_bias", "geqo_threshold", b"geqo_threshold", "gin_pending_list_limit", b"gin_pending_list_limit", "hash_mem_multiplier", b"hash_mem_multiplier", "idle_in_transaction_session_timeout", b"idle_in_transaction_session_timeout", "idle_session_timeout", b"idle_session_timeout", "jit", b"jit", "join_collapse_limit", b"join_collapse_limit", "lo_compat_privileges", b"lo_compat_privileges", "lock_timeout", b"lock_timeout", "log_autoanalyze_min_duration", b"log_autoanalyze_min_duration", "log_autovacuum_min_duration", b"log_autovacuum_min_duration", "log_checkpoints", b"log_checkpoints", "log_connections", b"log_connections", "log_disconnections", b"log_disconnections", "log_duration", b"log_duration", "log_error_verbosity", b"log_error_verbosity", "log_lock_waits", b"log_lock_waits", "log_min_duration_sample", b"log_min_duration_sample", "log_min_duration_statement", b"log_min_duration_statement", "log_min_error_statement", b"log_min_error_statement", "log_min_messages", b"log_min_messages", "log_parameter_max_length", b"log_parameter_max_length", "log_parameter_max_length_on_error", b"log_parameter_max_length_on_error", "log_recovery_conflict_waits", b"log_recovery_conflict_waits", "log_replication_commands", b"log_replication_commands", "log_statement", b"log_statement", "log_statement_sample_rate", b"log_statement_sample_rate", "log_temp_files", b"log_temp_files", "log_transaction_sample_rate", b"log_transaction_sample_rate", "logical_decoding_work_mem", b"logical_decoding_work_mem", "maintenance_io_concurrency", b"maintenance_io_concurrency", "maintenance_work_mem", b"maintenance_work_mem", "max_active_replication_origins", b"max_active_replication_origins", "max_connections", b"max_connections", "max_locks_per_transaction", b"max_locks_per_transaction", "max_logical_replication_workers", b"max_logical_replication_workers", "max_parallel_maintenance_workers", b"max_parallel_maintenance_workers", "max_parallel_workers", b"max_parallel_workers", "max_parallel_workers_per_gather", b"max_parallel_workers_per_gather", "max_pred_locks_per_transaction", b"max_pred_locks_per_transaction", "max_prepared_transactions", b"max_prepared_transactions", "max_repack_replication_slots", b"max_repack_replication_slots", "max_replication_slots", b"max_replication_slots", "max_slot_wal_keep_size", b"max_slot_wal_keep_size", "max_stack_depth", b"max_stack_depth", "max_standby_archive_delay", b"max_standby_archive_delay", "max_standby_streaming_delay", b"max_standby_streaming_delay", "max_wal_senders", b"max_wal_senders", "max_wal_size", b"max_wal_size", "max_worker_processes", b"max_worker_processes", "min_wal_size", b"min_wal_size", "online_analyze_enable", b"online_analyze_enable", "parallel_leader_participation", b"parallel_leader_participation", "password_encryption", b"password_encryption", "pg_hint_plan_debug_print", b"pg_hint_plan_debug_print", "pg_hint_plan_enable_hint", b"pg_hint_plan_enable_hint", "pg_hint_plan_enable_hint_table", b"pg_hint_plan_enable_hint_table", "pg_hint_plan_message_level", b"pg_hint_plan_message_level", "pg_qualstats_enabled", b"pg_qualstats_enabled", "pg_qualstats_max", b"pg_qualstats_max", "pg_qualstats_resolve_oids", b"pg_qualstats_resolve_oids", "pg_qualstats_sample_rate", b"pg_qualstats_sample_rate", "pg_qualstats_track_constants", b"pg_qualstats_track_constants", "pg_trgm_similarity_threshold", b"pg_trgm_similarity_threshold", "pg_trgm_strict_word_similarity_threshold", b"pg_trgm_strict_word_similarity_threshold", "pg_trgm_word_similarity_threshold", b"pg_trgm_word_similarity_threshold", "plan_cache_mode", b"plan_cache_mode", "plantuner_fix_empty_table", b"plantuner_fix_empty_table", "quote_all_identifiers", b"quote_all_identifiers", "random_page_cost", b"random_page_cost", "row_security", b"row_security", "search_path", b"search_path", "seq_page_cost", b"seq_page_cost", "session_duration_timeout", b"session_duration_timeout", "shared_buffers", b"shared_buffers", "shared_preload_libraries", b"shared_preload_libraries", "statement_timeout", b"statement_timeout", "synchronize_seqscans", b"synchronize_seqscans", "synchronous_commit", b"synchronous_commit", "temp_buffers", b"temp_buffers", "temp_file_limit", b"temp_file_limit", "timezone", b"timezone", "track_activity_query_size", b"track_activity_query_size", "track_commit_timestamp", b"track_commit_timestamp", "transform_null_equals", b"transform_null_equals", "vacuum_cost_delay", b"vacuum_cost_delay", "vacuum_cost_limit", b"vacuum_cost_limit", "vacuum_cost_page_dirty", b"vacuum_cost_page_dirty", "vacuum_cost_page_hit", b"vacuum_cost_page_hit", "vacuum_cost_page_miss", b"vacuum_cost_page_miss", "vacuum_failsafe_age", b"vacuum_failsafe_age", "vacuum_multixact_failsafe_age", b"vacuum_multixact_failsafe_age", "vacuum_truncate", b"vacuum_truncate", "wal_keep_size", b"wal_keep_size", "wal_level", b"wal_level", "work_mem", b"work_mem", "xmlbinary", b"xmlbinary", "xmloption", b"xmloption"]) -> None: ...

global___PostgresqlConfig19_1C = PostgresqlConfig19_1C

@typing.final
class PostgresqlConfigSet19_1C(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    @property
    def effective_config(self) -> global___PostgresqlConfig19_1C:
        """Effective settings for a PostgreSQL 19 1C cluster (a combination of settings defined
        in [user_config] and [default_config]).
        """

    @property
    def user_config(self) -> global___PostgresqlConfig19_1C:
        """User-defined settings for a PostgreSQL 19 1C cluster."""

    @property
    def default_config(self) -> global___PostgresqlConfig19_1C:
        """Default configuration for a PostgreSQL 19 1C cluster."""

    def __init__(
        self,
        *,
        effective_config: global___PostgresqlConfig19_1C | None = ...,
        user_config: global___PostgresqlConfig19_1C | None = ...,
        default_config: global___PostgresqlConfig19_1C | None = ...,
    ) -> None: ...
...
global___PostgresqlConfigSet19_1C = PostgresqlConfigSet19_1C
