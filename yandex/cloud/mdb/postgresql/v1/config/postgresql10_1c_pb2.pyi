...
class PostgresqlConfig10_1C(google.protobuf.message.Message):
    ...
    class _PasswordEncryptionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig10_1C._PasswordEncryption.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        PASSWORD_ENCRYPTION_UNSPECIFIED: PostgresqlConfig10_1C._PasswordEncryption.ValueType  # 0
        PASSWORD_ENCRYPTION_MD5: PostgresqlConfig10_1C._PasswordEncryption.ValueType  # 1
        PASSWORD_ENCRYPTION_SCRAM_SHA_256: PostgresqlConfig10_1C._PasswordEncryption.ValueType  # 2

    class PasswordEncryption(_PasswordEncryption, metaclass=_PasswordEncryptionEnumTypeWrapper): ...
    PASSWORD_ENCRYPTION_UNSPECIFIED: PostgresqlConfig10_1C.PasswordEncryption.ValueType  # 0
    PASSWORD_ENCRYPTION_MD5: PostgresqlConfig10_1C.PasswordEncryption.ValueType  # 1
    PASSWORD_ENCRYPTION_SCRAM_SHA_256: PostgresqlConfig10_1C.PasswordEncryption.ValueType  # 2
    ...
    password_encryption: global___PostgresqlConfig10_1C.PasswordEncryption.ValueType
    ...
    def __init__(
        ...
        *,
        ...
        shared_preload_libraries: collections.abc.Iterable[global___PostgresqlConfig10_1C.SharedPreloadLibraries.ValueType] | None = ...,
...
class PostgresqlConfigSet10_1C(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        effective_config: global___PostgresqlConfig10_1C | None = ...,
        user_config: global___PostgresqlConfig10_1C | None = ...,
        default_config: global___PostgresqlConfig10_1C | None = ...,
    ) -> None: ...
