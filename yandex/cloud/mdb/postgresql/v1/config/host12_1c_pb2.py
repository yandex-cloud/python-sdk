...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['backend_flush_after']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['backend_flush_after']._serialized_options = b'\372\3071\0060-2048'
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['old_snapshot_threshold']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['old_snapshot_threshold']._serialized_options = b'\372\3071\010-1-86400'
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['from_collapse_limit']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['from_collapse_limit']._serialized_options = b'\372\3071\0141-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['join_collapse_limit']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['join_collapse_limit']._serialized_options = b'\372\3071\0141-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['idle_in_transaction_session_timeout']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['idle_in_transaction_session_timeout']._serialized_options = b'\372\3071\0140-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['deadlock_timeout']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['deadlock_timeout']._serialized_options = b'\372\3071\0141-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['max_parallel_workers']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['max_parallel_workers']._serialized_options = b'\372\3071\0060-1024'
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['max_parallel_workers_per_gather']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['max_parallel_workers_per_gather']._serialized_options = b'\372\3071\0060-1024'
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['effective_io_concurrency']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['effective_io_concurrency']._serialized_options = b'\372\3071\0060-1000'
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['effective_cache_size']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG12_1C'].fields_by_name['effective_cache_size']._serialized_options = b'\372\3071\0241048576-549755813888'
  _globals['_POSTGRESQLHOSTCONFIG12_1C']._serialized_start=160
  _globals['_POSTGRESQLHOSTCONFIG12_1C']._serialized_end=6223
  _globals['_POSTGRESQLHOSTCONFIG12_1C_BACKSLASHQUOTE']._serialized_start=4683
  _globals['_POSTGRESQLHOSTCONFIG12_1C_BACKSLASHQUOTE']._serialized_end=4837
  _globals['_POSTGRESQLHOSTCONFIG12_1C_BYTEAOUTPUT']._serialized_start=4839
  _globals['_POSTGRESQLHOSTCONFIG12_1C_BYTEAOUTPUT']._serialized_end=4930
  _globals['_POSTGRESQLHOSTCONFIG12_1C_CONSTRAINTEXCLUSION']._serialized_start=4933
  _globals['_POSTGRESQLHOSTCONFIG12_1C_CONSTRAINTEXCLUSION']._serialized_end=5087
  _globals['_POSTGRESQLHOSTCONFIG12_1C_FORCEPARALLELMODE']._serialized_start=5090
  _globals['_POSTGRESQLHOSTCONFIG12_1C_FORCEPARALLELMODE']._serialized_end=5236
  _globals['_POSTGRESQLHOSTCONFIG12_1C_LOGERRORVERBOSITY']._serialized_start=5239
  _globals['_POSTGRESQLHOSTCONFIG12_1C_LOGERRORVERBOSITY']._serialized_end=5392
  _globals['_POSTGRESQLHOSTCONFIG12_1C_LOGLEVEL']._serialized_start=5395
  _globals['_POSTGRESQLHOSTCONFIG12_1C_LOGLEVEL']._serialized_end=5669
  _globals['_POSTGRESQLHOSTCONFIG12_1C_LOGSTATEMENT']._serialized_start=5672
  _globals['_POSTGRESQLHOSTCONFIG12_1C_LOGSTATEMENT']._serialized_end=5810
  _globals['_POSTGRESQLHOSTCONFIG12_1C_TRANSACTIONISOLATION']._serialized_start=5813
  _globals['_POSTGRESQLHOSTCONFIG12_1C_TRANSACTIONISOLATION']._serialized_end=6043
  _globals['_POSTGRESQLHOSTCONFIG12_1C_XMLBINARY']._serialized_start=6045
  _globals['_POSTGRESQLHOSTCONFIG12_1C_XMLBINARY']._serialized_end=6127
  _globals['_POSTGRESQLHOSTCONFIG12_1C_XMLOPTION']._serialized_start=6129
  _globals['_POSTGRESQLHOSTCONFIG12_1C_XMLOPTION']._serialized_end=6217
