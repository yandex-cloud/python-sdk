...
_POSTGRESQLCONFIG13 = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='geqo_seed', full_name='yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13.geqo_seed', index=142,
