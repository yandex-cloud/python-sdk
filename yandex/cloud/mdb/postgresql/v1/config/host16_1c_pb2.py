...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_POSTGRESQLHOSTCONFIG16_1C_BACKSLASHQUOTE'].values_by_name["BACKSLASH_QUOTE"]._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG16_1C_BACKSLASHQUOTE'].values_by_name["BACKSLASH_QUOTE"]._serialized_options = b'\010\001'
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['backend_flush_after']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['backend_flush_after']._serialized_options = b'\372\3071\t0-2097152'
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['old_snapshot_threshold']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['old_snapshot_threshold']._serialized_options = b'\372\3071\013-1-86400000'
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['from_collapse_limit']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['from_collapse_limit']._serialized_options = b'\372\3071\0141-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['join_collapse_limit']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['join_collapse_limit']._serialized_options = b'\372\3071\0141-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['idle_in_transaction_session_timeout']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['idle_in_transaction_session_timeout']._serialized_options = b'\372\3071\0140-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['deadlock_timeout']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['deadlock_timeout']._serialized_options = b'\372\3071\0141-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['seq_page_cost']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['seq_page_cost']._serialized_options = b'\372\3071\003>=0'
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['random_page_cost']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['random_page_cost']._serialized_options = b'\372\3071\003>=0'
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['max_parallel_workers']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['max_parallel_workers']._serialized_options = b'\372\3071\0060-1024'
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['max_parallel_workers_per_gather']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['max_parallel_workers_per_gather']._serialized_options = b'\372\3071\0060-1024'
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['effective_io_concurrency']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['effective_io_concurrency']._serialized_options = b'\372\3071\0060-1000'
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['effective_cache_size']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['effective_cache_size']._serialized_options = b'\372\3071\0241048576-549755813888'
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['idle_session_timeout']._loaded_options = None
  _globals['_POSTGRESQLHOSTCONFIG16_1C'].fields_by_name['idle_session_timeout']._serialized_options = b'\372\3071\0140-2147483647'
  _globals['_POSTGRESQLHOSTCONFIG16_1C']._serialized_start=160
  _globals['_POSTGRESQLHOSTCONFIG16_1C']._serialized_end=6451
  _globals['_POSTGRESQLHOSTCONFIG16_1C_BACKSLASHQUOTE']._serialized_start=4721
  _globals['_POSTGRESQLHOSTCONFIG16_1C_BACKSLASHQUOTE']._serialized_end=4879
  _globals['_POSTGRESQLHOSTCONFIG16_1C_BYTEAOUTPUT']._serialized_start=4881
  _globals['_POSTGRESQLHOSTCONFIG16_1C_BYTEAOUTPUT']._serialized_end=4972
  _globals['_POSTGRESQLHOSTCONFIG16_1C_CONSTRAINTEXCLUSION']._serialized_start=4975
  _globals['_POSTGRESQLHOSTCONFIG16_1C_CONSTRAINTEXCLUSION']._serialized_end=5129
  _globals['_POSTGRESQLHOSTCONFIG16_1C_DEBUGPARALLELQUERY']._serialized_start=5132
  _globals['_POSTGRESQLHOSTCONFIG16_1C_DEBUGPARALLELQUERY']._serialized_end=5283
  _globals['_POSTGRESQLHOSTCONFIG16_1C_FORCEPARALLELMODE']._serialized_start=5286
  _globals['_POSTGRESQLHOSTCONFIG16_1C_FORCEPARALLELMODE']._serialized_end=5432
  _globals['_POSTGRESQLHOSTCONFIG16_1C_LOGERRORVERBOSITY']._serialized_start=5435
  _globals['_POSTGRESQLHOSTCONFIG16_1C_LOGERRORVERBOSITY']._serialized_end=5588
  _globals['_POSTGRESQLHOSTCONFIG16_1C_LOGLEVEL']._serialized_start=5591
  _globals['_POSTGRESQLHOSTCONFIG16_1C_LOGLEVEL']._serialized_end=5885
  _globals['_POSTGRESQLHOSTCONFIG16_1C_LOGSTATEMENT']._serialized_start=5888
  _globals['_POSTGRESQLHOSTCONFIG16_1C_LOGSTATEMENT']._serialized_end=6026
  _globals['_POSTGRESQLHOSTCONFIG16_1C_TRANSACTIONISOLATION']._serialized_start=6029
  _globals['_POSTGRESQLHOSTCONFIG16_1C_TRANSACTIONISOLATION']._serialized_end=6259
  _globals['_POSTGRESQLHOSTCONFIG16_1C_XMLBINARY']._serialized_start=6261
  _globals['_POSTGRESQLHOSTCONFIG16_1C_XMLBINARY']._serialized_end=6343
  _globals['_POSTGRESQLHOSTCONFIG16_1C_XMLOPTION']._serialized_start=6345
  _globals['_POSTGRESQLHOSTCONFIG16_1C_XMLOPTION']._serialized_end=6433
