...
class PostgresqlConfig12_1C(google.protobuf.message.Message):
    ...
    class _ConstraintExclusionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig12_1C._ConstraintExclusion.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        CONSTRAINT_EXCLUSION_UNSPECIFIED: PostgresqlConfig12_1C._ConstraintExclusion.ValueType  # 0
        CONSTRAINT_EXCLUSION_ON: PostgresqlConfig12_1C._ConstraintExclusion.ValueType  # 1
        CONSTRAINT_EXCLUSION_OFF: PostgresqlConfig12_1C._ConstraintExclusion.ValueType  # 2
        CONSTRAINT_EXCLUSION_PARTITION: PostgresqlConfig12_1C._ConstraintExclusion.ValueType  # 3

    class ConstraintExclusion(_ConstraintExclusion, metaclass=_ConstraintExclusionEnumTypeWrapper): ...
    CONSTRAINT_EXCLUSION_UNSPECIFIED: PostgresqlConfig12_1C.ConstraintExclusion.ValueType  # 0
    CONSTRAINT_EXCLUSION_ON: PostgresqlConfig12_1C.ConstraintExclusion.ValueType  # 1
    CONSTRAINT_EXCLUSION_OFF: PostgresqlConfig12_1C.ConstraintExclusion.ValueType  # 2
    CONSTRAINT_EXCLUSION_PARTITION: PostgresqlConfig12_1C.ConstraintExclusion.ValueType  # 3

    class _ForceParallelMode:
        ValueType = typing.NewType("ValueType", builtins.int)
        V: typing_extensions.TypeAlias = ValueType

    class _ForceParallelModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig12_1C._ForceParallelMode.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        FORCE_PARALLEL_MODE_UNSPECIFIED: PostgresqlConfig12_1C._ForceParallelMode.ValueType  # 0
        FORCE_PARALLEL_MODE_ON: PostgresqlConfig12_1C._ForceParallelMode.ValueType  # 1
        FORCE_PARALLEL_MODE_OFF: PostgresqlConfig12_1C._ForceParallelMode.ValueType  # 2
        FORCE_PARALLEL_MODE_REGRESS: PostgresqlConfig12_1C._ForceParallelMode.ValueType  # 3

    class ForceParallelMode(_ForceParallelMode, metaclass=_ForceParallelModeEnumTypeWrapper): ...
    FORCE_PARALLEL_MODE_UNSPECIFIED: PostgresqlConfig12_1C.ForceParallelMode.ValueType  # 0
    FORCE_PARALLEL_MODE_ON: PostgresqlConfig12_1C.ForceParallelMode.ValueType  # 1
    ...
    class _LogLevelEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig12_1C._LogLevel.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        LOG_LEVEL_UNSPECIFIED: PostgresqlConfig12_1C._LogLevel.ValueType  # 0
        LOG_LEVEL_DEBUG5: PostgresqlConfig12_1C._LogLevel.ValueType  # 1
        LOG_LEVEL_DEBUG4: PostgresqlConfig12_1C._LogLevel.ValueType  # 2
        LOG_LEVEL_DEBUG3: PostgresqlConfig12_1C._LogLevel.ValueType  # 3
        LOG_LEVEL_DEBUG2: PostgresqlConfig12_1C._LogLevel.ValueType  # 4
        LOG_LEVEL_DEBUG1: PostgresqlConfig12_1C._LogLevel.ValueType  # 5
        LOG_LEVEL_LOG: PostgresqlConfig12_1C._LogLevel.ValueType  # 6
        LOG_LEVEL_NOTICE: PostgresqlConfig12_1C._LogLevel.ValueType  # 7
        LOG_LEVEL_WARNING: PostgresqlConfig12_1C._LogLevel.ValueType  # 8
        LOG_LEVEL_ERROR: PostgresqlConfig12_1C._LogLevel.ValueType  # 9
        LOG_LEVEL_FATAL: PostgresqlConfig12_1C._LogLevel.ValueType  # 10
        LOG_LEVEL_PANIC: PostgresqlConfig12_1C._LogLevel.ValueType  # 11

    class LogLevel(_LogLevel, metaclass=_LogLevelEnumTypeWrapper): ...
    LOG_LEVEL_UNSPECIFIED: PostgresqlConfig12_1C.LogLevel.ValueType  # 0
    LOG_LEVEL_DEBUG5: PostgresqlConfig12_1C.LogLevel.ValueType  # 1
    LOG_LEVEL_DEBUG4: PostgresqlConfig12_1C.LogLevel.ValueType  # 2
    LOG_LEVEL_DEBUG3: PostgresqlConfig12_1C.LogLevel.ValueType  # 3
    LOG_LEVEL_DEBUG2: PostgresqlConfig12_1C.LogLevel.ValueType  # 4
    LOG_LEVEL_DEBUG1: PostgresqlConfig12_1C.LogLevel.ValueType  # 5
    LOG_LEVEL_LOG: PostgresqlConfig12_1C.LogLevel.ValueType  # 6
    LOG_LEVEL_NOTICE: PostgresqlConfig12_1C.LogLevel.ValueType  # 7
    LOG_LEVEL_WARNING: PostgresqlConfig12_1C.LogLevel.ValueType  # 8
    LOG_LEVEL_ERROR: PostgresqlConfig12_1C.LogLevel.ValueType  # 9
    ...
    class _LogStatementEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig12_1C._LogStatement.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        LOG_STATEMENT_UNSPECIFIED: PostgresqlConfig12_1C._LogStatement.ValueType  # 0
        LOG_STATEMENT_NONE: PostgresqlConfig12_1C._LogStatement.ValueType  # 1
        LOG_STATEMENT_DDL: PostgresqlConfig12_1C._LogStatement.ValueType  # 2
        LOG_STATEMENT_MOD: PostgresqlConfig12_1C._LogStatement.ValueType  # 3
        LOG_STATEMENT_ALL: PostgresqlConfig12_1C._LogStatement.ValueType  # 4

    class LogStatement(_LogStatement, metaclass=_LogStatementEnumTypeWrapper): ...
    LOG_STATEMENT_UNSPECIFIED: PostgresqlConfig12_1C.LogStatement.ValueType  # 0
    LOG_STATEMENT_NONE: PostgresqlConfig12_1C.LogStatement.ValueType  # 1
    ...
    class _PasswordEncryptionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig12_1C._PasswordEncryption.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        PASSWORD_ENCRYPTION_UNSPECIFIED: PostgresqlConfig12_1C._PasswordEncryption.ValueType  # 0
        PASSWORD_ENCRYPTION_MD5: PostgresqlConfig12_1C._PasswordEncryption.ValueType  # 1
        PASSWORD_ENCRYPTION_SCRAM_SHA_256: PostgresqlConfig12_1C._PasswordEncryption.ValueType  # 2

    class PasswordEncryption(_PasswordEncryption, metaclass=_PasswordEncryptionEnumTypeWrapper): ...
    PASSWORD_ENCRYPTION_UNSPECIFIED: PostgresqlConfig12_1C.PasswordEncryption.ValueType  # 0
    PASSWORD_ENCRYPTION_MD5: PostgresqlConfig12_1C.PasswordEncryption.ValueType  # 1
    PASSWORD_ENCRYPTION_SCRAM_SHA_256: PostgresqlConfig12_1C.PasswordEncryption.ValueType  # 2
    ...
    class _SharedPreloadLibrariesEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig12_1C._SharedPreloadLibraries.ValueType], builtins.type):
        ...
        SHARED_PRELOAD_LIBRARIES_PGLOGICAL: PostgresqlConfig12_1C._SharedPreloadLibraries.ValueType  # 6
        SHARED_PRELOAD_LIBRARIES_PG_PREWARM: PostgresqlConfig12_1C._SharedPreloadLibraries.ValueType  # 7
        SHARED_PRELOAD_LIBRARIES_PGAUDIT: PostgresqlConfig12_1C._SharedPreloadLibraries.ValueType  # 8
    ...
    SHARED_PRELOAD_LIBRARIES_PGLOGICAL: PostgresqlConfig12_1C.SharedPreloadLibraries.ValueType  # 6
    SHARED_PRELOAD_LIBRARIES_PG_PREWARM: PostgresqlConfig12_1C.SharedPreloadLibraries.ValueType  # 7
    SHARED_PRELOAD_LIBRARIES_PGAUDIT: PostgresqlConfig12_1C.SharedPreloadLibraries.ValueType  # 8
    ...
    class _TransactionIsolationEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig12_1C._TransactionIsolation.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        TRANSACTION_ISOLATION_UNSPECIFIED: PostgresqlConfig12_1C._TransactionIsolation.ValueType  # 0
        TRANSACTION_ISOLATION_READ_UNCOMMITTED: PostgresqlConfig12_1C._TransactionIsolation.ValueType  # 1
        TRANSACTION_ISOLATION_READ_COMMITTED: PostgresqlConfig12_1C._TransactionIsolation.ValueType  # 2
        TRANSACTION_ISOLATION_REPEATABLE_READ: PostgresqlConfig12_1C._TransactionIsolation.ValueType  # 3
        TRANSACTION_ISOLATION_SERIALIZABLE: PostgresqlConfig12_1C._TransactionIsolation.ValueType  # 4

    class TransactionIsolation(_TransactionIsolation, metaclass=_TransactionIsolationEnumTypeWrapper): ...
    TRANSACTION_ISOLATION_UNSPECIFIED: PostgresqlConfig12_1C.TransactionIsolation.ValueType  # 0
    TRANSACTION_ISOLATION_READ_UNCOMMITTED: PostgresqlConfig12_1C.TransactionIsolation.ValueType  # 1
    TRANSACTION_ISOLATION_READ_COMMITTED: PostgresqlConfig12_1C.TransactionIsolation.ValueType  # 2
    ...
    class _XmlBinaryEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig12_1C._XmlBinary.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        XML_BINARY_UNSPECIFIED: PostgresqlConfig12_1C._XmlBinary.ValueType  # 0
        XML_BINARY_BASE64: PostgresqlConfig12_1C._XmlBinary.ValueType  # 1
        XML_BINARY_HEX: PostgresqlConfig12_1C._XmlBinary.ValueType  # 2

    class XmlBinary(_XmlBinary, metaclass=_XmlBinaryEnumTypeWrapper): ...
    XML_BINARY_UNSPECIFIED: PostgresqlConfig12_1C.XmlBinary.ValueType  # 0
    XML_BINARY_BASE64: PostgresqlConfig12_1C.XmlBinary.ValueType  # 1
    XML_BINARY_HEX: PostgresqlConfig12_1C.XmlBinary.ValueType  # 2

    class _XmlOption:
        ValueType = typing.NewType("ValueType", builtins.int)
        V: typing_extensions.TypeAlias = ValueType

    class _XmlOptionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PostgresqlConfig12_1C._XmlOption.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        XML_OPTION_UNSPECIFIED: PostgresqlConfig12_1C._XmlOption.ValueType  # 0
        XML_OPTION_DOCUMENT: PostgresqlConfig12_1C._XmlOption.ValueType  # 1
        XML_OPTION_CONTENT: PostgresqlConfig12_1C._XmlOption.ValueType  # 2
    ...
    wal_level: global___PostgresqlConfig12_1C.WalLevel.ValueType
    synchronous_commit: global___PostgresqlConfig12_1C.SynchronousCommit.ValueType
    constraint_exclusion: global___PostgresqlConfig12_1C.ConstraintExclusion.ValueType
    force_parallel_mode: global___PostgresqlConfig12_1C.ForceParallelMode.ValueType
    client_min_messages: global___PostgresqlConfig12_1C.LogLevel.ValueType
    log_min_messages: global___PostgresqlConfig12_1C.LogLevel.ValueType
    log_min_error_statement: global___PostgresqlConfig12_1C.LogLevel.ValueType
    log_error_verbosity: global___PostgresqlConfig12_1C.LogErrorVerbosity.ValueType
    log_statement: global___PostgresqlConfig12_1C.LogStatement.ValueType
    search_path: builtins.str
    default_transaction_isolation: global___PostgresqlConfig12_1C.TransactionIsolation.ValueType
    bytea_output: global___PostgresqlConfig12_1C.ByteaOutput.ValueType
    xmlbinary: global___PostgresqlConfig12_1C.XmlBinary.ValueType
    xmloption: global___PostgresqlConfig12_1C.XmlOption.ValueType
    backslash_quote: global___PostgresqlConfig12_1C.BackslashQuote.ValueType
    timezone: builtins.str
    plan_cache_mode: global___PostgresqlConfig12_1C.PlanCacheMode.ValueType
    pg_hint_plan_debug_print: global___PostgresqlConfig12_1C.PgHintPlanDebugPrint.ValueType
    pg_hint_plan_message_level: global___PostgresqlConfig12_1C.LogLevel.ValueType
    password_encryption: global___PostgresqlConfig12_1C.PasswordEncryption.ValueType
    ...
    @property
    def shared_preload_libraries(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[global___PostgresqlConfig12_1C.SharedPreloadLibraries.ValueType]: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        shared_preload_libraries: collections.abc.Iterable[global___PostgresqlConfig12_1C.SharedPreloadLibraries.ValueType] | None = ...,
...
class PostgresqlConfigSet12_1C(google.protobuf.message.Message):
    ...
    @property
    def effective_config(self) -> global___PostgresqlConfig12_1C:
        """Effective settings for a PostgreSQL 12 1C cluster (a combination of settings defined
        in [user_config] and [default_config]).
        """

    @property
    def user_config(self) -> global___PostgresqlConfig12_1C:
        """User-defined settings for a PostgreSQL 12 1C cluster."""

    @property
    def default_config(self) -> global___PostgresqlConfig12_1C:
        """Default configuration for a PostgreSQL 12 1C cluster."""

    def __init__(
        self,
        *,
        effective_config: global___PostgresqlConfig12_1C | None = ...,
        user_config: global___PostgresqlConfig12_1C | None = ...,
        default_config: global___PostgresqlConfig12_1C | None = ...,
    ) -> None: ...
...
global___PostgresqlConfigSet12_1C = PostgresqlConfigSet12_1C
