...
_POSTGRESQLCONFIG14 = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='geqo_seed', full_name='yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14.geqo_seed', index=147,
