...
class DatabaseServiceServicer(metaclass=abc.ABCMeta):
    ...
    ) -> typing.Union[yandex.cloud.mdb.postgresql.v1.database_pb2.Database, collections.abc.Awaitable[yandex.cloud.mdb.postgresql.v1.database_pb2.Database]]:
        """Returns the specified PostgreSQL Database resource.
    ...
    def List(
        ...
        context: _ServicerContext,
    ) -> typing.Union[yandex.cloud.mdb.postgresql.v1.database_service_pb2.ListDatabasesResponse, collections.abc.Awaitable[yandex.cloud.mdb.postgresql.v1.database_service_pb2.ListDatabasesResponse]]:
        """Retrieves the list of PostgreSQL Database resources in the specified cluster."""
