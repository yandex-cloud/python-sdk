...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/mdb/postgresql/v1/cluster_service_pb2_grpc.py depends on'
...
def add_ClusterServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.mdb.postgresql.v1.ClusterService', rpc_method_handlers)
