...
_SERVERROLE = _descriptor.EnumDescriptor(
  name='ServerRole',
  full_name='yandex.cloud.mdb.sqlserver.v1.ServerRole',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='SERVER_ROLE_UNSPECIFIED', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MDB_MONITOR', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_SERVERROLE)

ServerRole = enum_type_wrapper.EnumTypeWrapper(_SERVERROLE)
...
_USER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='server_roles', full_name='yandex.cloud.mdb.sqlserver.v1.User.server_roles', index=3,
...
_USERSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='server_roles', full_name='yandex.cloud.mdb.sqlserver.v1.UserSpec.server_roles', index=3,
      number=4, type=14, cpp_type=8, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_USER.fields_by_name['server_roles'].enum_type = _SERVERROLE
