...
_RESOURCEPRESET = _descriptor.Descriptor(
  name='ResourcePreset',
  full_name='yandex.cloud.mdb.redis.v1.ResourcePreset',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='yandex.cloud.mdb.redis.v1.ResourcePreset.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='zone_ids', full_name='yandex.cloud.mdb.redis.v1.ResourcePreset.zone_ids', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='memory', full_name='yandex.cloud.mdb.redis.v1.ResourcePreset.memory', index=2,
