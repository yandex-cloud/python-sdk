...
_REDISCONFIG5_0_CLIENTOUTPUTBUFFERLIMIT = _descriptor.Descriptor(
  name='ClientOutputBufferLimit',
  full_name='yandex.cloud.mdb.redis.v1.config.RedisConfig5_0.ClientOutputBufferLimit',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='hard_limit', full_name='yandex.cloud.mdb.redis.v1.config.RedisConfig5_0.ClientOutputBufferLimit.hard_limit', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='soft_limit', full_name='yandex.cloud.mdb.redis.v1.config.RedisConfig5_0.ClientOutputBufferLimit.soft_limit', index=1,
      ...
      serialized_options=b'\372\3071\003>=0', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='soft_seconds', full_name='yandex.cloud.mdb.redis.v1.config.RedisConfig5_0.ClientOutputBufferLimit.soft_seconds', index=2,
...
_REDISCONFIG5_0 = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='client_output_buffer_limit_pubsub', full_name='yandex.cloud.mdb.redis.v1.config.RedisConfig5_0.client_output_buffer_limit_pubsub', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='client_output_buffer_limit_normal', full_name='yandex.cloud.mdb.redis.v1.config.RedisConfig5_0.client_output_buffer_limit_normal', index=8,
  ...
  nested_types=[_REDISCONFIG5_0_CLIENTOUTPUTBUFFERLIMIT, ],
  enum_types=[
...
_REDISCONFIG5_0_CLIENTOUTPUTBUFFERLIMIT.fields_by_name['hard_limit'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
_REDISCONFIG5_0_CLIENTOUTPUTBUFFERLIMIT.fields_by_name['soft_limit'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
_REDISCONFIG5_0_CLIENTOUTPUTBUFFERLIMIT.fields_by_name['soft_seconds'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT64VALUE
_REDISCONFIG5_0_CLIENTOUTPUTBUFFERLIMIT.containing_type = _REDISCONFIG5_0
...
_REDISCONFIG5_0.fields_by_name['client_output_buffer_limit_pubsub'].message_type = _REDISCONFIG5_0_CLIENTOUTPUTBUFFERLIMIT
_REDISCONFIG5_0.fields_by_name['client_output_buffer_limit_normal'].message_type = _REDISCONFIG5_0_CLIENTOUTPUTBUFFERLIMIT
...
RedisConfig5_0 = _reflection.GeneratedProtocolMessageType('RedisConfig5_0', (_message.Message,), {
  ...
  'ClientOutputBufferLimit' : _reflection.GeneratedProtocolMessageType('ClientOutputBufferLimit', (_message.Message,), {
    'DESCRIPTOR' : _REDISCONFIG5_0_CLIENTOUTPUTBUFFERLIMIT,
...
_sym_db.RegisterMessage(RedisConfig5_0.ClientOutputBufferLimit)
...
_REDISCONFIG5_0_CLIENTOUTPUTBUFFERLIMIT.fields_by_name['hard_limit']._options = None
_REDISCONFIG5_0_CLIENTOUTPUTBUFFERLIMIT.fields_by_name['soft_limit']._options = None
_REDISCONFIG5_0_CLIENTOUTPUTBUFFERLIMIT.fields_by_name['soft_seconds']._options = None
