...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _REDISCONFIG_CLIENTOUTPUTBUFFERLIMIT.fields_by_name['hard_limit']._serialized_options = b'\372\3071\003>=0'
  _REDISCONFIG_CLIENTOUTPUTBUFFERLIMIT.fields_by_name['soft_limit']._options = None
  _REDISCONFIG_CLIENTOUTPUTBUFFERLIMIT.fields_by_name['soft_limit']._serialized_options = b'\372\3071\003>=0'
  _REDISCONFIG_CLIENTOUTPUTBUFFERLIMIT.fields_by_name['soft_seconds']._options = None
  _REDISCONFIG_CLIENTOUTPUTBUFFERLIMIT.fields_by_name['soft_seconds']._serialized_options = b'\372\3071\003>=0'
  _REDISCONFIG.fields_by_name['password']._options = None
  _REDISCONFIG.fields_by_name['password']._serialized_options = b'\362\3071\"[a-zA-Z0-9@=+?*.,!&#$^<>_-]{8,128}'
  _REDISCONFIG.fields_by_name['databases']._options = None
  _REDISCONFIG.fields_by_name['databases']._serialized_options = b'\372\3071\002>0'
  _REDISCONFIG.fields_by_name['slowlog_log_slower_than']._options = None
  _REDISCONFIG.fields_by_name['slowlog_log_slower_than']._serialized_options = b'\372\3071\003>=0'
  _REDISCONFIG.fields_by_name['slowlog_max_len']._options = None
  _REDISCONFIG.fields_by_name['slowlog_max_len']._serialized_options = b'\372\3071\003>=0'
  ...
  _globals['_REDISCONFIG']._serialized_end=1310
  _globals['_REDISCONFIG_CLIENTOUTPUTBUFFERLIMIT']._serialized_start=898
  _globals['_REDISCONFIG_CLIENTOUTPUTBUFFERLIMIT']._serialized_end=1111
  _globals['_REDISCONFIG_MAXMEMORYPOLICY']._serialized_start=1114
  _globals['_REDISCONFIG_MAXMEMORYPOLICY']._serialized_end=1310
  _globals['_REDISCONFIGSET']._serialized_start=1313
  _globals['_REDISCONFIGSET']._serialized_end=1541
