...
class RedisConfig5_0(google.protobuf.message.Message):
    ...
    class _MaxmemoryPolicyEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[RedisConfig5_0._MaxmemoryPolicy.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        MAXMEMORY_POLICY_UNSPECIFIED: RedisConfig5_0._MaxmemoryPolicy.ValueType  # 0
        VOLATILE_LRU: RedisConfig5_0._MaxmemoryPolicy.ValueType  # 1
        """Try to remove less recently used (LRU) keys with `expire set`."""
        ALLKEYS_LRU: RedisConfig5_0._MaxmemoryPolicy.ValueType  # 2
        """Remove less recently used (LRU) keys."""
        VOLATILE_LFU: RedisConfig5_0._MaxmemoryPolicy.ValueType  # 3
        """Try to remove least frequently used (LFU) keys with `expire set`."""
        ALLKEYS_LFU: RedisConfig5_0._MaxmemoryPolicy.ValueType  # 4
        """Remove least frequently used (LFU) keys."""
        VOLATILE_RANDOM: RedisConfig5_0._MaxmemoryPolicy.ValueType  # 5
        """Try to remove keys with `expire set` randomly."""
        ALLKEYS_RANDOM: RedisConfig5_0._MaxmemoryPolicy.ValueType  # 6
        """Remove keys randomly."""
        VOLATILE_TTL: RedisConfig5_0._MaxmemoryPolicy.ValueType  # 7
        """Try to remove less recently used (LRU) keys with `expire set`
        and shorter TTL first.
        """
        NOEVICTION: RedisConfig5_0._MaxmemoryPolicy.ValueType  # 8
    ...
    MAXMEMORY_POLICY_UNSPECIFIED: RedisConfig5_0.MaxmemoryPolicy.ValueType  # 0
    VOLATILE_LRU: RedisConfig5_0.MaxmemoryPolicy.ValueType  # 1
    """Try to remove less recently used (LRU) keys with `expire set`."""
    ALLKEYS_LRU: RedisConfig5_0.MaxmemoryPolicy.ValueType  # 2
    """Remove less recently used (LRU) keys."""
    VOLATILE_LFU: RedisConfig5_0.MaxmemoryPolicy.ValueType  # 3
    """Try to remove least frequently used (LFU) keys with `expire set`."""
    ALLKEYS_LFU: RedisConfig5_0.MaxmemoryPolicy.ValueType  # 4
    """Remove least frequently used (LFU) keys."""
    VOLATILE_RANDOM: RedisConfig5_0.MaxmemoryPolicy.ValueType  # 5
    """Try to remove keys with `expire set` randomly."""
    ALLKEYS_RANDOM: RedisConfig5_0.MaxmemoryPolicy.ValueType  # 6
    """Remove keys randomly."""
    VOLATILE_TTL: RedisConfig5_0.MaxmemoryPolicy.ValueType  # 7
    """Try to remove less recently used (LRU) keys with `expire set`
    and shorter TTL first.
    """
    NOEVICTION: RedisConfig5_0.MaxmemoryPolicy.ValueType  # 8
    """Return errors when memory limit was reached and commands could require
    more memory to be used.
    """
    ...
    maxmemory_policy: global___RedisConfig5_0.MaxmemoryPolicy.ValueType
    ...
    @property
    def client_output_buffer_limit_pubsub(self) -> global___RedisConfig5_0.ClientOutputBufferLimit:
        """Redis connection output buffers limits for pubsub operations."""

    @property
    def client_output_buffer_limit_normal(self) -> global___RedisConfig5_0.ClientOutputBufferLimit:
    ...
    def __init__(
        ...
        *,
        ...
        notify_keyspace_events: builtins.str = ...,
        client_output_buffer_limit_pubsub: global___RedisConfig5_0.ClientOutputBufferLimit | None = ...,
        client_output_buffer_limit_normal: global___RedisConfig5_0.ClientOutputBufferLimit | None = ...,
    ) -> None: ...
...
class RedisConfigSet5_0(google.protobuf.message.Message):
    ...
    @property
    def effective_config(self) -> global___RedisConfig5_0:
        """Effective settings for a Redis 5.0 cluster (a combination of settings
        defined in [user_config] and [default_config]).
        """

    @property
    def user_config(self) -> global___RedisConfig5_0:
        """User-defined settings for a Redis 5.0 cluster."""

    @property
    def default_config(self) -> global___RedisConfig5_0:
        """Default configuration for a Redis 5.0 cluster."""

    def __init__(
        self,
        *,
        effective_config: global___RedisConfig5_0 | None = ...,
        user_config: global___RedisConfig5_0 | None = ...,
        default_config: global___RedisConfig5_0 | None = ...,
    ) -> None: ...
...
global___RedisConfigSet5_0 = RedisConfigSet5_0
