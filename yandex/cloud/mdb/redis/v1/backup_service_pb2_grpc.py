...
class BackupService(object):
    ...
    def Get(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/yandex.cloud.mdb.redis.v1.BackupService/Get',
            yandex_dot_cloud_dot_mdb_dot_redis_dot_v1_dot_backup__service__pb2.GetBackupRequest.SerializeToString,
            yandex_dot_cloud_dot_mdb_dot_redis_dot_v1_dot_backup__pb2.Backup.FromString,
    ...
    def List(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/yandex.cloud.mdb.redis.v1.BackupService/List',
            yandex_dot_cloud_dot_mdb_dot_redis_dot_v1_dot_backup__service__pb2.ListBackupsRequest.SerializeToString,
