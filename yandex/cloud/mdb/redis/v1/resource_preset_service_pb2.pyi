...
class ListResourcePresetsResponse(google.protobuf.message.Message):
    ...
    """
    @property
    def resource_presets(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[yandex.cloud.mdb.redis.v1.resource_preset_pb2.ResourcePreset]:
        """List of resource presets."""

    def __init__(
        self,
        *,
        resource_presets: collections.abc.Iterable[yandex.cloud.mdb.redis.v1.resource_preset_pb2.ResourcePreset] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
