...
class ListDatabasesResponse(google.protobuf.message.Message):
    ...
    """
    @property
    def databases(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[yandex.cloud.mdb.spqr.v1.database_pb2.Database]:
        """List of SPQR databases."""

    def __init__(
        self,
        *,
        databases: collections.abc.Iterable[yandex.cloud.mdb.spqr.v1.database_pb2.Database] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
...
class CreateDatabaseRequest(google.protobuf.message.Message):
    ...
    """
    @property
    def database_spec(self) -> yandex.cloud.mdb.spqr.v1.database_pb2.DatabaseSpec:
    ...
    def __init__(
        ...
        *,
        cluster_id: builtins.str = ...,
        database_spec: yandex.cloud.mdb.spqr.v1.database_pb2.DatabaseSpec | None = ...,
    ) -> None: ...
