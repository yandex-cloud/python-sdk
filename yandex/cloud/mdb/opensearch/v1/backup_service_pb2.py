...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='yandex/cloud/mdb/opensearch/v1/backup_service.proto',
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,yandex_dot_cloud_dot_validation__pb2.DESCRIPTOR,yandex_dot_cloud_dot_mdb_dot_opensearch_dot_v1_dot_backup__pb2.DESCRIPTOR,])
...
_GETBACKUPREQUEST = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.mdb.opensearch.v1.GetBackupRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='backup_id', full_name='yandex.cloud.mdb.opensearch.v1.GetBackupRequest.backup_id', index=0,
...
_LISTBACKUPSREQUEST = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.mdb.opensearch.v1.ListBackupsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='folder_id', full_name='yandex.cloud.mdb.opensearch.v1.ListBackupsRequest.folder_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='page_size', full_name='yandex.cloud.mdb.opensearch.v1.ListBackupsRequest.page_size', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='page_token', full_name='yandex.cloud.mdb.opensearch.v1.ListBackupsRequest.page_token', index=2,
...
_LISTBACKUPSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='yandex.cloud.mdb.opensearch.v1.ListBackupsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='backups', full_name='yandex.cloud.mdb.opensearch.v1.ListBackupsResponse.backups', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='yandex.cloud.mdb.opensearch.v1.ListBackupsResponse.next_page_token', index=1,
...
_LISTBACKUPSRESPONSE.fields_by_name['backups'].message_type = yandex_dot_cloud_dot_mdb_dot_opensearch_dot_v1_dot_backup__pb2._BACKUP
...
GetBackupRequest = _reflection.GeneratedProtocolMessageType('GetBackupRequest', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.opensearch.v1.backup_service_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.opensearch.v1.GetBackupRequest)
  })
...
ListBackupsRequest = _reflection.GeneratedProtocolMessageType('ListBackupsRequest', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.opensearch.v1.backup_service_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.opensearch.v1.ListBackupsRequest)
  })
...
ListBackupsResponse = _reflection.GeneratedProtocolMessageType('ListBackupsResponse', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.opensearch.v1.backup_service_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.opensearch.v1.ListBackupsResponse)
  })
...
_BACKUPSERVICE = _descriptor.ServiceDescriptor(
  name='BackupService',
  full_name='yandex.cloud.mdb.opensearch.v1.BackupService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Get',
    full_name='yandex.cloud.mdb.opensearch.v1.BackupService.Get',
    index=0,
    containing_service=None,
    input_type=_GETBACKUPREQUEST,
    output_type=yandex_dot_cloud_dot_mdb_dot_opensearch_dot_v1_dot_backup__pb2._BACKUP,
    serialized_options=b'\202\323\344\223\002,\022*/managed-opensearch/v1/backups/{backup_id}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='List',
    full_name='yandex.cloud.mdb.opensearch.v1.BackupService.List',
    index=1,
    containing_service=None,
    input_type=_LISTBACKUPSREQUEST,
    output_type=_LISTBACKUPSRESPONSE,
    serialized_options=b'\202\323\344\223\002 \022\036/managed-opensearch/v1/backups',
    create_key=_descriptor._internal_create_key,
  ),
])
