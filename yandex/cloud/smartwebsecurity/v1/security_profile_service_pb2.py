...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'yandex/cloud/smartwebsecurity/v1/security_profile_service.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GETSECURITYPROFILEREQUEST'].fields_by_name['security_profile_id']._loaded_options = None
  _globals['_GETSECURITYPROFILEREQUEST'].fields_by_name['security_profile_id']._serialized_options = b'\350\3071\001'
  _globals['_LISTSECURITYPROFILESREQUEST'].fields_by_name['folder_id']._loaded_options = None
  _globals['_LISTSECURITYPROFILESREQUEST'].fields_by_name['folder_id']._serialized_options = b'\350\3071\001'
  _globals['_CREATESECURITYPROFILEREQUEST_LABELSENTRY']._loaded_options = None
  _globals['_CREATESECURITYPROFILEREQUEST_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_CREATESECURITYPROFILEREQUEST'].fields_by_name['folder_id']._loaded_options = None
  ...
  _globals['_UPDATESECURITYPROFILEREQUEST'].fields_by_name['security_profile_id']._serialized_options = b'\350\3071\001'
  _globals['_UPDATESECURITYPROFILEREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_UPDATESECURITYPROFILEREQUEST'].fields_by_name['name']._serialized_options = b'\350\3071\000\362\3071\032[a-zA-Z0-9][a-zA-Z0-9-_.]*\212\3101\0041-50'
  _globals['_DELETESECURITYPROFILEREQUEST'].fields_by_name['security_profile_id']._loaded_options = None
  _globals['_DELETESECURITYPROFILEREQUEST'].fields_by_name['security_profile_id']._serialized_options = b'\350\3071\001'
  _globals['_SECURITYPROFILESERVICE'].methods_by_name['Get']._loaded_options = None
  _globals['_SECURITYPROFILESERVICE'].methods_by_name['Get']._serialized_options = b'\202\323\344\223\002=\022;/smartwebsecurity/v1/securityProfiles/{security_profile_id}'
  _globals['_SECURITYPROFILESERVICE'].methods_by_name['List']._loaded_options = None
  _globals['_SECURITYPROFILESERVICE'].methods_by_name['List']._serialized_options = b'\202\323\344\223\002\'\022%/smartwebsecurity/v1/securityProfiles'
  _globals['_SECURITYPROFILESERVICE'].methods_by_name['Create']._loaded_options = None
  _globals['_SECURITYPROFILESERVICE'].methods_by_name['Create']._serialized_options = b'\262\322*0\n\035CreateSecurityProfileMetadata\022\017SecurityProfile\202\323\344\223\002*\"%/smartwebsecurity/v1/securityProfiles:\001*'
  _globals['_SECURITYPROFILESERVICE'].methods_by_name['Update']._loaded_options = None
  ...
  _globals['_CREATESECURITYPROFILEREQUEST']._serialized_end=1154
  _globals['_CREATESECURITYPROFILEREQUEST_LABELSENTRY']._serialized_start=1109
  _globals['_CREATESECURITYPROFILEREQUEST_LABELSENTRY']._serialized_end=1154
  _globals['_CREATESECURITYPROFILEMETADATA']._serialized_start=1156
  _globals['_CREATESECURITYPROFILEMETADATA']._serialized_end=1216
  _globals['_UPDATESECURITYPROFILEREQUEST']._serialized_start=1219
  _globals['_UPDATESECURITYPROFILEREQUEST']._serialized_end=1874
  _globals['_UPDATESECURITYPROFILEREQUEST_LABELSENTRY']._serialized_start=1109
  _globals['_UPDATESECURITYPROFILEREQUEST_LABELSENTRY']._serialized_end=1154
  _globals['_UPDATESECURITYPROFILEMETADATA']._serialized_start=1876
  _globals['_UPDATESECURITYPROFILEMETADATA']._serialized_end=1936
  _globals['_DELETESECURITYPROFILEREQUEST']._serialized_start=1938
  _globals['_DELETESECURITYPROFILEREQUEST']._serialized_end=2003
  _globals['_DELETESECURITYPROFILEMETADATA']._serialized_start=2005
  _globals['_DELETESECURITYPROFILEMETADATA']._serialized_end=2065
  _globals['_SECURITYPROFILESERVICE']._serialized_start=2068
  _globals['_SECURITYPROFILESERVICE']._serialized_end=3147
