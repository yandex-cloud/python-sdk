...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _RECOGNIZETEXTREQUEST.fields_by_name['model']._options = None
  _RECOGNIZETEXTREQUEST.fields_by_name['model']._serialized_options = b'\212\3101\004<=50'
  ...
  _TEXTRECOGNITIONSERVICE.methods_by_name['Recognize']._options = None
  _TEXTRECOGNITIONSERVICE.methods_by_name['Recognize']._serialized_options = b'\202\323\344\223\002\032\"\025/ocr/v1/recognizeText:\001*'
  _TEXTRECOGNITIONASYNCSERVICE.methods_by_name['Recognize']._options = None
  _TEXTRECOGNITIONASYNCSERVICE.methods_by_name['Recognize']._serialized_options = b'\262\322*\027\022\025google.protobuf.Empty\202\323\344\223\002\037\"\032/ocr/v1/recognizeTextAsync:\001*'
  _TEXTRECOGNITIONASYNCSERVICE.methods_by_name['GetRecognition']._options = None
  _TEXTRECOGNITIONASYNCSERVICE.methods_by_name['GetRecognition']._serialized_options = b'\202\323\344\223\002\030\022\026/ocr/v1/getRecognition'
