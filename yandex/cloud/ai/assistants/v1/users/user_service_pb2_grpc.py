...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/ai/assistants/v1/users/user_service_pb2_grpc.py depends on'
...
def add_UserServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.ai.assistants.v1.users.UserService', rpc_method_handlers)
