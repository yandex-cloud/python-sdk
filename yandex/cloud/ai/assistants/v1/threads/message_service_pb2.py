...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'yandex/cloud/ai/assistants/v1/threads/message_service.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CREATEMESSAGEREQUEST_LABELSENTRY']._loaded_options = None
  _globals['_CREATEMESSAGEREQUEST_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_CREATEMESSAGEREQUEST'].fields_by_name['thread_id']._loaded_options = None
  _globals['_CREATEMESSAGEREQUEST'].fields_by_name['thread_id']._serialized_options = b'\350\3071\001'
  _globals['_CREATEMESSAGEREQUEST'].fields_by_name['content']._loaded_options = None
  _globals['_CREATEMESSAGEREQUEST'].fields_by_name['content']._serialized_options = b'\350\3071\001'
  _globals['_GETMESSAGEREQUEST'].fields_by_name['thread_id']._loaded_options = None
  _globals['_GETMESSAGEREQUEST'].fields_by_name['thread_id']._serialized_options = b'\350\3071\001'
  _globals['_GETMESSAGEREQUEST'].fields_by_name['message_id']._loaded_options = None
  _globals['_GETMESSAGEREQUEST'].fields_by_name['message_id']._serialized_options = b'\350\3071\001'
  _globals['_LISTMESSAGESREQUEST'].fields_by_name['thread_id']._loaded_options = None
  _globals['_LISTMESSAGESREQUEST'].fields_by_name['thread_id']._serialized_options = b'\350\3071\001'
  _globals['_MESSAGESERVICE'].methods_by_name['Create']._loaded_options = None
  _globals['_MESSAGESERVICE'].methods_by_name['Create']._serialized_options = b'\202\323\344\223\002\034\"\027/assistants/v1/messages:\001*'
  _globals['_MESSAGESERVICE'].methods_by_name['Get']._loaded_options = None
  _globals['_MESSAGESERVICE'].methods_by_name['Get']._serialized_options = b'\202\323\344\223\002&\022$/assistants/v1/messages/{message_id}'
  _globals['_MESSAGESERVICE'].methods_by_name['List']._loaded_options = None
  _globals['_MESSAGESERVICE'].methods_by_name['List']._serialized_options = b'\202\323\344\223\002\031\022\027/assistants/v1/messages'
