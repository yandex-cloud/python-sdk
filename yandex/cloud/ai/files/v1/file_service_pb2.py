...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'yandex/cloud/ai/files/v1/file_service.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CREATEFILEREQUEST_LABELSENTRY']._loaded_options = None
  _globals['_CREATEFILEREQUEST_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_CREATEFILEREQUEST'].fields_by_name['folder_id']._loaded_options = None
  _globals['_CREATEFILEREQUEST'].fields_by_name['folder_id']._serialized_options = b'\350\3071\001'
  _globals['_CREATEFILEREQUEST'].fields_by_name['content']._loaded_options = None
  _globals['_CREATEFILEREQUEST'].fields_by_name['content']._serialized_options = b'\350\3071\001'
  _globals['_GETFILEREQUEST'].fields_by_name['file_id']._loaded_options = None
  _globals['_GETFILEREQUEST'].fields_by_name['file_id']._serialized_options = b'\350\3071\001'
  _globals['_GETFILEURLREQUEST'].fields_by_name['file_id']._loaded_options = None
  _globals['_GETFILEURLREQUEST'].fields_by_name['file_id']._serialized_options = b'\350\3071\001'
  _globals['_UPDATEFILEREQUEST_LABELSENTRY']._loaded_options = None
  _globals['_UPDATEFILEREQUEST_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_UPDATEFILEREQUEST'].fields_by_name['file_id']._loaded_options = None
  _globals['_UPDATEFILEREQUEST'].fields_by_name['file_id']._serialized_options = b'\350\3071\001'
  _globals['_UPDATEFILEREQUEST'].fields_by_name['update_mask']._loaded_options = None
  _globals['_UPDATEFILEREQUEST'].fields_by_name['update_mask']._serialized_options = b'\350\3071\001'
  _globals['_DELETEFILEREQUEST'].fields_by_name['file_id']._loaded_options = None
  _globals['_DELETEFILEREQUEST'].fields_by_name['file_id']._serialized_options = b'\350\3071\001'
  ...
  _globals['_FILESERVICE'].methods_by_name['Create']._loaded_options = None
  _globals['_FILESERVICE'].methods_by_name['Create']._serialized_options = b'\202\323\344\223\002\024\"\017/files/v1/files:\001*'
  _globals['_FILESERVICE'].methods_by_name['Get']._loaded_options = None
  _globals['_FILESERVICE'].methods_by_name['Get']._serialized_options = b'\202\323\344\223\002\033\022\031/files/v1/files/{file_id}'
  ...
  _globals['_FILESERVICE'].methods_by_name['List']._serialized_options = b'\202\323\344\223\002\021\022\017/files/v1/files'
