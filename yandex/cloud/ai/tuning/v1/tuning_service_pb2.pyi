...
class GetOptionsResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["text_to_text_completion", b"text_to_text_completion", "tuning_params", b"tuning_params"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["base_model_uri", b"base_model_uri", "task_id", b"task_id", "text_to_text_completion", b"text_to_text_completion", "train_datasets", b"train_datasets", "tuning_params", b"tuning_params", "validation_datasets", b"validation_datasets"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["tuning_params", b"tuning_params"]) -> typing.Literal["text_to_text_completion"] | None: ...
