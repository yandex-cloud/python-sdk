...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RECOGNIZER']._serialized_end=432
  _globals['_ASYNCRECOGNIZER']._serialized_start=435
  _globals['_ASYNCRECOGNIZER']._serialized_end=866
