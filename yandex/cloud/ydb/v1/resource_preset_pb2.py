...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='yandex/cloud/ydb/v1/resource_preset.proto',
...
_RESOURCEPRESET = _descriptor.Descriptor(
  name='ResourcePreset',
  full_name='yandex.cloud.ydb.v1.ResourcePreset',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='yandex.cloud.ydb.v1.ResourcePreset.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='cores', full_name='yandex.cloud.ydb.v1.ResourcePreset.cores', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='memory', full_name='yandex.cloud.ydb.v1.ResourcePreset.memory', index=2,
