...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SCALEPOLICY_AUTOSCALE_TARGETTRACKING'].oneofs_by_name['target']._loaded_options = None
  _globals['_SCALEPOLICY_AUTOSCALE_TARGETTRACKING'].oneofs_by_name['target']._serialized_options = b'\300\3011\001'
  _globals['_SCALEPOLICY_AUTOSCALE_TARGETTRACKING'].fields_by_name['cpu_utilization_percent']._loaded_options = None
  _globals['_SCALEPOLICY_AUTOSCALE_TARGETTRACKING'].fields_by_name['cpu_utilization_percent']._serialized_options = b'\372\3071\00510-90'
  _globals['_SCALEPOLICY_AUTOSCALE'].oneofs_by_name['auto_scale_type']._loaded_options = None
  _globals['_SCALEPOLICY_AUTOSCALE'].oneofs_by_name['auto_scale_type']._serialized_options = b'\300\3011\001'
  _globals['_SCALEPOLICY_AUTOSCALE'].fields_by_name['min_size']._loaded_options = None
  _globals['_SCALEPOLICY_AUTOSCALE'].fields_by_name['min_size']._serialized_options = b'\372\3071\003>=1'
  _globals['_SCALEPOLICY_AUTOSCALE'].fields_by_name['max_size']._loaded_options = None
  _globals['_SCALEPOLICY_AUTOSCALE'].fields_by_name['max_size']._serialized_options = b'\372\3071\003>=1'
