...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/ydb/v1/database_service_pb2_grpc.py depends on'
...
def add_DatabaseServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.ydb.v1.DatabaseService', rpc_method_handlers)
