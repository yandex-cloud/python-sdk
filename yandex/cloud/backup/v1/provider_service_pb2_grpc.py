...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/backup/v1/provider_service_pb2_grpc.py depends on'
...
def add_ProviderServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.backup.v1.ProviderService', rpc_method_handlers)
