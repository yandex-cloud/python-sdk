...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/vpc/v1/network_service_pb2_grpc.py depends on'
...
def add_NetworkServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.vpc.v1.NetworkService', rpc_method_handlers)
