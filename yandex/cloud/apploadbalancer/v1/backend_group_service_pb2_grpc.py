...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/apploadbalancer/v1/backend_group_service_pb2_grpc.py depends on'
...
def add_BackendGroupServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.apploadbalancer.v1.BackendGroupService', rpc_method_handlers)
